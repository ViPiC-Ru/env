...
var m=y.connectServer(l.context,"root\\default").get("stdRegProv")}catch(B){n=null}if(n){var f=m.methods_.item("getBinaryValue");b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";b.sValueName="DigitalProductId";b=m.execMethod_(f.name,b);b.returnValue||(a=d.fun.bin2key(b.uValue))&&"BBBBB-BBBBB-BBBBB-BBBBB-BBBBB"!=a&&(c["SYS-KEY"]=a);response=n.execQuery("SELECT * FROM Win32_OperatingSystem WHERE primary = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.systemDrive)var H=a;if(a=b.localDateTime)v=d.fun.wql2date(a);if(a=d.fun.clear(b.caption,"Майкрософт","Microsoft","Edition","x64",","))c["SYS-NAME"]=a;if(a=d.fun.clear(b.version))c["SYS-VERSION"]=a;if(a=b.localDateTime)c["SYS-TIME"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.localDateTime)c["SYS-TIME-DATE"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y");if(a=d.fun.clear(b.systemDrive))c["SYS-DRIVE"]=a;if(a=b.installDate)c["SYS-INSTALL"]=d.lib.date2str(d.fun.wql2date(a),
...
b.domain!=b.workgroup&&(r=b.domain);if(a=b.userName)var A=a.split(d.val.keyDelim)[0];if(a=b.userName)var z=a.split(d.val.keyDelim)[1];if(a=b.userName)var x=a;if(a=d.fun.clear(p))c["NET-HOST"]=a;if(a=d.fun.clear(b.domain))c["NET-DOMAIN"]=a;if(a=d.fun.clear(b.model))c["DEV-NAME"]=a;a&&(a=d.fun.clear(b.manufacturer,"Inc.","Hewlett-Packard"))&&(c["DEV-NAME"]=a.split(" ")[0]+" "+d.fun.clear(b.model));break}x||(e=[],f=m.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,
b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName="DefaultDomainName",b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&e.push(b.sValue),f=m.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName="DefaultUserName",b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&e.push(b.sValue),2==e.length&&(A=e[0]),2==e.length&&(z=e[1]),2==e.length&&(x=
...
d.fun.repair(z)+(A?" AND domain = "+d.fun.repair(A):""));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.fullName))c["USR-NAME"]=a;if(a=d.fun.clear(b.fullName)){e=a.split(d.val.argDelim);for(k=e.length-1;-1<k;k--)a=d.fun.clear(e[k],/[\[\(,\.\)\]]/g),2<a.length?e[k]=a:e.splice(k,1);if(a=e[0])c["USR-NAME-FIRST"]=a;if(a=e[1])c["USR-NAME-SECOND"]=a;if(a=e[2])c["USR-NAME-THIRD"]=a;if(a=e[3])c["USR-NAME-FOURTH"]=a}e=[];if(a=b.sid)var C=a;(a=b.domain)&&e.push(a);(a=
b.name)&&e.push(a);2==e.length&&(A=e[0]);2==e.length&&(z=e[1]);2==e.length&&(x=e.join(d.val.keyDelim));break}try{h=!g.length||C?null:y.connectServer(g.shift(),"root\\CIMV2")}catch(B){h=null}}while(h)}if(x)for(response=n.execQuery("SELECT homeDirectory FROM Win32_NetworkLoginProfile WHERE name = "+d.fun.repair(x)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.homeDirectory)var I=a;break}if(!F&&C)for(response=n.execQuery("SELECT localPath FROM Win32_UserProfile WHERE sid = "+
d.fun.repair(C)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.localPath)F=a;break}if(a=d.fun.clear(C))c["USR-SID"]=a;if(a=d.fun.clear(x))c["USR-LOGIN"]=a;if(a=d.fun.clear(A))c["USR-DOMAIN"]=a;if(a=d.fun.clear(z))c["USR-ACCOUNT"]=a;if(a=d.fun.clear(F))c["USR-PROFILE"]=a;if(a=d.fun.clear(I))c["USR-HOME"]=a;if(p)for(response=G.execQuery("SELECT DS_distinguishedName FROM DS_computer WHERE DS_cn = "+d.fun.repair(p)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();
...
e):e);response=n.execQuery("SELECT adapterRam, name, driverVersion, currentHorizontalResolution, currentRefreshRate, currentBitsPerPixel, currentVerticalResolution FROM Win32_VideoController");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.adapterRam)c["GPU-SIZE"]=d.fun.info2str(Math.abs(a),0)+"Б";if(a=b.adapterRam)c["GPU-SIZE-VAL"]=Math.abs(a);if(a=d.fun.clear(b.name,"GPU","Видеоустройство","Family","Chipset","Series","Graphics","Adapter"))c["GPU-NAME"]=a;if(a=d.fun.clear(b.driverVersion))c["GPU-VERSION"]=
...
a;break}e=0;response=t.execQuery("SELECT friendlyName, firmwareVersion, mediaType, serialNumber, size FROM MSFT_PhysicalDisk");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();switch(b.mediaType){case 0:h="USB";break;case 3:h="HDD";break;case 4:h="SSD";break;case 5:h="SCM";break;default:h=""}if((!b.friendlyName||-1==b.friendlyName.indexOf("Raid"))&&h&&!c[h+"-NAME"]){if(a=d.fun.clear(b.friendlyName,"ATA Device","SCSI Disk Device","USB Device","SSD","SATA"))c[h+"-NAME"]=a;if(a=d.fun.clear(b.firmwareVersion))c[h+
"-VERSION"]=a;if(a=d.fun.clear(b.serialNumber))c[h+"-SERIAL"]=a;if(a=b.size)c[h+"-SIZE"]=d.fun.info2str(a,0)+"Б";if(a=b.size)c[h+"-SIZE-VAL"]=a;h&&(e=Math.max(e,"SDD"==h?15.51143:7.14577))}}e&&(q=q?Math.min(q,e):e);response=n.execQuery("SELECT mediaType, caption, drive FROM Win32_CDROMDrive");for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),!b.caption||-1==b.caption.indexOf("Alcohol"))if(!b.caption||-1==b.caption.indexOf("Virtual")){switch(b.mediaType){case "CD-ROM":c["ROM-TYPE"]=
"CD";break;case "DVD-ROM":c["ROM-TYPE"]="DVD";break;case "CD Writer":c["ROM-TYPE"]="CD-RW";break;case "DVD Writer":c["ROM-TYPE"]="DVD-RW"}if(a=d.fun.clear(b.caption,"ATA Device","SCSI CdRom Device"))c["ROM-NAME"]=a;if(a=d.fun.clear(b.drive))c["ROM-DRIVE"]=a;break}response=n.execQuery("SELECT caption, size FROM Win32_LogicalDisk WHERE driveType = 2 OR driveType = 3 OR driveType = 4");for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),b.caption&&-1!=b.caption.indexOf(H)||c["BAK-DRIVE"]||
(a=d.fun.clear(b.caption))&&b.size>=d.val.driveMinSize&&(c["BAK-DRIVE"]=a);u="";h="DisplayIcon";e=["SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма"];a="";f=m.methods_.item("getStringValue");g=0;for(k=e.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=
2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(e=a.split(d.val.keyDelim),e.pop(),e.pop(),u=e.join(d.val.keyDelim),c["APP-EFARMA-DIR"]=u);h="\\Client\\ePlus.Client.exe";e=[u];a="";g=0;for(k=e.length;g<k;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=e.length;g<k;g++)if(a=e[g]+
h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-CLIENT"]=a;break}h="\\ARM\\ePlus.ARMCasherNew.exe";e=[u];a="";g=0;for(k=e.length;g<k;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=e.length;g<k;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-CASHER"]=a;break}h="\\UpdateServer\\ePlus.UpdateServer.exe";e=[u];a="";
g=0;for(k=e.length;g<k;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=e.length;g<k;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-UPDATER"]=a;break}h="lic";e=[u+"\\UpdateServer\\",u+"\\Client\\",u+"\\ARM\\"];a="";g=0;for(k=e.length;g<k;g++)g&&(a+=" OR "),a+="drive = "+d.fun.repair(d.lib.strim(e[g],"",":",!0,!1))+" ",a+="AND path = "+
d.fun.repair(d.lib.strim(e[g],":","",!1,!1))+" ",a+="AND extension = "+d.fun.repair(h);response=n.execQuery("SELECT name, fileName FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=e.length;g<k;g++)if(a=e[g]+b.fileName+"."+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-LICENSE"]=a;break}a=d.lib.date2str(v,"Y");h="\\ULUS.exe";e=["C:\\SoftLink\\Ulus\\"+a,"C:\\LO\\ULUS\\"+a,"C:\\so\\Ulus\\"+a,"C:\\ULUS\\"+a];a="";g=0;for(k=e.length;g<
k;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=e.length;g<k;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-ULUS"]=a;c["APP-ULUS-DIR"]=e[g];break}h="";e=["SOFTWARE\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command","SOFTWARE\\WOW6432Node\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command"];a="";f=m.methods_.item("getStringValue");
...
e[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(e=a.split(d.val.keyDelim),e.pop(),c["APP-VLC"]=a,c["APP-VLC-DIR"]=e.join(d.val.keyDelim));h="ClientID";e=["SOFTWARE\\TeamViewer","SOFTWARE\\WOW6432Node\\TeamViewer"];a="";f=m.methods_.item("getDWORDValue");g=0;for(k=e.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.uValue&&(a=d.fun.clear(b.uValue));
a&&(c["APP-TEAMVIEWER-ID"]=a);e=[];c["CPU-NAME"]&&c["CPU-CORE"]&&c["CPU-SPEED"]&&e.push(d.fun.clear(c["CPU-NAME"].replace("Dual-Core","Intel"),"Dual Core","Xeon","Pentium","Celeron","Core2 Duo","Core","Processor","Athlon 64","Athlon",/,.+/,/@.+/,/\d\.d+GHz/)+" "+c["CPU-CORE"]+"x"+c["CPU-SPEED"].replace(",",".").replace(" МГц","M").replace(" ГГц","G")+"Hz");c["RAM-SIZE"]&&c["RAM-SPEED"]&&e.push(c["RAM-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+c["RAM-SPEED"].replace(" МГц","M").replace(" ГГц",
"G")+"Hz");c["GPU-SIZE"]&&c["GPU-NAME"]&&(-1!=c["GPU-NAME"].indexOf("GeForce")||-1!=c["GPU-NAME"].indexOf("Radeon"))&&e.push(c["GPU-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+d.fun.clear(c["GPU-NAME"],"AMD","NVIDIA","GeForce","Radeon",/\(.+/));c["HDD-SIZE"]&&e.push(c["HDD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" HDD");c["SSD-SIZE"]&&e.push(c["SSD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" SSD");c["USB-SIZE"]&&e.push(c["USB-SIZE"].replace(" МБ",
...
if(l.input)try{h="windows-1251",a=w.stdIn.readAll(),l.charset!=h&&(a=d.wsh.iconv(l.charset,h,a))}catch(B){a=""}if(l.input&&a)switch(b=0,m="",t=a.split(d.val.linDelim),l.input){case "ini":b=d.lib.ini2obj(a,!1);for(h in b)!h||!b[h]||h in c||(c[h]=b[h]);break;case "TSV":m||(m=d.val.tsvDelim);case "CSV":m||(m=d.val.csvDelim),b<t.length&&(n=t[b++].split(m));case "tsv":m||(m=d.val.tsvDelim);case "csv":for(m||(m=d.val.csvDelim);b<t.length;)for(e=t[b++].split(m),g=0,k=n.length;g<k;g++)h=n[g],!h||!e[g]||h in
c||(c[h]=e[g])}if(l.output)switch(t=[],m="",l.output){case "ini":m=d.val.argDelim+d.val.iniDelim+d.val.argDelim;e=[];for(h in c)e.push(h);e.sort();g=0;for(k=e.length;g<k;g++)h=e[g],a=c[h]?c[h]:"",a=h+m+a,t.push(a);a=t.join(d.val.linDelim);break;case "TSV":m||(m=d.val.tsvDelim);case "CSV":m||(m=d.val.csvDelim);v=!0;e=[];g=0;for(k=n.length;g<k;g++)(h=n[g])&&(v=!1),e.push(h);a=n.join(m);v||t.push(a);case "tsv":m||(m=d.val.tsvDelim);case "csv":m||(m=d.val.csvDelim);v=!0;e=[];g=0;for(k=n.length;g<k;g++)h=
n[g],(a=c[h]?c[h]:"")&&(v=!1),e.push(a);a=e.join(m);v||t.push(a);a=t.join(d.val.linDelim)}if(l.output&&a){a+=d.val.linDelim;try{w.stdOut.write(a)}catch(B){}}f=E.environment(d.val.envType);for(h in c)a=c[h],setEnv(f,h,a);f=[];for(b=D;b<w.arguments.length;b++)a=w.arguments.item(b),a=a.split(d.val.getDelim).join(d.val.setDelim),(a=E.expandEnvironmentStrings(a))&&-1==a.indexOf(d.val.argDelim)||(a=d.val.argWrap+a+d.val.argWrap),f.push(a);if(c=f.join(d.val.argDelim)){D=l.silent?0:d.val.runStyle;try{a=E.run(c,
D,!l.nowait),l.nowait&&(a=d.val.defReturn)}catch(B){a=d.val.defReturn}}else a=d.val.defReturn;w.quit(a)}})})(WSH,env);env.init();
