...
(function(w,e,J){e.lib.extend(e,{fun:{wql2date:function(b,p){return new Date(b?Date.UTC(1*b.substr(0,4),1*b.substr(4,2)-1,1*b.substr(6,2),1*b.substr(8,2),1*b.substr(10,2)-1*b.substr(21,4)+(p||0),1*b.substr(12,2),1*b.substr(14,3)):0)},bin2key:function(b){var p="";var r=b.toArray();b=Math.floor(r[66]/6)&1;r[66]=r[66]&247|4*(b&2);for(var c=24;-1<c;c--){var l=0;for(var q=14;-1<q;q--)l*=256,l=r[q+52]+l,r[q+52]=Math.floor(l/24),l%=24;p="BCDFGHJKMPQRTVWXY2346789".substr(l,1)+p}1==b&&(b=p.substr(1,l),p=p.substr(1).replace(b,
b+"N"));return[p.substr(0,5),p.substr(5,5),p.substr(10,5),p.substr(15,5),p.substr(20,5)].join("-")},info2str:function(b,p,r){if(!r||2>r)r=1024;if(!p||0>p)p=0;var c=Math.pow(10,p);for(var l=-1;b>=r;l++)b/=r;b=Math.ceil(b*c)/c;b=e.lib.num2str(b,-1<l?p:0,",","");return b+=" "+"КМГТПЭЗЙ".charAt(l)},clear:function(b){b=b?""+b:"";"INVALID"==b&&(b="");"To be filled by O.E.M."==b&&(b="");"System Product Name"==b&&(b="");"System Serial Number"==b&&(b="");"System manufacturer"==b&&(b="");"Default string"==
...
p="",r="";var c={};var l={},q=0;var v=new Date;for(b=0;b<w.arguments.length;b++){var a=w.arguments.item(b);if(!("context"in l)){var d=a.split(e.val.keyDelim);if(3==d.length&&!d[0]&&!d[1]){l.context=d[2];continue}}if(!("input"in l)&&(d=a.split(e.val.chrDelim),2==d.length&&e.lib.hasValue(["ini","csv","tsv","CSV","TSV"],d[0],!0)&&d[1])){l.input=d[0];l.charset=d[1];continue}if(!("output"in l)&&(d=a.split(e.val.chrDelim),1==d.length&&e.lib.hasValue(["ini","csv","tsv","CSV","TSV"],d[0],!0))){l.output=d[0];
...
var m=y.connectServer(l.context,"root\\default").get("stdRegProv")}catch(B){n=null}if(n){var f=m.methods_.item("getBinaryValue");b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";b.sValueName="DigitalProductId";b=m.execMethod_(f.name,b);b.returnValue||(a=e.fun.bin2key(b.uValue))&&"BBBBB-BBBBB-BBBBB-BBBBB-BBBBB"!=a&&(c["SYS-KEY"]=a);response=n.execQuery("SELECT * FROM Win32_OperatingSystem WHERE primary = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.systemDrive)var H=a;if(a=b.localDateTime)v=e.fun.wql2date(a);if(a=e.fun.clear(b.caption,"Майкрософт","Microsoft","Edition","x64",","))c["SYS-NAME"]=a;if(a=e.fun.clear(b.version))c["SYS-VERSION"]=a;if(a=b.localDateTime)c["SYS-TIME"]=e.lib.date2str(e.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.localDateTime)c["SYS-TIME-DATE"]=e.lib.date2str(e.fun.wql2date(a),"d.m.Y");if(a=e.fun.clear(b.systemDrive))c["SYS-DRIVE"]=a;if(a=b.installDate)c["SYS-INSTALL"]=e.lib.date2str(e.fun.wql2date(a),
"d.m.Y H:i:s");if(a=b.installDate)c["SYS-INSTALL-DATE"]=e.lib.date2str(e.fun.wql2date(a),"d.m.Y");if(a=b.lastBootUpTime)c["SYS-RESET"]=e.lib.date2str(e.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.lastBootUpTime)c["SYS-RESET-DATE"]=e.lib.date2str(e.fun.wql2date(a),"d.m.Y");if(a=e.fun.clear(b.serialNumber))c["SYS-SERIAL"]=a;if(a=e.fun.clear(b.description))c["SYS-DESCRIPTION"]=a;c["SYS-ARCHITECTURE"]=b.osArchitecture&&!b.osArchitecture.indexOf("64")?"x64":"x86";break}response=n.execQuery("SELECT manufacturer, product, serialNumber FROM Win32_BaseBoard WHERE hostingBoard = TRUE");
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=e.fun.clear(b.product))c["PCB-NAME"]=a;a&&(a=e.fun.clear(b.manufacturer,"Inc.").replace("Hewlett-Packard","HP"))&&(c["PCB-NAME"]=a.split(" ")[0]+" "+e.fun.clear(b.product));if(a=e.fun.clear(b.serialNumber))c["PCB-SERIAL"]=a;break}response=n.execQuery("SELECT releaseDate, manufacturer, smBIOSBIOSVersion, serialNumber FROM Win32_BIOS WHERE primaryBIOS = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();
if(a=e.fun.clear(b.releaseDate))c["PCB-BIOS-RELEASE"]=e.lib.date2str(e.fun.wql2date(a,v.getTimezoneOffset()),"d.m.Y H:i:s");if(a=e.fun.clear(b.releaseDate))c["PCB-BIOS-RELEASE-DATE"]=e.lib.date2str(e.fun.wql2date(a,v.getTimezoneOffset()),"d.m.Y");if(a=e.fun.clear(b.manufacturer,"Inc."))c["PCB-BIOS-MANUFACTURE"]=a;if(a=e.fun.clear(b.smBIOSBIOSVersion))c["PCB-BIOS-VERSION"]=a;if(a=e.fun.clear(b.serialNumber))c["PCB-BIOS-SERIAL"]=a;break}var u="";response=n.execQuery("SELECT * FROM Win32_NetworkAdapterConfiguration WHERE ipEnabled = TRUE");
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.interfaceIndex)u=a;if(null!=b.ipAddress){d=b.ipAddress.toArray();var g=0;for(var k=d.length;g<k;g++)(a=e.fun.clear(d[g]))&&-1!=a.indexOf(".")&&!c["NET-IP-V4"]&&(c["NET-IP-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-IP-V6"]&&(c["NET-IP-V6"]=a)}if(null!=b.defaultIPGateway)for(d=b.defaultIPGateway.toArray(),g=0,k=d.length;g<k;g++)(a=e.fun.clear(d[g]))&&-1!=a.indexOf(".")&&!c["NET-GATEWAY-V4"]&&(c["NET-GATEWAY-V4"]=a),a&&-1==a.indexOf(".")&&
!c["NET-GATEWAY-V6"]&&(c["NET-GATEWAY-V6"]=a);if(null!=b.dnsServerSearchOrder)for(d=b.dnsServerSearchOrder.toArray(),g=0,k=d.length;g<k;g++)(a=e.fun.clear(d[g]))&&-1!=a.indexOf(".")&&!c["NET-DNS-V4"]&&(c["NET-DNS-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-DNS-V6"]&&(c["NET-DNS-V6"]=a);if(null!=b.ipSubnet)for(d=b.ipSubnet.toArray(),g=0,k=d.length;g<k;g++)(a=e.fun.clear(d[g]))&&-1!=a.indexOf(".")&&!c["NET-SUBNET-V4"]&&(c["NET-SUBNET-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-SUBNET-V6"]&&(c["NET-SUBNET-V6"]=
a);if(a=e.fun.clear(b.dhcpServer))c["NET-DHCP-V4"]=a;if(a=e.fun.clear(b.description,"Сетевой адаптер","Адаптер","для виртуальной сети","Сетевая карта","Контроллер","NIC (NDIS 6.20)","- Минипорт планировщика пакетов","Family Controller","Adapter"))c["NET-NAME"]=a;if(a=e.fun.clear(b.macAddress))c["NET-MAC"]=a;break}d=0;response=n.execQuery("SELECT speed, timeOfLastReset FROM Win32_NetworkAdapter WHERE netEnabled = TRUE AND interfaceIndex = "+e.fun.repair(u));for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.speed)c["NET-SPEED"]=e.fun.info2str(a,0,1E3)+"бит/с";if(a=b.speed)c["NET-SPEED-VAL"]=a;if(a=b.timeOfLastReset)c["NET-RESET"]=e.lib.date2str(e.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.timeOfLastReset)c["NET-RESET-DATE"]=e.lib.date2str(e.fun.wql2date(a),"d.m.Y");if(a=b.speed)d+=8.12567*Math.sqrt(a/100/1E3/1E3);break}d&&(q=q?Math.min(q,d):d);response=n.execQuery("SELECT * FROM Win32_ComputerSystem");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.dnsHostName)p=
a;if(a=b.name)p||(p=a.toLowerCase());b.domain!=b.workgroup&&(r=b.domain);if(a=b.userName)var A=a.split(e.val.keyDelim)[0];if(a=b.userName)var z=a.split(e.val.keyDelim)[1];if(a=b.userName)var x=a;if(a=e.fun.clear(p))c["NET-HOST"]=a;if(a=e.fun.clear(b.domain))c["NET-DOMAIN"]=a;if(a=e.fun.clear(b.model))c["DEV-NAME"]=a;a&&(a=e.fun.clear(b.manufacturer,"Inc.","Hewlett-Packard"))&&(c["DEV-NAME"]=a.split(" ")[0]+" "+e.fun.clear(b.model));break}x||(d=[],f=m.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),
b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName="DefaultDomainName",b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&d.push(b.sValue),f=m.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName="DefaultUserName",b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&d.push(b.sValue),2==d.length&&(A=d[0]),2==d.length&&(z=d[1]),
2==d.length&&(x=d.join(e.val.keyDelim)));if(!x){d=null;response=n.execQuery("SELECT lastUseTime, localPath, loaded FROM Win32_UserProfile WHERE special = FALSE");for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),(a=d?0:1)||(a=b.loaded&&!d.loaded?1:a),a||(a=e.lib.compare(e.fun.wql2date(b.lastUseTime),e.fun.wql2date(d.lastUseTime))),0<a&&(d=b);if(b=d){if(a=b.localPath.split(e.val.keyDelim).pop())z=a;if(a=b.localPath)var F=a}}if(z){var h=n;g=[".",r];do{response=h.execQuery("SELECT domain, name, fullName, sid FROM Win32_UserAccount WHERE name = "+
e.fun.repair(z)+(A?" AND domain = "+e.fun.repair(A):""));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=e.fun.clear(b.fullName))c["USR-NAME"]=a;if(a=e.fun.clear(b.fullName)){d=a.split(e.val.argDelim);for(k=d.length-1;-1<k;k--)a=e.fun.clear(d[k],/[\[\(,\.\)\]]/g),2<a.length?d[k]=a:d.splice(k,1);if(a=d[0])c["USR-NAME-FIRST"]=a;if(a=d[1])c["USR-NAME-SECOND"]=a;if(a=d[2])c["USR-NAME-THIRD"]=a;if(a=d[3])c["USR-NAME-FOURTH"]=a}d=[];if(a=b.sid)var C=a;(a=b.domain)&&d.push(a);(a=
b.name)&&d.push(a);2==d.length&&(A=d[0]);2==d.length&&(z=d[1]);2==d.length&&(x=d.join(e.val.keyDelim));break}try{h=!g.length||C?null:y.connectServer(g.shift(),"root\\CIMV2")}catch(B){h=null}}while(h)}if(x)for(response=n.execQuery("SELECT homeDirectory FROM Win32_NetworkLoginProfile WHERE name = "+e.fun.repair(x)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.homeDirectory)var I=a;break}if(!F&&C)for(response=n.execQuery("SELECT localPath FROM Win32_UserProfile WHERE sid = "+
e.fun.repair(C)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.localPath)F=a;break}if(a=e.fun.clear(C))c["USR-SID"]=a;if(a=e.fun.clear(x))c["USR-LOGIN"]=a;if(a=e.fun.clear(A))c["USR-DOMAIN"]=a;if(a=e.fun.clear(z))c["USR-ACCOUNT"]=a;if(a=e.fun.clear(F))c["USR-PROFILE"]=a;if(a=e.fun.clear(I))c["USR-HOME"]=a;if(p)for(response=G.execQuery("SELECT DS_distinguishedName FROM DS_computer WHERE DS_cn = "+e.fun.repair(p)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();
if(a=e.fun.clear(b.DS_distinguishedName))c["NET-HOST-DN"]=a;break}d=0;response=n.execQuery("SELECT architecture, maxClockSpeed, name, revision, numberOfCores, socketDesignation FROM Win32_Processor WHERE role = 'CPU'");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();0==b.architecture?c["CPU-ARCHITECTURE"]="x86":9==b.architecture&&(c["CPU-ARCHITECTURE"]="x64");if(a=b.maxClockSpeed)c["CPU-SPEED"]=e.fun.info2str(1E6*a,2,1E3)+"Гц";if(a=b.maxClockSpeed)c["CPU-SPEED-VAL"]=1E6*a;if(a=
e.fun.clear(b.name,"CPU","APU","Процессор","Processor","with","Radeon HD Graphics"))c["CPU-NAME"]=a;if(a=e.fun.clear(b.revision))c["CPU-VERSION"]=a;if(a=b.numberOfCores)c["CPU-CORE"]=a;if(a=e.fun.clear(b.socketDesignation,"SOCKET 0"))c["CPU-SOCKET"]=a;if(a=b.maxClockSpeed)d+=2.26143*Math.sqrt(a/1E3);if(a=b.numberOfCores)d*=1.02033*Math.sqrt(a);break}d&&(q=q?Math.min(q,d):d);response=n.execQuery("SELECT level, maxCacheSize FROM Win32_CacheMemory");for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),
f.moveNext(),a=b.maxCacheSize)c["CPU-CACHE-L"+(b.level-2)]=e.fun.info2str(1024*a,0)+"Б";h=d=0;response=n.execQuery("SELECT capacity, speed FROM Win32_PhysicalMemory");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.capacity)c["RAM-SIZE-VAL"]=h+=1*a;b.capacity&&(c["RAM-SIZE"]=e.fun.info2str(h,0)+"Б");if(a=b.speed)c["RAM-SPEED"]=a+" МГц";if(a=b.speed)c["RAM-SPEED-VAL"]=1E6*a;if(a=h)d=2.51143*Math.sqrt(a/1024/1024/1024);if(a=b.speed)d*=.92245*Math.sqrt(a/1E3)}d&&(q=q?Math.min(q,
d):d);response=n.execQuery("SELECT adapterRam, name, driverVersion, currentHorizontalResolution, currentRefreshRate, currentBitsPerPixel, currentVerticalResolution FROM Win32_VideoController");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.adapterRam)c["GPU-SIZE"]=e.fun.info2str(Math.abs(a),0)+"Б";if(a=b.adapterRam)c["GPU-SIZE-VAL"]=Math.abs(a);if(a=e.fun.clear(b.name,"GPU","Видеоустройство","Family","Chipset","Series","Graphics","Adapter"))c["GPU-NAME"]=a;if(a=e.fun.clear(b.driverVersion))c["GPU-VERSION"]=
a;b.currentHorizontalResolution&&b.currentVerticalResolution&&(c["GPU-RESOLUTION"]=b.currentHorizontalResolution+" x "+b.currentVerticalResolution);if(a=b.currentHorizontalResolution)c["GPU-RESOLUTION-X"]=a;if(a=b.currentVerticalResolution)c["GPU-RESOLUTION-Y"]=a;if(a=b.currentRefreshRate)c["GPU-FREQUENCY"]=e.fun.info2str(a,0,1E3)+"Гц";if(a=b.currentRefreshRate)c["GPU-FREQUENCY-VAL"]=a;if(a=b.currentBitsPerPixel)c["GPU-COLOR"]=e.fun.info2str(a,0)+"бит"+e.lib.numDeclin(a,"","","а");if(a=b.currentBitsPerPixel)c["GPU-COLOR-VAL"]=
a;break}d=0;response=t.execQuery("SELECT friendlyName, firmwareVersion, mediaType, serialNumber, size FROM MSFT_PhysicalDisk");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();switch(b.mediaType){case 0:h="USB";break;case 3:h="HDD";break;case 4:h="SSD";break;case 5:h="SCM";break;default:h=""}if((!b.friendlyName||-1==b.friendlyName.indexOf("Raid"))&&h&&!c[h+"-NAME"]){if(a=e.fun.clear(b.friendlyName,"ATA Device","SCSI Disk Device","USB Device","SSD","SATA"))c[h+"-NAME"]=a;if(a=e.fun.clear(b.firmwareVersion))c[h+
"-VERSION"]=a;if(a=e.fun.clear(b.serialNumber))c[h+"-SERIAL"]=a;if(a=b.size)c[h+"-SIZE"]=e.fun.info2str(a,0)+"Б";if(a=b.size)c[h+"-SIZE-VAL"]=a;h&&(d=Math.max(d,"SDD"==h?15.51143:7.14577))}}d&&(q=q?Math.min(q,d):d);response=n.execQuery("SELECT mediaType, caption, drive FROM Win32_CDROMDrive");for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),!b.caption||-1==b.caption.indexOf("Alcohol"))if(!b.caption||-1==b.caption.indexOf("Virtual")){switch(b.mediaType){case "CD-ROM":c["ROM-TYPE"]=
"CD";break;case "DVD-ROM":c["ROM-TYPE"]="DVD";break;case "CD Writer":c["ROM-TYPE"]="CD-RW";break;case "DVD Writer":c["ROM-TYPE"]="DVD-RW"}if(a=e.fun.clear(b.caption,"ATA Device","SCSI CdRom Device"))c["ROM-NAME"]=a;if(a=e.fun.clear(b.drive))c["ROM-DRIVE"]=a;break}response=n.execQuery("SELECT caption, size FROM Win32_LogicalDisk WHERE driveType = 2 OR driveType = 3 OR driveType = 4");for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),b.caption&&-1!=b.caption.indexOf(H)||c["BAK-DRIVE"]||
(a=e.fun.clear(b.caption))&&b.size>=e.val.driveMinSize&&(c["BAK-DRIVE"]=a);u="";h="DisplayIcon";d=["SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма"];a="";f=m.methods_.item("getStringValue");g=0;for(k=d.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=
2147483650,b.sSubKeyName=d[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=e.fun.clear(b.sValue));a&&(d=a.split(e.val.keyDelim),d.pop(),d.pop(),u=d.join(e.val.keyDelim),c["APP-EFARMA-DIR"]=u);h="\\Client\\ePlus.Client.exe";d=[u];a="";g=0;for(k=d.length;g<k;g++)g&&(a+=" OR "),a+="name = "+e.fun.repair(d[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=d.length;g<k;g++)if(a=d[g]+
h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-CLIENT"]=a;break}h="\\ARM\\ePlus.ARMCasherNew.exe";d=[u];a="";g=0;for(k=d.length;g<k;g++)g&&(a+=" OR "),a+="name = "+e.fun.repair(d[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=d.length;g<k;g++)if(a=d[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-CASHER"]=a;break}h="\\UpdateServer\\ePlus.UpdateServer.exe";d=[u];a="";
g=0;for(k=d.length;g<k;g++)g&&(a+=" OR "),a+="name = "+e.fun.repair(d[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=d.length;g<k;g++)if(a=d[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-UPDATER"]=a;break}h="lic";d=[u+"\\UpdateServer\\",u+"\\Client\\",u+"\\ARM\\"];a="";g=0;for(k=d.length;g<k;g++)g&&(a+=" OR "),a+="drive = "+e.fun.repair(e.lib.strim(d[g],"",":",!0,!1))+" ",a+="AND path = "+
e.fun.repair(e.lib.strim(d[g],":","",!1,!1))+" ",a+="AND extension = "+e.fun.repair(h);response=n.execQuery("SELECT name, fileName FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=d.length;g<k;g++)if(a=d[g]+b.fileName+"."+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-LICENSE"]=a;break}a=e.lib.date2str(v,"Y");h="\\ULUS.exe";d=["C:\\SoftLink\\Ulus\\"+a,"C:\\LO\\ULUS\\"+a,"C:\\so\\Ulus\\"+a,"C:\\ULUS\\"+a];a="";g=0;for(k=d.length;g<
k;g++)g&&(a+=" OR "),a+="name = "+e.fun.repair(d[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=d.length;g<k;g++)if(a=d[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-ULUS"]=a;c["APP-ULUS-DIR"]=d[g];break}h="";d=["SOFTWARE\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command","SOFTWARE\\WOW6432Node\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command"];a="";f=m.methods_.item("getStringValue");
g=0;for(k=d.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=d[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=e.fun.clear(b.sValue));a&&(d=a.split(e.val.keyDelim),d.pop(),c["APP-CHROME"]=a,c["APP-CHROME-DIR"]=d.join(e.val.keyDelim));h="";d=["SOFTWARE\\VideoLAN\\VLC","SOFTWARE\\WOW6432Node\\VideoLAN\\VLC"];a="";f=m.methods_.item("getStringValue");g=0;for(k=d.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=
d[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=e.fun.clear(b.sValue));a&&(d=a.split(e.val.keyDelim),d.pop(),c["APP-VLC"]=a,c["APP-VLC-DIR"]=d.join(e.val.keyDelim));h="ClientID";d=["SOFTWARE\\TeamViewer","SOFTWARE\\WOW6432Node\\TeamViewer"];a="";f=m.methods_.item("getDWORDValue");g=0;for(k=d.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=d[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.uValue&&(a=e.fun.clear(b.uValue));
a&&(c["APP-TEAMVIEWER-ID"]=a);d=[];c["CPU-NAME"]&&c["CPU-CORE"]&&c["CPU-SPEED"]&&d.push(e.fun.clear(c["CPU-NAME"].replace("Dual-Core","Intel"),"Dual Core","Xeon","Pentium","Celeron","Core2 Duo","Core","Processor","Athlon 64","Athlon",/,.+/,/@.+/,/\d\.d+GHz/)+" "+c["CPU-CORE"]+"x"+c["CPU-SPEED"].replace(",",".").replace(" МГц","M").replace(" ГГц","G")+"Hz");c["RAM-SIZE"]&&c["RAM-SPEED"]&&d.push(c["RAM-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+c["RAM-SPEED"].replace(" МГц","M").replace(" ГГц",
"G")+"Hz");c["GPU-SIZE"]&&c["GPU-NAME"]&&(-1!=c["GPU-NAME"].indexOf("GeForce")||-1!=c["GPU-NAME"].indexOf("Radeon"))&&d.push(c["GPU-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+e.fun.clear(c["GPU-NAME"],"AMD","NVIDIA","GeForce","Radeon",/\(.+/));c["HDD-SIZE"]&&d.push(c["HDD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" HDD");c["SSD-SIZE"]&&d.push(c["SSD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" SSD");c["USB-SIZE"]&&d.push(c["USB-SIZE"].replace(" МБ",
"MB").replace(" ГБ","GB").replace(" ТБ","TB")+" USB");c["ROM-TYPE"]&&d.push(c["ROM-TYPE"]);d.length&&(c["DEV-DESCRIPTION"]=d.join("/"));q&&(c["DEV-BENCHMARK"]=e.lib.num2str(q,5,",",""))}n="SYS-KEY SYS-NAME SYS-VERSION SYS-TIME SYS-ARCHITECTURE SYS-DRIVE SYS-INSTALL SYS-RESET SYS-SERIAL PCB-NAME PCB-SERIAL PCB-BIOS-MANUFACTURE PCB-BIOS-RELEASE PCB-BIOS-VERSION PCB-BIOS-SERIAL NET-IP-V4 NET-GATEWAY-V4 NET-DNS-V4 NET-SUBNET-V4 NET-DHCP-V4 NET-NAME NET-MAC NET-SPEED NET-RESET NET-HOST NET-DOMAIN USR-LOGIN USR-DOMAIN USR-ACCOUNT USR-NAME USR-SID USR-PROFILE CPU-ARCHITECTURE CPU-SPEED CPU-NAME CPU-CORE CPU-SOCKET CPU-CACHE-L1 CPU-CACHE-L2 CPU-CACHE-L3 RAM-SIZE RAM-SPEED GPU-SIZE GPU-NAME GPU-VERSION GPU-RESOLUTION GPU-FREQUENCY GPU-COLOR SSD-NAME SSD-VERSION SSD-SERIAL SSD-SIZE HDD-NAME HDD-VERSION HDD-SERIAL HDD-SIZE USB-NAME USB-VERSION USB-SERIAL USB-SIZE ROM-TYPE ROM-NAME ROM-DRIVE ROM-VERSION DEV-NAME DEV-DESCRIPTION DEV-BENCHMARK".split(" ");
if(l.input)try{h="windows-1251",a=w.stdIn.readAll(),l.charset!=h&&(a=e.wsh.iconv(l.charset,h,a))}catch(B){a=""}if(l.input&&a)switch(b=0,m="",t=a.split(e.val.linDelim),l.input){case "ini":b=e.lib.ini2obj(a,!1);for(h in b)!h||!b[h]||h in c||(c[h]=b[h]);break;case "TSV":m||(m=e.val.tsvDelim);case "CSV":m||(m=e.val.csvDelim),b<t.length&&(n=t[b++].split(m));case "tsv":m||(m=e.val.tsvDelim);case "csv":for(m||(m=e.val.csvDelim);b<t.length;)for(d=t[b++].split(m),g=0,k=n.length;g<k;g++)h=n[g],!h||!d[g]||h in
c||(c[h]=d[g])}if(l.output)switch(t=[],m="",l.output){case "ini":m=e.val.argDelim+e.val.iniDelim+e.val.argDelim;d=[];for(h in c)d.push(h);d.sort();g=0;for(k=d.length;g<k;g++)h=d[g],a=c[h]?c[h]:"",a=h+m+a,t.push(a);a=t.join(e.val.linDelim);break;case "TSV":m||(m=e.val.tsvDelim);case "CSV":m||(m=e.val.csvDelim);v=!0;d=[];g=0;for(k=n.length;g<k;g++)(h=n[g])&&(v=!1),d.push(h);a=n.join(m);v||t.push(a);case "tsv":m||(m=e.val.tsvDelim);case "csv":m||(m=e.val.csvDelim);v=!0;d=[];g=0;for(k=n.length;g<k;g++)h=
n[g],(a=c[h]?c[h]:"")&&(v=!1),d.push(a);a=d.join(m);v||t.push(a);a=t.join(e.val.linDelim)}if(l.output&&a){a+=e.val.linDelim;try{w.stdOut.write(a)}catch(B){}}f=E.environment(e.val.envType);for(h in c)a=c[h],setEnv(f,h,a);f=[];for(b=D;b<w.arguments.length;b++)a=w.arguments.item(b),a=a.split(e.val.getDelim).join(e.val.setDelim),(a=E.expandEnvironmentStrings(a))&&-1==a.indexOf(e.val.argDelim)||(a=e.val.argWrap+a+e.val.argWrap),f.push(a);if(c=f.join(e.val.argDelim)){D=l.silent?0:e.val.runStyle;try{a=E.run(c,
D,!l.nowait),l.nowait&&(a=e.val.defReturn)}catch(B){a=e.val.defReturn}}else a=e.val.defReturn;w.quit(a)}})})(WSH,env);env.init();
