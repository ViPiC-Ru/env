...
b+"N"));return[p.substr(0,5),p.substr(5,5),p.substr(10,5),p.substr(15,5),p.substr(20,5)].join("-")},info2str:function(b,p,r){if(!r||2>r)r=1024;if(!p||0>p)p=0;var c=Math.pow(10,p);for(var l=-1;b>=r;l++)b/=r;b=Math.ceil(b*c)/c;b=d.lib.num2str(b,-1<l?p:0,",","");return b+=" "+"КМГТПЭЗЙ".charAt(l)},clear:function(b){b=b?""+b:"";"INVALID"==b&&(b="");"To be filled by O.E.M."==b&&(b="");"System Product Name"==b&&(b="");"System Serial Number"==b&&(b="");"System manufacturer"==b&&(b="");"Default string"==
...
p="",r="";var c={};var l={},q=0;var A=new Date;for(b=0;b<v.arguments.length;b++){var a=v.arguments.item(b);if(!("context"in l)){var e=a.split(d.val.keyDelim);if(3==e.length&&!e[0]&&!e[1]){l.context=e[2];continue}}if(!("input"in l)&&(e=a.split(d.val.chrDelim),2==e.length&&d.lib.hasValue(["ini","csv","tsv","CSV","TSV"],e[0],!0)&&e[1])){l.input=e[0];l.charset=e[1];continue}if(!("output"in l)&&(e=a.split(d.val.chrDelim),1==e.length&&d.lib.hasValue(["ini","csv","tsv","CSV","TSV"],e[0],!0))){l.output=e[0];
continue}if("silent"in l||"silent"!=a)if("nowait"in l||"nowait"!=a)break;else l.nowait=!0;else l.silent=!0}var D=b;"context"in l||(l.context=".");"auto"==l.charset&&(l.charset="windows-1251");var E=new ActiveXObject("WScript.Shell");var x=new ActiveXObject("wbemScripting.Swbemlocator");x.security_.impersonationLevel=3;if(l.context)try{var n=x.connectServer(l.context,"root\\CIMV2");var G=x.connectServer(l.context,"root\\directory\\LDAP");var t=x.connectServer(l.context,"root\\Microsoft\\Windows\\Storage");
var m=x.connectServer(l.context,"root\\default").get("stdRegProv")}catch(B){n=null}if(n){var f=m.methods_.item("getBinaryValue");b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";b.sValueName="DigitalProductId";b=m.execMethod_(f.name,b);b.returnValue||(a=d.fun.bin2key(b.uValue))&&"BBBBB-BBBBB-BBBBB-BBBBB-BBBBB"!=a&&(c["SYS-KEY"]=a);response=n.execQuery("SELECT * FROM Win32_OperatingSystem WHERE primary = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.systemDrive)var H=a;if(a=b.localDateTime)A=d.fun.wql2date(a);if(a=d.fun.clear(b.caption,"Майкрософт","Microsoft","Edition","x64",","))c["SYS-NAME"]=a;if(a=d.fun.clear(b.version))c["SYS-VERSION"]=a;if(a=b.localDateTime)c["SYS-TIME"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.localDateTime)c["SYS-TIME-DATE"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y");if(a=d.fun.clear(b.systemDrive))c["SYS-DRIVE"]=a;if(a=b.installDate)c["SYS-INSTALL"]=d.lib.date2str(d.fun.wql2date(a),
"d.m.Y H:i:s");if(a=b.installDate)c["SYS-INSTALL-DATE"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y");if(a=b.lastBootUpTime)c["SYS-RESET"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.lastBootUpTime)c["SYS-RESET-DATE"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y");if(a=d.fun.clear(b.serialNumber))c["SYS-SERIAL"]=a;if(a=d.fun.clear(b.description))c["SYS-DESCRIPTION"]=a;c["SYS-ARCHITECTURE"]=b.osArchitecture&&!b.osArchitecture.indexOf("64")?"x64":"x86";break}response=n.execQuery("SELECT manufacturer, product, serialNumber FROM Win32_BaseBoard WHERE hostingBoard = TRUE");
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.product))c["PCB-NAME"]=a;a&&(a=d.fun.clear(b.manufacturer,"Inc.").replace("Hewlett-Packard","HP"))&&(c["PCB-NAME"]=a.split(" ")[0]+" "+d.fun.clear(b.product));if(a=d.fun.clear(b.serialNumber))c["PCB-SERIAL"]=a;break}response=n.execQuery("SELECT releaseDate, manufacturer, smBIOSBIOSVersion, serialNumber FROM Win32_BIOS WHERE primaryBIOS = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();
if(a=d.fun.clear(b.releaseDate))c["PCB-BIOS-RELEASE"]=d.lib.date2str(d.fun.wql2date(a,A.getTimezoneOffset()),"d.m.Y H:i:s");if(a=d.fun.clear(b.releaseDate))c["PCB-BIOS-RELEASE-DATE"]=d.lib.date2str(d.fun.wql2date(a,A.getTimezoneOffset()),"d.m.Y");if(a=d.fun.clear(b.manufacturer,"Inc."))c["PCB-BIOS-MANUFACTURE"]=a;if(a=d.fun.clear(b.smBIOSBIOSVersion))c["PCB-BIOS-VERSION"]=a;if(a=d.fun.clear(b.serialNumber))c["PCB-BIOS-SERIAL"]=a;break}var u="";response=n.execQuery("SELECT * FROM Win32_NetworkAdapterConfiguration WHERE ipEnabled = TRUE");
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.interfaceIndex)u=a;if(null!=b.ipAddress){e=b.ipAddress.toArray();var g=0;for(var k=e.length;g<k;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-IP-V4"]&&(c["NET-IP-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-IP-V6"]&&(c["NET-IP-V6"]=a)}if(null!=b.defaultIPGateway)for(e=b.defaultIPGateway.toArray(),g=0,k=e.length;g<k;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-GATEWAY-V4"]&&(c["NET-GATEWAY-V4"]=a),a&&-1==a.indexOf(".")&&
!c["NET-GATEWAY-V6"]&&(c["NET-GATEWAY-V6"]=a);if(null!=b.dnsServerSearchOrder)for(e=b.dnsServerSearchOrder.toArray(),g=0,k=e.length;g<k;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-DNS-V4"]&&(c["NET-DNS-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-DNS-V6"]&&(c["NET-DNS-V6"]=a);if(null!=b.ipSubnet)for(e=b.ipSubnet.toArray(),g=0,k=e.length;g<k;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-SUBNET-V4"]&&(c["NET-SUBNET-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-SUBNET-V6"]&&(c["NET-SUBNET-V6"]=
a);if(a=d.fun.clear(b.dhcpServer))c["NET-DHCP-V4"]=a;if(a=d.fun.clear(b.description,"Сетевой адаптер","Адаптер","для виртуальной сети","Сетевая карта","Контроллер","NIC (NDIS 6.20)","- Минипорт планировщика пакетов","Family Controller","Adapter"))c["NET-NAME"]=a;if(a=d.fun.clear(b.macAddress))c["NET-MAC"]=a;break}e=0;response=n.execQuery("SELECT speed, timeOfLastReset FROM Win32_NetworkAdapter WHERE netEnabled = TRUE AND interfaceIndex = "+d.fun.repair(u));for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.speed)c["NET-SPEED"]=d.fun.info2str(a,0,1E3)+"бит/с";if(a=b.speed)c["NET-SPEED-VAL"]=a;if(a=b.timeOfLastReset)c["NET-RESET"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.timeOfLastReset)c["NET-RESET-DATE"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y");break}e&&(q=q?Math.min(q,e):e);response=n.execQuery("SELECT * FROM Win32_ComputerSystem");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.dnsHostName)p=a;if(a=b.name)p||(p=a.toLowerCase());
b.domain!=b.workgroup&&(r=b.domain);if(a=b.userName)var z=a.split(d.val.keyDelim)[0];if(a=b.userName)var y=a.split(d.val.keyDelim)[1];if(a=b.userName)var w=a;if(a=d.fun.clear(p))c["NET-HOST"]=a;if(a=d.fun.clear(b.domain))c["NET-DOMAIN"]=a;if(a=d.fun.clear(b.model))c["DEV-NAME"]=a;a&&(a=d.fun.clear(b.manufacturer,"Inc.","Hewlett-Packard"))&&(c["DEV-NAME"]=a.split(" ")[0]+" "+d.fun.clear(b.model));break}w||(e=[],f=m.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,
b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName="DefaultDomainName",b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&e.push(b.sValue),f=m.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName="DefaultUserName",b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&e.push(b.sValue),2==e.length&&(z=e[0]),2==e.length&&(y=e[1]),2==e.length&&(w=
e.join(d.val.keyDelim)));if(!w){e=null;response=n.execQuery("SELECT lastUseTime, localPath, loaded FROM Win32_UserProfile WHERE special = FALSE");for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),(a=e?0:1)||(a=b.loaded&&!e.loaded?1:a),a||(a=d.lib.compare(d.fun.wql2date(b.lastUseTime),d.fun.wql2date(e.lastUseTime))),0<a&&(e=b);if(b=e){if(a=b.localPath.split(d.val.keyDelim).pop())y=a;if(a=b.localPath)var F=a}}if(y){var h=n;g=[".",r];do{response=h.execQuery("SELECT domain, name, fullName, sid FROM Win32_UserAccount WHERE name = "+
d.fun.repair(y)+(z?" AND domain = "+d.fun.repair(z):""));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.fullName))c["USR-NAME"]=a;if(a=d.fun.clear(b.fullName)){e=a.split(d.val.argDelim);for(k=e.length-1;-1<k;k--)a=d.fun.clear(e[k],/[\[\(,\.\)\]]/g),(f=(f=3>a.length)||d.lib.hasValue(["von"],a,!0))?e.splice(k,1):e[k]=a;if(a=e[0])c["USR-NAME-FIRST"]=a;if(a=e[1])c["USR-NAME-SECOND"]=a;if(a=e[2])c["USR-NAME-THIRD"]=a;if(a=e[3])c["USR-NAME-FOURTH"]=a}e=[];if(a=b.sid)var C=
a;(a=b.domain)&&e.push(a);(a=b.name)&&e.push(a);2==e.length&&(z=e[0]);2==e.length&&(y=e[1]);2==e.length&&(w=e.join(d.val.keyDelim));break}try{h=!g.length||C?null:x.connectServer(g.shift(),"root\\CIMV2")}catch(B){h=null}}while(h)}if(w)for(response=n.execQuery("SELECT homeDirectory FROM Win32_NetworkLoginProfile WHERE name = "+d.fun.repair(w)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.homeDirectory)var I=a;break}if(!F&&C)for(response=n.execQuery("SELECT localPath FROM Win32_UserProfile WHERE sid = "+
d.fun.repair(C)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.localPath)F=a;break}if(a=d.fun.clear(C))c["USR-SID"]=a;if(a=d.fun.clear(w))c["USR-LOGIN"]=a;if(a=d.fun.clear(z))c["USR-DOMAIN"]=a;if(a=d.fun.clear(y))c["USR-ACCOUNT"]=a;if(a=d.fun.clear(F))c["USR-PROFILE"]=a;if(a=d.fun.clear(I))c["USR-HOME"]=a;if(p)for(response=G.execQuery("SELECT DS_distinguishedName FROM DS_computer WHERE DS_cn = "+d.fun.repair(p)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();
if(a=d.fun.clear(b.DS_distinguishedName))c["NET-HOST-DN"]=a;break}e=0;response=n.execQuery("SELECT architecture, maxClockSpeed, name, revision, numberOfCores, socketDesignation FROM Win32_Processor WHERE role = 'CPU'");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();0==b.architecture?c["CPU-ARCHITECTURE"]="x86":9==b.architecture&&(c["CPU-ARCHITECTURE"]="x64");if(a=b.maxClockSpeed)c["CPU-SPEED"]=d.fun.info2str(1E6*a,2,1E3)+"Гц";if(a=b.maxClockSpeed)c["CPU-SPEED-VAL"]=1E6*a;if(a=
d.fun.clear(b.name,"CPU","APU","Процессор","Processor","with","Radeon HD Graphics","11th Gen"))c["CPU-NAME"]=a;if(a=d.fun.clear(b.revision))c["CPU-VERSION"]=a;if(a=b.numberOfCores)c["CPU-CORE"]=a;if(a=d.fun.clear(b.socketDesignation,"SOCKET 0"))c["CPU-SOCKET"]=a;if(a=b.maxClockSpeed)e+=2.26143*Math.sqrt(a/1E3);if(a=b.numberOfCores)e*=1.02033*Math.sqrt(a);break}e&&(q=q?Math.min(q,e):e);response=n.execQuery("SELECT level, maxCacheSize FROM Win32_CacheMemory");for(f=new Enumerator(response);!f.atEnd();)if(b=
f.item(),f.moveNext(),a=b.maxCacheSize)c["CPU-CACHE-L"+(b.level-2)]=d.fun.info2str(1024*a,0)+"Б";h=e=0;response=n.execQuery("SELECT capacity, speed FROM Win32_PhysicalMemory");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.capacity)c["RAM-SIZE-VAL"]=h+=1*a;b.capacity&&(c["RAM-SIZE"]=d.fun.info2str(h,0)+"Б");if(a=b.speed)c["RAM-SPEED"]=a+" МГц";if(a=b.speed)c["RAM-SPEED-VAL"]=1E6*a;if(a=h)e=2.51143*Math.sqrt(a/1024/1024/1024);if(a=b.speed)e*=.92245*Math.sqrt(a/1E3)}e&&(q=
q?Math.min(q,e):e);response=n.execQuery("SELECT adapterRam, name, driverVersion, currentHorizontalResolution, currentRefreshRate, currentBitsPerPixel, currentVerticalResolution FROM Win32_VideoController");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.adapterRam)c["GPU-SIZE"]=d.fun.info2str(Math.abs(a),0)+"Б";if(a=b.adapterRam)c["GPU-SIZE-VAL"]=Math.abs(a);if(a=d.fun.clear(b.name,"GPU","Видеоустройство","Family","Chipset","Series","Graphics","Adapter"))c["GPU-NAME"]=a;
if(a=d.fun.clear(b.driverVersion))c["GPU-VERSION"]=a;b.currentHorizontalResolution&&b.currentVerticalResolution&&(c["GPU-RESOLUTION"]=b.currentHorizontalResolution+" x "+b.currentVerticalResolution);if(a=b.currentHorizontalResolution)c["GPU-RESOLUTION-X"]=a;if(a=b.currentVerticalResolution)c["GPU-RESOLUTION-Y"]=a;if(a=b.currentRefreshRate)c["GPU-FREQUENCY"]=d.fun.info2str(a,0,1E3)+"Гц";if(a=b.currentRefreshRate)c["GPU-FREQUENCY-VAL"]=a;if(a=b.currentBitsPerPixel)c["GPU-COLOR"]=d.fun.info2str(a,0)+
"бит"+d.lib.numDeclin(a,"","","а");if(a=b.currentBitsPerPixel)c["GPU-COLOR-VAL"]=a;break}e=0;response=t.execQuery("SELECT friendlyName, firmwareVersion, mediaType, serialNumber, size FROM MSFT_PhysicalDisk");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();switch(b.mediaType){case 0:h="USB";break;case 3:h="HDD";break;case 4:h="SSD";break;case 5:h="SCM";break;default:h=""}if((!b.friendlyName||-1==b.friendlyName.indexOf("Raid"))&&h&&!c[h+"-NAME"]){if(a=d.fun.clear(b.friendlyName,
"ATA Device","SCSI Disk Device","USB Device","SSD","SATA"))c[h+"-NAME"]=a;if(a=d.fun.clear(b.firmwareVersion))c[h+"-VERSION"]=a;if(a=d.fun.clear(b.serialNumber))c[h+"-SERIAL"]=a;if(a=b.size)c[h+"-SIZE"]=d.fun.info2str(a,0)+"Б";if(a=b.size)c[h+"-SIZE-VAL"]=a;h&&(e=Math.max(e,"SDD"==h?15.51143:7.14577))}}e&&(q=q?Math.min(q,e):e);response=n.execQuery("SELECT mediaType, caption, drive FROM Win32_CDROMDrive");for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),!b.caption||-1==b.caption.indexOf("Alcohol"))if(!b.caption||
...
a="";f=m.methods_.item("getStringValue");g=0;for(k=e.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(e=a.split(d.val.keyDelim),e.pop(),c["APP-CHROME"]=a,c["APP-CHROME-DIR"]=e.join(d.val.keyDelim));h="";e=["SOFTWARE\\VideoLAN\\VLC","SOFTWARE\\WOW6432Node\\VideoLAN\\VLC"];a="";f=m.methods_.item("getStringValue");g=0;for(k=e.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),
b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(e=a.split(d.val.keyDelim),e.pop(),c["APP-VLC"]=a,c["APP-VLC-DIR"]=e.join(d.val.keyDelim));h="ClientID";e=["SOFTWARE\\TeamViewer","SOFTWARE\\WOW6432Node\\TeamViewer"];a="";f=m.methods_.item("getDWORDValue");g=0;for(k=e.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&
...
if(l.input)try{h="windows-1251",a=v.stdIn.readAll(),l.charset!=h&&(a=d.wsh.iconv(l.charset,h,a))}catch(B){a=""}if(l.input&&a)switch(b=0,m="",t=a.split(d.val.linDelim),l.input){case "ini":b=d.lib.ini2obj(a,!1);for(h in b)!h||!b[h]||h in c||(c[h]=b[h]);break;case "TSV":m||(m=d.val.tsvDelim);case "CSV":m||(m=d.val.csvDelim),b<t.length&&(n=t[b++].split(m));case "tsv":m||(m=d.val.tsvDelim);case "csv":for(m||(m=d.val.csvDelim);b<t.length;)for(e=t[b++].split(m),g=0,k=n.length;g<k;g++)h=n[g],!h||!e[g]||h in
c||(c[h]=e[g])}if(l.output)switch(t=[],m="",l.output){case "ini":m=d.val.argDelim+d.val.iniDelim+d.val.argDelim;e=[];for(h in c)e.push(h);e.sort();g=0;for(k=e.length;g<k;g++)h=e[g],a=c[h]?c[h]:"",a=h+m+a,t.push(a);a=t.join(d.val.linDelim);break;case "TSV":m||(m=d.val.tsvDelim);case "CSV":m||(m=d.val.csvDelim);f=!0;e=[];g=0;for(k=n.length;g<k;g++)(h=n[g])&&(f=!1),e.push(h);a=n.join(m);f||t.push(a);case "tsv":m||(m=d.val.tsvDelim);case "csv":m||(m=d.val.csvDelim);f=!0;e=[];g=0;for(k=n.length;g<k;g++)h=
n[g],(a=c[h]?c[h]:"")&&(f=!1),e.push(a);a=e.join(m);f||t.push(a);a=t.join(d.val.linDelim)}if(l.output&&a){a+=d.val.linDelim;try{v.stdOut.write(a)}catch(B){}}f=E.environment(d.val.envType);for(h in c)a=c[h],setEnv(f,h,a);f=[];for(b=D;b<v.arguments.length;b++)a=v.arguments.item(b),a=a.split(d.val.getDelim).join(d.val.setDelim),(a=E.expandEnvironmentStrings(a))&&-1==a.indexOf(d.val.argDelim)||(a=d.val.argWrap+a+d.val.argWrap),f.push(a);if(c=f.join(d.val.argDelim)){D=l.silent?0:d.val.runStyle;try{a=E.run(c,
D,!l.nowait),l.nowait&&(a=d.val.defReturn)}catch(B){a=d.val.defReturn}}else a=d.val.defReturn;v.quit(a)}})})(WSH,env);env.init();
