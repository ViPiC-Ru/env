...
// 0.1.3-beta.1 функци для работы в среде windows script host
...
!c){b?(a=""+b,a=q.lib.template(a,{protocol:"LDAP:",parent:l,select:f}),a.toUpperCase().indexOf("WHERE")?a.toUpperCase().indexOf("SELECT")&&(d=2):a=f+" "+a):a=g?f+" WHERE distinguishedName = '"+l+"'":f;try{h.commandText=a,k=h.execute(),k.recordCount||(d=4)}catch(p){d=3}}if(!d&&c&&!g)if(e)m.push(e);else{a=c;try{e=GetObject("LDAP://"+a),m.push(e)}catch(p){d=5}}if(!d&&!c)for(b=0,f=k.recordCount;b<f;k.moveNext(),b++)a=k.fields("distinguishedName").value,b||(c=a),!g&&b&&(e=GetObject("LDAP://"+a),m.push(e));
...
(function(w,d,H){d.lib.extend(d,{fun:{wql2date:function(b){return new Date(Date.UTC(1*b.substr(0,4),1*b.substr(4,2)-1,1*b.substr(6,2),1*b.substr(8,2),1*b.substr(10,2)-1*b.substr(21,4),1*b.substr(12,2),1*b.substr(14,3)))},bin2key:function(b){var p="";var t=b.toArray();b=Math.floor(t[66]/6)&1;t[66]=t[66]&247|4*(b&2);for(var c=24;-1<c;c--){var k=0;for(var q=14;-1<q;q--)k*=256,k=t[q+52]+k,t[q+52]=Math.floor(k/24),k%=24;p="BCDFGHJKMPQRTVWXY2346789".substr(k,1)+p}1==b&&(b=p.substr(1,k),p=p.substr(1).replace(b,
b+"N"));return[p.substr(0,5),p.substr(5,5),p.substr(10,5),p.substr(15,5),p.substr(20,5)].join("-")},info2str:function(b,p,t){if(!t||2>t)t=1024;if(!p||0>p)p=0;var c=Math.pow(10,p);for(var k=-1;b>=t;k++)b/=t;b=Math.ceil(b*c)/c;b=d.lib.num2str(b,-1<k?p:0,",","");return b+=" "+"КМГТПЭЗЙ".charAt(k)},clear:function(b){b=b?""+b:"";"INVALID"==b&&(b="");"To be filled by O.E.M."==b&&(b="");"System Product Name"==b&&(b="");"System Serial Number"==b&&(b="");"System manufacturer"==b&&(b="");"Default string"==
b&&(b="");"empty"==b&&(b="");"None"==b&&(b="");for(var p=1,t=arguments.length;p<t;p++)b=b.replace(arguments[p],"");return b.replace(/\(R\)/gi,"").replace(/\(Registered Trademark\)/gi,"").replace(/\(Microsoft Corporation\)/gi,"").replace(/\(Корпорация Майкрософт\)/gi,"").replace(/\(Майкрософт\)/gi,"").replace(/\(TM\)/gi,"").replace(/^[/'"]|[/"']$/g,"").replace(/^\s+|\s+$/g,"").replace(/\.+$/,"").replace(/\s(?=\s)/gi,"")},repair:function(b){return("'"+(b?b:"")+"'").replace(/\\/g,"\\\\")}},init:function(){var b,
p="",t="";var c={};var k={},q=0;var v=new Date;for(b=0;b<w.arguments.length;b++){var a=w.arguments.item(b);if(!("context"in k)){var e=a.split(d.val.keyDelim);if(3==e.length&&!e[0]&&!e[1]){k.context=e[2];continue}}if(!("input"in k)&&(e=a.split(d.val.chrDelim),2==e.length&&d.lib.hasValue(["ini","csv","tsv","CSV","TSV"],e[0],!0)&&e[1])){k.input=e[0];k.charset=e[1];continue}if(!("output"in k)&&(e=a.split(d.val.chrDelim),1==e.length&&d.lib.hasValue(["ini","csv","tsv","CSV","TSV"],e[0],!0))){k.output=e[0];
continue}if("silent"in k||"silent"!=a)if("nowait"in k||"nowait"!=a)break;else k.nowait=!0;else k.silent=!0}var C=b;"context"in k||(k.context=".");"auto"==k.charset&&(k.charset="windows-1251");var D=new ActiveXObject("WScript.Shell");var x=new ActiveXObject("wbemScripting.Swbemlocator");x.security_.impersonationLevel=3;if(k.context)try{var n=x.connectServer(k.context,"root\\CIMV2");var F=x.connectServer(k.context,"root\\directory\\LDAP");var u=x.connectServer(k.context,"root\\Microsoft\\Windows\\Storage");
var m=x.connectServer(k.context,"root\\default").get("stdRegProv")}catch(y){n=null}if(n){var f=m.methods_.item("getBinaryValue");b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";b.sValueName="DigitalProductId";b=m.execMethod_(f.name,b);b.returnValue||(a=d.fun.bin2key(b.uValue))&&"BBBBB-BBBBB-BBBBB-BBBBB-BBBBB"!=a&&(c["SYS-KEY"]=a);response=n.execQuery("SELECT * FROM Win32_OperatingSystem WHERE primary = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.systemDrive)var G=a;if(a=b.localDateTime)v=d.fun.wql2date(a);if(a=d.fun.clear(b.caption,"Майкрософт","Microsoft","Edition","x64",","))c["SYS-NAME"]=a;if(a=d.fun.clear(b.version))c["SYS-VERSION"]=a;if(a=b.localDateTime)c["SYS-TIME"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=d.fun.clear(b.systemDrive))c["SYS-DRIVE"]=a;if(a=b.installDate)c["SYS-INSTALL"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.lastBootUpTime)c["SYS-RESET"]=d.lib.date2str(d.fun.wql2date(a),
"d.m.Y H:i:s");if(a=d.fun.clear(b.serialNumber))c["SYS-SERIAL"]=a;if(a=d.fun.clear(b.description))c["SYS-DESCRIPTION"]=a;c["SYS-ARCHITECTURE"]=b.osArchitecture&&!b.osArchitecture.indexOf("64")?"x64":"x86";break}response=n.execQuery("SELECT manufacturer, product, serialNumber FROM Win32_BaseBoard WHERE hostingBoard = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.product))c["PCB-NAME"]=a;a&&(a=d.fun.clear(b.manufacturer,"Inc."))&&(c["PCB-NAME"]=a.split(" ")[0]+
" "+d.fun.clear(b.product));if(a=d.fun.clear(b.serialNumber))c["PCB-SERIAL"]=a;break}response=n.execQuery("SELECT releaseDate, manufacturer, smBIOSBIOSVersion, serialNumber FROM Win32_BIOS WHERE primaryBIOS = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.releaseDate))c["PCB-BIOS-RELEASE"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=d.fun.clear(b.manufacturer,"Inc."))c["PCB-BIOS-MANUFACTURE"]=a;if(a=d.fun.clear(b.smBIOSBIOSVersion))c["PCB-BIOS-VERSION"]=
a;if(a=d.fun.clear(b.serialNumber))c["PCB-BIOS-SERIAL"]=a;break}var r="";response=n.execQuery("SELECT * FROM Win32_NetworkAdapterConfiguration WHERE ipEnabled = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.interfaceIndex)r=a;if(null!=b.ipAddress){e=b.ipAddress.toArray();for(var g=0,l=e.length;g<l;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-IP-V4"]&&(c["NET-IP-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-IP-V6"]&&(c["NET-IP-V6"]=a)}if(null!=b.defaultIPGateway)for(e=
b.defaultIPGateway.toArray(),g=0,l=e.length;g<l;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-GATEWAY-V4"]&&(c["NET-GATEWAY-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-GATEWAY-V6"]&&(c["NET-GATEWAY-V6"]=a);if(null!=b.dnsServerSearchOrder)for(e=b.dnsServerSearchOrder.toArray(),g=0,l=e.length;g<l;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-DNS-V4"]&&(c["NET-DNS-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-DNS-V6"]&&(c["NET-DNS-V6"]=a);if(null!=b.ipSubnet)for(e=b.ipSubnet.toArray(),g=0,l=e.length;g<
l;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-SUBNET-V4"]&&(c["NET-SUBNET-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-SUBNET-V6"]&&(c["NET-SUBNET-V6"]=a);if(a=d.fun.clear(b.dhcpServer))c["NET-DHCP-V4"]=a;if(a=d.fun.clear(b.description,"Сетевой адаптер","Адаптер","для виртуальной сети","Сетевая карта","Контроллер","NIC (NDIS 6.20)","- Минипорт планировщика пакетов","Family Controller","Adapter"))c["NET-NAME"]=a;if(a=d.fun.clear(b.macAddress))c["NET-MAC"]=a;break}e=0;response=n.execQuery("SELECT speed, timeOfLastReset FROM Win32_NetworkAdapter WHERE netEnabled = TRUE AND interfaceIndex = "+
d.fun.repair(r));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.speed)c["NET-SPEED"]=d.fun.info2str(a,0,1E3)+"бит/с";if(a=b.speed)c["NET-SPEED-VAL"]=a;if(a=b.timeOfLastReset)c["NET-RESET"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.speed)e+=8.12567*Math.sqrt(a/100/1E3/1E3);break}e&&(q=q?Math.min(q,e):e);r="";response=n.execQuery("SELECT * FROM Win32_ComputerSystem");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.dnsHostName)p=a;if(a=
b.name)p||(p=a.toLowerCase());b.domain!=b.workgroup&&(t=b.domain);if(a=b.userName)var z=r=a;if(a=b.userName)var A=a.split(d.val.keyDelim)[0];if(a=b.userName)var B=a.split(d.val.keyDelim)[1];if(a=d.fun.clear(p))c["NET-HOST"]=a;if(a=d.fun.clear(b.domain))c["NET-DOMAIN"]=a;if(a=d.fun.clear(z))c["USR-LOGIN"]=a;if(a=d.fun.clear(A))c["USR-DOMAIN"]=a;if(a=d.fun.clear(B))c["USR-ACCOUNT"]=a;if(a=d.fun.clear(b.model))c["DEV-NAME"]=a;a&&(a=d.fun.clear(b.manufacturer,"Inc."))&&(c["DEV-NAME"]=a.split(" ")[0]+
" "+d.fun.clear(b.model));break}if(!r){e=[];f=m.methods_.item("getStringValue");b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon";b.sValueName="DefaultDomainName";b=m.execMethod_(f.name,b);!b.returnValue&&b.sValue&&e.push(b.sValue);f=m.methods_.item("getStringValue");b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon";b.sValueName="DefaultUserName";
b=m.execMethod_(f.name,b);!b.returnValue&&b.sValue&&e.push(b.sValue);2==e.length&&(z=e.join(d.val.keyDelim));2==e.length&&(A=e[0]);2==e.length&&(B=e[1]);if(a=d.fun.clear(z))c["USR-LOGIN"]=a;if(a=d.fun.clear(A))c["USR-DOMAIN"]=a;if(a=d.fun.clear(B))c["USR-ACCOUNT"]=a}var h=n;r="";e=[".",t];do{response=h.execQuery("SELECT fullName, sid FROM Win32_UserAccount WHERE domain = "+d.fun.repair(A)+" AND name = "+d.fun.repair(B));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.sid)var E=
r=a;if(a=d.fun.clear(b.fullName))c["USR-NAME"]=a;if(a=d.fun.clear(E))c["USR-SID"]=a;break}try{h=!e.length||r?null:x.connectServer(e.shift(),"root\\CIMV2")}catch(y){h=null}}while(h);response=n.execQuery("SELECT localPath FROM Win32_UserProfile WHERE sid = "+d.fun.repair(E));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.localPath))c["USR-PROFILE"]=a;break}response=n.execQuery("SELECT homeDirectory FROM Win32_NetworkLoginProfile WHERE name = "+d.fun.repair(z));
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.homeDirectory))c["USR-HOME"]=a;break}if(p)for(response=F.execQuery("SELECT DS_distinguishedName FROM DS_computer WHERE DS_cn = "+d.fun.repair(p)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.DS_distinguishedName))c["NET-HOST-DN"]=a;break}e=0;response=n.execQuery("SELECT architecture, maxClockSpeed, name, revision, numberOfCores, socketDesignation FROM Win32_Processor WHERE role = 'CPU'");
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();0==b.architecture?c["CPU-ARCHITECTURE"]="x86":9==b.architecture&&(c["CPU-ARCHITECTURE"]="x64");if(a=b.maxClockSpeed)c["CPU-SPEED"]=d.fun.info2str(1E6*a,2,1E3)+"Гц";if(a=b.maxClockSpeed)c["CPU-SPEED-VAL"]=1E6*a;if(a=d.fun.clear(b.name,"CPU","APU","Процессор","Processor","with","Radeon HD Graphics"))c["CPU-NAME"]=a;if(a=d.fun.clear(b.revision))c["CPU-VERSION"]=a;if(a=b.numberOfCores)c["CPU-CORE"]=a;if(a=d.fun.clear(b.socketDesignation,
"SOCKET 0"))c["CPU-SOCKET"]=a;if(a=b.maxClockSpeed)e+=2.26143*Math.sqrt(a/1E3);if(a=b.numberOfCores)e*=1.02033*Math.sqrt(a);break}e&&(q=q?Math.min(q,e):e);response=n.execQuery("SELECT level, maxCacheSize FROM Win32_CacheMemory");for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),a=b.maxCacheSize)c["CPU-CACHE-L"+(b.level-2)]=d.fun.info2str(1024*a,0)+"Б";h=e=0;response=n.execQuery("SELECT capacity, speed FROM Win32_PhysicalMemory");for(f=new Enumerator(response);!f.atEnd();){b=f.item();
f.moveNext();if(a=b.capacity)c["RAM-SIZE-VAL"]=h+=1*a;b.capacity&&(c["RAM-SIZE"]=d.fun.info2str(h,0)+"Б");if(a=b.speed)c["RAM-SPEED"]=a+" МГц";if(a=b.speed)c["RAM-SPEED-VAL"]=1E6*a;if(a=h)e=2.51143*Math.sqrt(a/1024/1024/1024);if(a=b.speed)e*=.92245*Math.sqrt(a/1E3)}e&&(q=q?Math.min(q,e):e);response=n.execQuery("SELECT adapterRam, name, driverVersion, currentHorizontalResolution, currentRefreshRate, currentBitsPerPixel, currentVerticalResolution FROM Win32_VideoController");for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.adapterRam)c["GPU-SIZE"]=d.fun.info2str(Math.abs(a),0)+"Б";if(a=b.adapterRam)c["GPU-SIZE-VAL"]=Math.abs(a);if(a=d.fun.clear(b.name,"GPU","Видеоустройство","Family","Chipset","Series","Graphics","Adapter"))c["GPU-NAME"]=a;if(a=d.fun.clear(b.driverVersion))c["GPU-VERSION"]=a;b.currentHorizontalResolution&&b.currentVerticalResolution&&(c["GPU-RESOLUTION"]=b.currentHorizontalResolution+" x "+b.currentVerticalResolution);if(a=b.currentHorizontalResolution)c["GPU-RESOLUTION-X"]=
a;if(a=b.currentVerticalResolution)c["GPU-RESOLUTION-Y"]=a;if(a=b.currentRefreshRate)c["GPU-FREQUENCY"]=d.fun.info2str(a,0,1E3)+"Гц";if(a=b.currentRefreshRate)c["GPU-FREQUENCY-VAL"]=a;if(a=b.currentBitsPerPixel)c["GPU-COLOR"]=d.fun.info2str(a,0)+"бит"+d.lib.numDeclin(a,"","","а");if(a=b.currentBitsPerPixel)c["GPU-COLOR-VAL"]=a;break}e=0;response=u.execQuery("SELECT friendlyName, firmwareVersion, mediaType, serialNumber, size FROM MSFT_PhysicalDisk");for(f=new Enumerator(response);!f.atEnd();){b=f.item();
f.moveNext();switch(b.mediaType){case 0:h="USB";break;case 3:h="HDD";break;case 4:h="SSD";break;case 5:h="SCM";break;default:h=""}if((!b.friendlyName||-1==b.friendlyName.indexOf("Raid"))&&h&&!c[h+"-NAME"]){if(a=d.fun.clear(b.friendlyName,"ATA Device","SCSI Disk Device","USB Device","SSD","SATA"))c[h+"-NAME"]=a;if(a=d.fun.clear(b.firmwareVersion))c[h+"-VERSION"]=a;if(a=d.fun.clear(b.serialNumber))c[h+"-SERIAL"]=a;if(a=b.size)c[h+"-SIZE"]=d.fun.info2str(a,0)+"Б";if(a=b.size)c[h+"-SIZE-VAL"]=a;h&&(e=
Math.max(e,"SDD"==h?15.51143:7.14577))}}e&&(q=q?Math.min(q,e):e);response=n.execQuery("SELECT mediaType, caption, drive FROM Win32_CDROMDrive");for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),!b.caption||-1==b.caption.indexOf("Alcohol"))if(!b.caption||-1==b.caption.indexOf("Virtual")){switch(b.mediaType){case "CD-ROM":c["ROM-TYPE"]="CD";break;case "DVD-ROM":c["ROM-TYPE"]="DVD";break;case "CD Writer":c["ROM-TYPE"]="CD-RW";break;case "DVD Writer":c["ROM-TYPE"]="DVD-RW"}if(a=d.fun.clear(b.caption,
"ATA Device","SCSI CdRom Device"))c["ROM-NAME"]=a;if(a=d.fun.clear(b.drive))c["ROM-DRIVE"]=a;break}response=n.execQuery("SELECT caption, size FROM Win32_LogicalDisk WHERE driveType = 2 OR driveType = 3 OR driveType = 4");for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),b.caption&&-1!=b.caption.indexOf(G)||c["BAK-DRIVE"]||(a=d.fun.clear(b.caption))&&b.size>=d.val.driveMinSize&&(c["BAK-DRIVE"]=a);r="";h="DisplayIcon";e=["SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL",
"SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма"];a="";f=m.methods_.item("getStringValue");g=0;for(l=e.length;g<l&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(e=a.split(d.val.keyDelim),e.pop(),
e.pop(),r=e.join(d.val.keyDelim),c["APP-EFARMA-DIR"]=r);h="\\Client\\ePlus.Client.exe";e=[r];a="";g=0;for(l=e.length;g<l;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,l=e.length;g<l;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-CLIENT"]=a;break}h="\\ARM\\ePlus.ARMCasherNew.exe";e=[r];a="";g=0;for(l=e.length;g<l;g++)g&&(a+=" OR "),
a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,l=e.length;g<l;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-CASHER"]=a;break}h="\\UpdateServer\\ePlus.UpdateServer.exe";e=[r];a="";g=0;for(l=e.length;g<l;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=
f.item(),f.moveNext(),g=0,l=e.length;g<l;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-UPDATER"]=a;break}h="lic";e=[r+"\\UpdateServer\\",r+"\\Client\\",r+"\\ARM\\"];a="";g=0;for(l=e.length;g<l;g++)g&&(a+=" OR "),a+="drive = "+d.fun.repair(d.lib.strim(e[g],"",":",!0,!1))+" ",a+="AND path = "+d.fun.repair(d.lib.strim(e[g],":","",!1,!1))+" ",a+="AND extension = "+d.fun.repair(h);response=n.execQuery("SELECT name, fileName FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=
f.item(),f.moveNext(),g=0,l=e.length;g<l;g++)if(a=e[g]+b.fileName+"."+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-LICENSE"]=a;break}a=d.lib.date2str(v,"Y");h="\\ULUS.exe";e=["C:\\SoftLink\\Ulus\\"+a,"C:\\LO\\ULUS\\"+a,"C:\\so\\Ulus\\"+a,"C:\\ULUS\\"+a];a="";g=0;for(l=e.length;g<l;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,l=e.length;g<
l;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-ULUS"]=a;c["APP-ULUS-DIR"]=e[g];break}h="";e=["SOFTWARE\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command","SOFTWARE\\WOW6432Node\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command"];a="";f=m.methods_.item("getStringValue");g=0;for(l=e.length;g<l&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));
a&&(e=a.split(d.val.keyDelim),e.pop(),c["APP-CHROME"]=a,c["APP-CHROME-DIR"]=e.join(d.val.keyDelim));h="";e=["SOFTWARE\\VideoLAN\\VLC","SOFTWARE\\WOW6432Node\\VideoLAN\\VLC"];a="";f=m.methods_.item("getStringValue");g=0;for(l=e.length;g<l&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(e=a.split(d.val.keyDelim),e.pop(),c["APP-VLC"]=a,c["APP-VLC-DIR"]=e.join(d.val.keyDelim));
h="ClientID";e=["SOFTWARE\\TeamViewer","SOFTWARE\\WOW6432Node\\TeamViewer"];a="";f=m.methods_.item("getDWORDValue");g=0;for(l=e.length;g<l&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.uValue&&(a=d.fun.clear(b.uValue));a&&(c["APP-TEAMVIEWER-ID"]=a);a=p.toLowerCase();0==a.indexOf(d.val.aptPref)&&(a=a.substr(d.val.aptPref.length,d.val.aptLen),isNaN(a)||(c["APT-NUMBER"]=a||d.val.aptNone,c["APT-NUMBER-VAL"]=
Number(a)));a=p.toLowerCase();0==a.indexOf(d.val.aptPref)&&((a=a.substr(d.val.aptPref.length+d.val.aptLen))?0==a.indexOf(d.val.wsPref)?(a=a.substr(d.val.wsPref.length,d.val.wsLen),a=isNaN(a)?0:Number(a)):a=0:a=1,c["APT-COMPUTER-VAL"]=a,c["APT-COMPUTER"]=0==a?d.val.wsNoneDesc:1==a?d.val.wsFirstDesc:d.val.wsNextDesc);e=[];c["CPU-NAME"]&&c["CPU-CORE"]&&c["CPU-SPEED"]&&e.push(d.fun.clear(c["CPU-NAME"].replace("Dual-Core","Intel"),"Dual Core","Xeon","Pentium","Celeron","Core2 Duo","Core","Processor","Athlon 64",
"Athlon",/,.+/,/@.+/,/\d\.d+GHz/)+" "+c["CPU-CORE"]+"x"+c["CPU-SPEED"].replace(",",".").replace(" МГц","M").replace(" ГГц","G")+"Hz");c["RAM-SIZE"]&&c["RAM-SPEED"]&&e.push(c["RAM-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+c["RAM-SPEED"].replace(" МГц","M").replace(" ГГц","G")+"Hz");c["GPU-SIZE"]&&c["GPU-NAME"]&&(-1!=c["GPU-NAME"].indexOf("GeForce")||-1!=c["GPU-NAME"].indexOf("Radeon"))&&e.push(c["GPU-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+d.fun.clear(c["GPU-NAME"],"AMD","NVIDIA",
"GeForce","Radeon",/\(.+/));c["HDD-SIZE"]&&e.push(c["HDD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" HDD");c["SSD-SIZE"]&&e.push(c["SSD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" SSD");c["USB-SIZE"]&&e.push(c["USB-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" USB");c["ROM-TYPE"]&&e.push(c["ROM-TYPE"]);e.length&&(c["DEV-DESCRIPTION"]=e.join("/"));q&&(c["DEV-BENCHMARK"]=d.lib.num2str(q,5,",",""))}n="SYS-KEY SYS-NAME SYS-VERSION SYS-TIME SYS-ARCHITECTURE SYS-DRIVE SYS-INSTALL SYS-RESET SYS-SERIAL PCB-NAME PCB-SERIAL PCB-BIOS-MANUFACTURE PCB-BIOS-RELEASE PCB-BIOS-VERSION PCB-BIOS-SERIAL NET-IP-V4 NET-GATEWAY-V4 NET-DNS-V4 NET-SUBNET-V4 NET-DHCP-V4 NET-NAME NET-MAC NET-SPEED NET-RESET NET-HOST NET-DOMAIN USR-LOGIN USR-DOMAIN USR-ACCOUNT USR-NAME USR-SID USR-PROFILE CPU-ARCHITECTURE CPU-SPEED CPU-NAME CPU-CORE CPU-SOCKET CPU-CACHE-L1 CPU-CACHE-L2 CPU-CACHE-L3 RAM-SIZE RAM-SPEED GPU-SIZE GPU-NAME GPU-VERSION GPU-RESOLUTION GPU-FREQUENCY GPU-COLOR SSD-NAME SSD-VERSION SSD-SERIAL SSD-SIZE HDD-NAME HDD-VERSION HDD-SERIAL HDD-SIZE USB-NAME USB-VERSION USB-SERIAL USB-SIZE ROM-TYPE ROM-NAME ROM-DRIVE ROM-VERSION DEV-NAME DEV-DESCRIPTION DEV-BENCHMARK".split(" ");
if(k.input)try{h="windows-1251",a=w.stdIn.readAll(),k.charset!=h&&(a=d.wsh.iconv(k.charset,h,a))}catch(y){a=""}if(k.input&&a)switch(b=0,m="",u=a.split(d.val.linDelim),k.input){case "ini":b=d.lib.ini2obj(a,!1);for(h in b)!h||!b[h]||h in c||(c[h]=b[h]);break;case "TSV":m||(m=d.val.tsvDelim);case "CSV":m||(m=d.val.csvDelim),b<u.length&&(n=u[b++].split(m));case "tsv":m||(m=d.val.tsvDelim);case "csv":for(m||(m=d.val.csvDelim);b<u.length;)for(e=u[b++].split(m),g=0,l=n.length;g<l;g++)h=n[g],!h||!e[g]||h in
c||(c[h]=e[g])}if(k.output)switch(u=[],m="",k.output){case "ini":m=d.val.argDelim+d.val.iniDelim+d.val.argDelim;e=[];for(h in c)e.push(h);e.sort();g=0;for(l=e.length;g<l;g++)h=e[g],a=c[h]?c[h]:"",a=h+m+a,u.push(a);a=u.join(d.val.linDelim);break;case "TSV":m||(m=d.val.tsvDelim);case "CSV":m||(m=d.val.csvDelim);v=!0;e=[];g=0;for(l=n.length;g<l;g++)(h=n[g])&&(v=!1),e.push(h);a=n.join(m);v||u.push(a);case "tsv":m||(m=d.val.tsvDelim);case "csv":m||(m=d.val.csvDelim);v=!0;e=[];g=0;for(l=n.length;g<l;g++)h=
n[g],(a=c[h]?c[h]:"")&&(v=!1),e.push(a);a=e.join(m);v||u.push(a);a=u.join(d.val.linDelim)}if(k.output&&a){a+=d.val.linDelim;try{w.stdOut.write(a)}catch(y){}}f=D.environment(d.val.envType);for(h in c)a=c[h],setEnv(f,h,a);f=[];for(b=C;b<w.arguments.length;b++)a=w.arguments.item(b),a=a.split(d.val.getDelim).join(d.val.setDelim),a=D.expandEnvironmentStrings(a),-1!=a.indexOf(d.val.argDelim)&&(a=d.val.argWrap+a+d.val.argWrap),f.push(a);if(c=f.join(d.val.argDelim)){C=k.silent?0:d.val.runStyle;try{a=D.run(c,
C,!k.nowait),k.nowait&&(a=d.val.defReturn)}catch(y){a=d.val.defReturn}}else a=d.val.defReturn;w.quit(a)}})})(WSH,env);env.init();
