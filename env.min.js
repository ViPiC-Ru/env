...
(function(x,d,H){d.lib.extend(d,{fun:{wql2date:function(h){return new Date(Date.UTC(1*h.substr(0,4),1*h.substr(4,2)-1,1*h.substr(6,2),1*h.substr(8,2),1*h.substr(10,2)-1*h.substr(21,4),1*h.substr(12,2),1*h.substr(14,3)))},bin2key:function(h){var m="";var q=h.toArray();h=Math.floor(q[66]/6)&1;q[66]=q[66]&247|4*(h&2);for(var v=24;-1<v;v--){var t=0;for(var c=14;-1<c;c--)t*=256,t=q[c+52]+t,q[c+52]=Math.floor(t/24),t%=24;m="BCDFGHJKMPQRTVWXY2346789".substr(t,1)+m}1==h&&(h=m.substr(1,t),m=m.substr(1).replace(h,
h+"N"));return[m.substr(0,5),m.substr(5,5),m.substr(10,5),m.substr(15,5),m.substr(20,5)].join("-")},info2str:function(h,m,q){if(!q||2>q)q=1024;if(!m||0>m)m=0;var v=Math.pow(10,m);for(var t=-1;h>=q;t++)h/=q;h=Math.ceil(h*v)/v;h=d.lib.num2str(h,-1<t?m:0,",","");return h+=" "+"КМГТПЭЗЙ".charAt(t)},clear:function(h){h=h?""+h:"";"INVALID"==h&&(h="");"To be filled by O.E.M."==h&&(h="");"Default string"==h&&(h="");"empty"==h&&(h="");"None"==h&&(h="");for(var m=1,q=arguments.length;m<q;m++)h=h.replace(arguments[m],
"");return h.replace(/^['"]|["']$/g,"").replace(/^\s+|\s+$/g,"").replace(/\.+$/,"").replace(/\(R\)/gi,"").replace(/\(Registered Trademark\)/gi,"").replace(/\(Microsoft Corporation\)/gi,"").replace(/\(Корпорация Майкрософт\)/gi,"").replace(/\(Майкрософт\)/gi,"").replace(/\(TM\)/gi,"").replace(/\s(?=\s)/gi,"")},repair:function(h){return("'"+(h?h:"")+"'").replace(/\\/g,"\\\\")}},init:function(){var h,m=0;var q=0;var v="",t="",c={};var E=new Date;var r=".";if(0<x.arguments.length){var a=x.arguments.item(0);
a.indexOf("\\\\")||-1!=a.indexOf("\\",2)||(r=h=a.substr(2),q++)}var F=new ActiveXObject("WScript.Shell");var y=new ActiveXObject("MSXML2.DOMDocument");var z=new ActiveXObject("Scripting.FileSystemObject");var w=new ActiveXObject("wbemScripting.Swbemlocator");w.security_.impersonationLevel=3;try{var p=w.connectServer(r,"root\\CIMV2");var u=w.connectServer(r,"root\\default").get("stdRegProv")}catch(G){p=null}if(p){var f=u.methods_.item("getBinaryValue");var b=f.inParameters.spawnInstance_();b.hDefKey=
2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";b.sValueName="DigitalProductId";b=u.execMethod_(f.name,b);b.returnValue||(a=d.fun.bin2key(b.uValue))&&"BBBBB-BBBBB-BBBBB-BBBBB-BBBBB"!=a&&(c["SYS-KEY"]=a);response=p.execQuery("SELECT * FROM Win32_OperatingSystem WHERE primary = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.systemDrive)var n=a;if(a=b.localDateTime)E=d.fun.wql2date(a);if(a=d.fun.clear(b.caption,"Майкрософт","Microsoft","Edition",
"x64",","))c["SYS-NAME"]=a;if(a=d.fun.clear(b.version))c["SYS-VERSION"]=a;if(a=b.localDateTime)c["SYS-TIME"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=d.fun.clear(b.systemDrive))c["SYS-DRIVE"]=a;if(a=b.installDate)c["SYS-INSTALL"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.lastBootUpTime)c["SYS-RESET"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=d.fun.clear(b.serialNumber))c["SYS-SERIAL"]=a;if(a=d.fun.clear(b.description))c["SYS-DESCRIPTION"]=a;c["SYS-ARCHITECTURE"]=
b.osArchitecture&&!b.osArchitecture.indexOf("64")?"x64":"x86";break}response=p.execQuery("SELECT manufacturer, product, serialNumber FROM Win32_BaseBoard WHERE hostingBoard = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.product))c["PCB-NAME"]=a;a&&(a=d.fun.clear(b.manufacturer))&&(c["PCB-NAME"]=a.split(" ")[0]+" "+d.fun.clear(b.product));if(a=d.fun.clear(b.serialNumber))c["PCB-SERIAL"]=a;break}r="";response=p.execQuery("SELECT * FROM Win32_NetworkAdapterConfiguration WHERE ipEnabled = TRUE");
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.interfaceIndex)r=a;if(null!=b.ipAddress){var g=b.ipAddress.toArray();var e=0;for(var l=g.length;e<l;e++)(a=d.fun.clear(g[e]))&&-1!=a.indexOf(".")&&!c["NET-IP-V4"]&&(c["NET-IP-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-IP-V6"]&&(c["NET-IP-V6"]=a)}if(null!=b.defaultIPGateway)for(g=b.defaultIPGateway.toArray(),e=0,l=g.length;e<l;e++)(a=d.fun.clear(g[e]))&&-1!=a.indexOf(".")&&!c["NET-GATEWAY-V4"]&&(c["NET-GATEWAY-V4"]=a),a&&-1==a.indexOf(".")&&
!c["NET-GATEWAY-V6"]&&(c["NET-GATEWAY-V6"]=a);if(null!=b.dnsServerSearchOrder)for(g=b.dnsServerSearchOrder.toArray(),e=0,l=g.length;e<l;e++)(a=d.fun.clear(g[e]))&&-1!=a.indexOf(".")&&!c["NET-DNS-V4"]&&(c["NET-DNS-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-DNS-V6"]&&(c["NET-DNS-V6"]=a);if(null!=b.ipSubnet)for(g=b.ipSubnet.toArray(),e=0,l=g.length;e<l;e++)(a=d.fun.clear(g[e]))&&-1!=a.indexOf(".")&&!c["NET-SUBNET-V4"]&&(c["NET-SUBNET-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-SUBNET-V6"]&&(c["NET-SUBNET-V6"]=
a);if(a=d.fun.clear(b.dhcpServer))c["NET-DHCP-V4"]=a;if(a=d.fun.clear(b.description,"Сетевой адаптер","Адаптер","для виртуальной сети","Сетевая карта","Контроллер","NIC (NDIS 6.20)","- Минипорт планировщика пакетов"))c["NET-NAME"]=a;if(a=d.fun.clear(b.macAddress))c["NET-MAC"]=a;break}e=0;response=p.execQuery("SELECT speed, timeOfLastReset FROM Win32_NetworkAdapter WHERE netEnabled = TRUE AND interfaceIndex = "+d.fun.repair(r));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=
b.speed)c["NET-SPEED"]=d.fun.info2str(a,0,1E3)+"бит/с";if(a=b.speed)c["NET-SPEED-VAL"]=a;if(a=b.timeOfLastReset)c["NET-RESET"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.speed)e+=8.12567*Math.sqrt(a/100/1E3/1E3);break}e&&(m=m?Math.min(m,e):e);r="";response=p.execQuery("SELECT * FROM Win32_ComputerSystem");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.dnsHostName)v=a;if(a=b.name)v||(v=a.toLowerCase());b.domain!=b.workgroup&&(t=b.domain);if(a=b.userName)var C=
r=a;if(a=b.userName)var A=a.split("\\")[0];if(a=b.userName)var B=a.split("\\")[1];if(a=d.fun.clear(v))c["NET-HOST"]=a;if(a=d.fun.clear(b.domain))c["NET-DOMAIN"]=a;if(a=d.fun.clear(C))c["USR-LOGIN"]=a;if(a=d.fun.clear(A))c["USR-DOMAIN"]=a;if(a=d.fun.clear(B))c["USR-ACCOUNT"]=a;break}if(!r){g=[];f=u.methods_.item("getStringValue");b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon";b.sValueName="DefaultDomainName";b=u.execMethod_(f.name,
b);!b.returnValue&&b.sValue&&g.push(b.sValue);f=u.methods_.item("getStringValue");b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon";b.sValueName="DefaultUserName";b=u.execMethod_(f.name,b);!b.returnValue&&b.sValue&&g.push(b.sValue);2==g.length&&(C=g.join("\\"));2==g.length&&(A=g[0]);2==g.length&&(B=g[1]);if(a=d.fun.clear(C))c["USR-LOGIN"]=a;if(a=d.fun.clear(A))c["USR-DOMAIN"]=a;if(a=d.fun.clear(B))c["USR-ACCOUNT"]=a}response=
p.execQuery("SELECT fullName, sid FROM Win32_UserAccount WHERE domain = "+d.fun.repair(A)+" AND name = "+d.fun.repair(B));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.sid)var D=a;if(a=d.fun.clear(b.fullName))c["USR-NAME"]=a;if(a=d.fun.clear(D))c["USR-SID"]=a;break}try{for(response=w.connectServer(t,"root\\CIMV2").execQuery("SELECT fullName, sid FROM Win32_UserAccount WHERE domain = "+d.fun.repair(A)+" AND name = "+d.fun.repair(B)),f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.sid)D=a;if(a=d.fun.clear(b.fullName))c["USR-NAME"]=a;if(a=d.fun.clear(D))c["USR-SID"]=a;break}}catch(G){}response=p.execQuery("SELECT localPath FROM Win32_UserProfile WHERE sid = "+d.fun.repair(D));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.localPath))c["USR-PROFILE"]=a;break}response=p.execQuery("SELECT homeDirectory FROM Win32_NetworkLoginProfile WHERE name = "+d.fun.repair(C));for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=d.fun.clear(b.homeDirectory))c["USR-HOME"]=a;break}e=0;response=p.execQuery("SELECT architecture, maxClockSpeed, name, revision, numberOfCores, socketDesignation FROM Win32_Processor WHERE role = 'CPU'");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();0==b.architecture?c["CPU-ARCHITECTURE"]="x86":9==b.architecture&&(c["CPU-ARCHITECTURE"]="x64");if(a=b.maxClockSpeed)c["CPU-SPEED"]=d.fun.info2str(1E6*a,2,1E3)+"Гц";if(a=b.maxClockSpeed)c["CPU-SPEED-VAL"]=
1E6*a;if(a=d.fun.clear(b.name,"CPU","APU","Процессор","Processor","with","Radeon HD Graphics"))c["CPU-NAME"]=a;if(a=d.fun.clear(b.revision))c["CPU-VERSION"]=a;if(a=b.numberOfCores)c["CPU-CORE"]=a;if(a=d.fun.clear(b.socketDesignation,"SOCKET 0"))c["CPU-SOCKET"]=a;if(a=b.maxClockSpeed)e+=2.26143*Math.sqrt(a/1E3);if(a=b.numberOfCores)e*=1.02033*Math.sqrt(a);break}e&&(m=m?Math.min(m,e):e);response=p.execQuery("SELECT level, maxCacheSize FROM Win32_CacheMemory");for(f=new Enumerator(response);!f.atEnd();)if(b=
f.item(),f.moveNext(),a=b.maxCacheSize)c["CPU-CACHE-L"+(b.level-2)]=d.fun.info2str(1024*a,0)+"Б";var k=e=0;response=p.execQuery("SELECT capacity, speed FROM Win32_PhysicalMemory");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.capacity)c["RAM-SIZE-VAL"]=k+=1*a;b.capacity&&(c["RAM-SIZE"]=d.fun.info2str(k,0)+"Б");if(a=b.speed)c["RAM-SPEED"]=a+" МГц";if(a=b.speed)c["RAM-SPEED-VAL"]=1E6*a;if(a=k)e=2.51143*Math.sqrt(a/1024/1024/1024);if(a=b.speed)e*=.92245*Math.sqrt(a/1E3)}e&&
(m=m?Math.min(m,e):e);response=p.execQuery("SELECT adapterRam, name, driverVersion, currentHorizontalResolution, currentRefreshRate, currentBitsPerPixel, currentVerticalResolution FROM Win32_VideoController");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.adapterRam)c["GPU-SIZE"]=d.fun.info2str(Math.abs(a),0)+"Б";if(a=b.adapterRam)c["GPU-SIZE-VAL"]=Math.abs(a);if(a=d.fun.clear(b.name,"GPU","Видеоустройство","Family","Chipset","Series","Graphics"))c["GPU-NAME"]=a;if(a=d.fun.clear(b.driverVersion))c["GPU-VERSION"]=
...
a;break}e=0;response=p.execQuery("SELECT * FROM Win32_DiskDrive");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();switch(b.mediaType){case "Removable Media":k="USB";break;case "Fixed\thard disk media":case "Fixed hard disk media":k=b.caption&&-1!=b.caption.indexOf("Solid")?"SSD":b.caption&&-1!=b.caption.indexOf("SSD")?"SSD":b.caption&&!b.caption.indexOf("ADATA")?"SSD":"HDD";break;default:k=""}if((!b.caption||-1==b.caption.indexOf("Raid"))&&k&&!c[k+"-NAME"]){if(a=d.fun.clear(b.caption,
"ATA Device","SCSI Disk Device","USB Device","SSD"))c[k+"-NAME"]=a;if(a=d.fun.clear(b.firmwareRevision))c[k+"-VERSION"]=a;if(a=d.fun.clear(b.interfaceType))c[k+"-TYPE"]=a;if(a=d.fun.clear(b.serialNumber))c[k+"-SERIAL"]=a;if(a=b.size)c[k+"-SIZE"]=d.fun.info2str(a,0)+"Б";if(a=b.size)c[k+"-SIZE-VAL"]=a;if(a=k)e=Math.max(e,"SDD"==a?15.51143:7.14577)}}e&&(m=m?Math.min(m,e):e);response=p.execQuery("SELECT mediaType, caption, drive FROM Win32_CDROMDrive");for(f=new Enumerator(response);!f.atEnd();)if(b=
...
for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),b.caption&&-1!=b.caption.indexOf(n)||c["BAK-DRIVE"]||(a=d.fun.clear(b.caption))&&b.size>=d.val.driveMinSize&&(c["BAK-DRIVE"]=a);r="";k="DisplayIcon";g=["SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма"];
a="";f=u.methods_.item("getStringValue");e=0;for(l=g.length;e<l&&!a;e++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=g[e],b.sValueName=k,b=u.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(g=a.split("\\"),g.pop(),g.pop(),r=g.join("\\"),c["APP-EFARMA-DIR"]=r);n="";k="\\Client\\ePlus.Client.exe";g=[r];a="";e=0;for(l=g.length;e<l;e++)e&&(a+=" OR "),a+="name = "+d.fun.repair(g[e]+k);response=p.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=
new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),e=0,l=g.length;e<l;e++)if(a=g[e]+k,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-CLIENT"]=n=a;break}if(n&&(k="ConnectionString",a=n+".Config",h&&(a=["\\",h,a.replace(":","$")].join("\\")),z.fileExists(a)&&y.load(a)))for(f=y.getElementsByTagName("appSettings"),e=0,l=f.length;e<l;e++)for(n=0,w=f.item(e).childNodes.length;n<w;n++)if(b=f.item(e).childNodes.item(n),1==b.nodeType&&k==b.getAttribute("key")){a=b.getAttribute("value");
b=d.lib.str2obj(a,!1,";","=");if(a=b["Data Source"])c["APP-EFARMA-CLIENT-SERVER"]=a;if(a=b["Initial Catalog"])c["APP-EFARMA-CLIENT-BASE"]=a;if(a=b["User ID"])c["APP-EFARMA-CLIENT-LOGIN"]=a;if(a=b.Password)c["APP-EFARMA-CLIENT-PASSWORD"]=a;break}n="";k="\\ARM\\ePlus.ARMCasherNew.exe";g=[r];a="";e=0;for(l=g.length;e<l;e++)e&&(a+=" OR "),a+="name = "+d.fun.repair(g[e]+k);response=p.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),
e=0,l=g.length;e<l;e++)if(a=g[e]+k,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-CASHER"]=n=a;break}if(n&&(k="LocalConnectionString",a=n+".Config",h&&(a=["\\",h,a.replace(":","$")].join("\\")),z.fileExists(a)&&y.load(a)))for(f=y.getElementsByTagName("appSettings"),e=0,l=f.length;e<l;e++)for(n=0,w=f.item(e).childNodes.length;n<w;n++)if(b=f.item(e).childNodes.item(n),1==b.nodeType&&k==b.getAttribute("key")){a=b.getAttribute("value");b=d.lib.str2obj(a,!1,";","=");if(a=b["Data Source"])c["APP-EFARMA-CASHER-SERVER"]=
a;if(a=b["Initial Catalog"])c["APP-EFARMA-CASHER-BASE"]=a;if(a=b["User ID"])c["APP-EFARMA-CASHER-LOGIN"]=a;if(a=b.Password)c["APP-EFARMA-CASHER-PASSWORD"]=a;break}n="";k="\\UpdateServer\\ePlus.UpdateServer.exe";g=[r];a="";e=0;for(l=g.length;e<l;e++)e&&(a+=" OR "),a+="name = "+d.fun.repair(g[e]+k);response=p.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),e=0,l=g.length;e<l;e++)if(a=g[e]+k,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-UPDATER"]=
n=a;break}if(n&&(a=n+".Config",h&&(a=["\\",h,a.replace(":","$")].join("\\")),z.fileExists(a)&&y.load(a)))for(f=y.getElementsByTagName("appSettings"),e=0,l=f.length;e<l;e++)for(n=0,w=f.item(e).childNodes.length;n<w;n++)if(b=f.item(e).childNodes.item(n),1==b.nodeType)switch(a=b.getAttribute("value"),b.getAttribute("key")){case "LocalUrl":a&&(c["APP-EFARMA-UPDATE-DIR"]=a);break;case "BackupDbFolder":a&&(c["APP-EFARMA-BACKUP-DIR"]=a)}k="lic";g=[r+"\\UpdateServer\\",r+"\\Client\\",r+"\\ARM\\"];a="";e=
0;for(l=g.length;e<l;e++)e&&(a+=" OR "),a+="drive = "+d.fun.repair(d.lib.strim(g[e],"",":",!0,!1))+" ",a+="AND path = "+d.fun.repair(d.lib.strim(g[e],":","",!1,!1))+" ",a+="AND extension = "+d.fun.repair(k);response=p.execQuery("SELECT name, fileName FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),e=0,l=g.length;e<l;e++)if(a=g[e]+b.fileName+"."+k,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-LICENSE"]=a;break}a=d.lib.date2str(E,"Y");
k="\\ULUS.exe";g=["C:\\SoftLink\\Ulus\\"+a,"C:\\LO\\ULUS\\"+a,"C:\\so\\Ulus\\"+a,"C:\\ULUS\\"+a];a="";e=0;for(l=g.length;e<l;e++)e&&(a+=" OR "),a+="name = "+d.fun.repair(g[e]+k);response=p.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),e=0,l=g.length;e<l;e++)if(a=g[e]+k,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-ULUS"]=a;c["APP-ULUS-DIR"]=g[e];break}k="";g=["SOFTWARE\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command",
"SOFTWARE\\WOW6432Node\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command"];a="";f=u.methods_.item("getStringValue");e=0;for(l=g.length;e<l&&!a;e++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=g[e],b.sValueName=k,b=u.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(g=a.split("\\"),g.pop(),c["APP-CHROME"]=a,c["APP-CHROME-DIR"]=g.join("\\"));k="";g=["SOFTWARE\\VideoLAN\\VLC","SOFTWARE\\WOW6432Node\\VideoLAN\\VLC"];a="";f=u.methods_.item("getStringValue");
e=0;for(l=g.length;e<l&&!a;e++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=g[e],b.sValueName=k,b=u.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(g=a.split("\\"),g.pop(),c["APP-VLC"]=a,c["APP-VLC-DIR"]=g.join("\\"));k="ClientID";g=["SOFTWARE\\TeamViewer","SOFTWARE\\WOW6432Node\\TeamViewer"];a="";f=u.methods_.item("getDWORDValue");e=0;for(l=g.length;e<l&&!a;e++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=g[e],b.sValueName=
k,b=u.execMethod_(f.name,b),!b.returnValue&&b.uValue&&(a=d.fun.clear(b.uValue));a&&(c["APP-TEAMVIEWER-ID"]=a);a=v.toLowerCase();0==a.indexOf(d.val.aptPref)&&(a=a.substr(d.val.aptPref.length,d.val.aptLen),isNaN(a)||(c["APT-NUMBER"]=a||d.val.aptNone,c["APT-NUMBER-VAL"]=Number(a)));a=v.toLowerCase();0==a.indexOf(d.val.aptPref)&&((a=a.substr(d.val.aptPref.length+d.val.aptLen))?0==a.indexOf(d.val.wsPref)?(a=a.substr(d.val.wsPref.length,d.val.wsLen),a=isNaN(a)?0:Number(a)):a=0:a=1,c["APT-COMPUTER-VAL"]=
a,c["APT-COMPUTER"]=0==a?d.val.wsNoneDesc:1==a?d.val.wsFirstDesc:d.val.wsNextDesc);a=v.toLowerCase();0==a.indexOf(d.val.aptPref)&&(a=a.substr(d.val.aptPref.length,d.val.aptLen),isNaN(a)||(g=[d.val.supportLogin,Number(a),d.val.supportToken],c["APT-SUPPORT-HASH"]=d.lib.md5(g.join("")),c["APT-SUPPORT-LOGIN"]=d.val.supportLogin));g=[];c["CPU-NAME"]&&c["CPU-CORE"]&&c["CPU-SPEED"]&&g.push(d.fun.clear(c["CPU-NAME"].replace("Dual-Core","Intel"),"Dual Core","Xeon","Pentium","Celeron","Core2 Duo","Core","Processor",
"Athlon 64","Athlon",/,.+/,/@.+/,/\d\.d+GHz/)+" "+c["CPU-CORE"]+"x"+c["CPU-SPEED"].replace(",",".").replace(" МГц","M").replace(" ГГц","G")+"Hz");c["RAM-SIZE"]&&c["RAM-SPEED"]&&g.push(c["RAM-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+c["RAM-SPEED"].replace(" МГц","M").replace(" ГГц","G")+"Hz");c["GPU-SIZE"]&&c["GPU-NAME"]&&(-1!=c["GPU-NAME"].indexOf("GeForce")||-1!=c["GPU-NAME"].indexOf("Radeon"))&&g.push(c["GPU-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+d.fun.clear(c["GPU-NAME"],
"AMD","NVIDIA","GeForce","Radeon",/\(.+/));c["HDD-SIZE"]&&g.push(c["HDD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" HDD");c["SSD-SIZE"]&&g.push(c["SSD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" SSD");c["USB-SIZE"]&&g.push(c["USB-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" USB");c["ROM-TYPE"]&&g.push(c["ROM-TYPE"]);g.length&&(c["DEV-NAME"]=g.join("/"));m&&(c["DEV-BENCHMARK"]=d.lib.num2str(m,5,",",""))}f=F.environment(d.val.envType);
for(k in c)a=c[k],setEnv(f,k,a);f=[];e=0;for(l=x.arguments.length-q;e<l;e++)if(a=x.arguments.item(e+q),a=a.split(d.val.getDelim).join(d.val.setDelim),e||"silent"!=a)if(e||"print"!=a)if(e||"csv"!=a){if(!e)for(k in c)z=new RegExp(d.val.keyWrap+k+d.val.keyWrap,"gi"),a=a.replace(z,c[k]);if(-1!=a.indexOf(d.val.argDelim)||-1!=a.indexOf(d.val.keyWrap))a=d.val.argWrap+a+d.val.argWrap;f.push(a)}else{g="SYS-KEY SYS-NAME SYS-VERSION SYS-TIME SYS-ARCHITECTURE SYS-DRIVE SYS-INSTALL SYS-RESET SYS-SERIAL PCB-NAME PCB-SERIAL NET-IP-V4 NET-GATEWAY-V4 NET-DNS-V4 NET-SUBNET-V4 NET-DHCP-V4 NET-NAME NET-MAC NET-SPEED NET-RESET NET-HOST NET-DOMAIN USR-LOGIN USR-DOMAIN USR-ACCOUNT USR-NAME USR-SID USR-PROFILE CPU-ARCHITECTURE CPU-SPEED CPU-NAME CPU-CORE CPU-SOCKET CPU-CACHE-L1 CPU-CACHE-L2 CPU-CACHE-L3 RAM-SIZE RAM-SPEED GPU-SIZE GPU-NAME GPU-VERSION GPU-RESOLUTION GPU-FREQUENCY GPU-COLOR SSD-NAME SSD-VERSION SSD-TYPE SSD-SERIAL SSD-SIZE HDD-NAME HDD-VERSION HDD-TYPE HDD-SERIAL HDD-SIZE USB-NAME USB-VERSION USB-TYPE USB-SERIAL USB-SIZE ROM-TYPE ROM-NAME ROM-DRIVE ROM-VERSION DEV-NAME DEV-BENCHMARK".split(" ");
n=0;for(w=g.length;n<w;n++)k=g[n],g[n]=c[k]?c[k]:"";x.echo(g.join(d.val.csvDelim))}else x.echo(d.lib.obj2str(c,!1,"\r\n"," = "));else d.val.runStyle=0;q=f.join(d.val.argDelim);try{a=q?F.run(q,d.val.runStyle,!0):d.val.defReturn}catch(G){a=d.val.defReturn}x.quit(a)}})})(WSH,env);env.init();
