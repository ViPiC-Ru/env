...
(function(x,c,G){c.lib.extend(c,{fun:{wql2date:function(e,l){return new Date(e?Date.UTC(1*e.substr(0,4),1*e.substr(4,2)-1,1*e.substr(6,2),1*e.substr(8,2),1*e.substr(10,2)-1*e.substr(21,4)+(l||0),1*e.substr(12,2),1*e.substr(14,3)):0)},getDateOfWeek:function(e,l){var n=new Date;e=1*e||1;l=1*l||n.getFullYear();n=(new Date(l,0,4)).getDay();return new Date(l,0,-((6+n)%7)+7*e)},bin2key:function(e){var l="";try{var n=e.toArray()}catch(w){n=[]}if(n.length){e=Math.floor(n[66]/6)&1;n[66]=n[66]&247|4*(e&2);
for(var k=24;-1<k;k--){var d=0;for(var m=14;-1<m;m--)d*=256,d=n[m+52]+d,n[m+52]=Math.floor(d/24),d%=24;l="BCDFGHJKMPQRTVWXY2346789".substr(d,1)+l}1==e&&(n=l.substr(1,d),l=l.substr(1).replace(n,n+"N"));l=[l.substr(0,5),l.substr(5,5),l.substr(10,5),l.substr(15,5),l.substr(20,5)].join("-")}return l},bin2sid:function(e){var l="";try{var n=e.toArray()}catch(r){n=[]}if(n.length){var k=n[0]&255;e=n[1]&255;var d=0;for(var m=2;7>=m;m++)d+=(n[m]&255)*(1<<8*(5-(m-2)));l=l+("S-"+k)+("-"+d);d=8;for(m=0;m<e;m++){for(var w=
k=0;4>w;w++)k+=(n[d+w]&255)*(1<<8*w);l+="-"+k;d+=4}}return l},bin2str:function(e){var l="";try{var n=e.toArray()}catch(m){n=[]}for(var k=0,d=n.length;k<d;k++)(e=n[k])&&(l+=String.fromCharCode(e));return l},info2str:function(e,l,n){if(!n||2>n)n=1024;if(!l||0>l)l=0;var k=Math.pow(10,l);for(var d=-1;e>=n;d++)e/=n;e=Math.ceil(e*k)/k;e=c.lib.num2str(e,-1<d?l:0,",","");return e+=" "+"КМГТПЭЗЙ".charAt(d)},clear:function(e){e=e?""+e:"";"INVALID"==e&&(e="");"To be filled by O.E.M."==e&&(e="");"System Product Name"==
e&&(e="");"System Serial Number"==e&&(e="");"System manufacturer"==e&&(e="");"Default string"==e&&(e="");"empty"==e&&(e="");"None"==e&&(e="");for(var l=1,n=arguments.length;l<n;l++)e=e.replace(arguments[l],"");return e.replace(/\(R\)/gi,"").replace(/\(Registered Trademark\)/gi,"").replace(/\(Microsoft Corporation\)/gi,"").replace(/\(Корпорация Майкрософт\)/gi,"").replace(/\(Майкрософт\)/gi,"").replace(/\(TM\)/gi,"").replace(/^[/'"]|[/"']$/g,"").replace(/\r\n|\n|\t/g," ").replace(/^\s+|\s+$/g,"").replace(/\.+$/,
"").replace(/\s(?=\s)/gi,"")},repair:function(e){return("'"+(e?e:"")+"'").replace(/\\/g,"\\\\")},debug:function(){var e,l,n={},k=-1;return function(d){if(n.first){e=[c.lib.strPad(k,3,"0","left")];e.push("|");e.push(c.lib.strPad(c.lib.num2str((n.now.valueOf()-n.first.valueOf())/1E3,3,".",""),7,"0","left"));n.last=n.now;n.now=new Date;e.push("+"+c.lib.strPad(c.lib.num2str((n.now.valueOf()-n.last.valueOf())/1E3,3,".",""),7,"0","left"));e.push("|");e.push(l);try{x.stdErr.writeLine(e.join(" "))}catch(m){}}else n.now=
new Date;!k&&l&&(n.first=n.now);l=d;k++;return d}}()},init:function(){var e,l="",n="",k={};var d={};var m={},w=0;var r=new Date;var A=new ActiveXObject("WScript.Shell");var f=new ActiveXObject("wbemScripting.Swbemlocator");f.security_.impersonationLevel=3;var q=x.arguments.length;for(e=0;e<q;e++){var a=x.arguments.item(e);var h="context";if(!(h in m)){var g=a.split(c.val.keyDelim);if(3==g.length&&!g[0]&&!g[1]){m[h]=g[2];continue}}h="input";if(!(h in m)&&(g=a.split(c.val.chrDelim),2==g.length&&c.lib.hasValue(["ini",
"csv","tsv","CSV","TSV"],g[0],!0)&&g[1])){m[h]=g[0];m.charset=g[1];continue}h="output";if(!(h in m)&&(g=a.split(c.val.chrDelim),1==g.length&&c.lib.hasValue(["ini","csv","tsv","CSV","TSV"],g[0],!0))){m[h]=g[0];continue}h="silent";if(h in m||c.lib.compare(h,a,!0))if(h="nowait",h in m||c.lib.compare(h,a,!0))if(h="debug",h in m||c.lib.compare(h,a,!0))break;else m[h]=!0;else m[h]=!0;else m[h]=!0}var B=e;"context"in m||(m.context=".");"auto"==m.charset&&(m.charset="windows-1251");c.fun.debug(m.debug);if(m.context)for(c.fun.debug("Connect and create objects"),
e=1;e;e++)try{switch(e){case 1:var t=f.connectServer(m.context,"root\\CIMV2",null,null,null,null,128);break;case 2:var z=f.connectServer(m.context,"root\\WMI",null,null,null,null,128);break;case 3:var u=f.connectServer(".","root\\directory\\LDAP",null,null,null,null,128);break;case 4:var C=f.connectServer(m.context,"root\\Microsoft\\Windows\\Storage",null,null,null,null,128);break;case 5:var v=f.connectServer(m.context,"root\\default",null,null,null,null,128).get("stdRegProv");break;default:e=-1}}catch(y){switch(e){case 1:t=
null;e=-1;break;case 2:z=null;break;case 3:u=null;break;case 4:C=null;break;case 5:v=null}}if(t){if(v){f=v.methods_.item("getBinaryValue");var b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";b.sValueName=c.fun.debug("DigitalProductId");b=v.execMethod_(f.name,b);!b.returnValue&&(a=c.fun.bin2key(b.uValue),a=c.fun.clear(a))&&(d["SYS-KEY"]=a)}q="";response=t.execQuery(c.fun.debug("SELECT * FROM Win32_OperatingSystem WHERE primary = TRUE"));
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.systemDrive)var E=a;if(a=b.localDateTime)r=c.fun.wql2date(a);if(a=c.fun.clear(b.caption,"Майкрософт","Microsoft","Edition","x64",","))d["SYS-NAME"]=a;if(a=c.fun.clear(b.version))d["SYS-VERSION"]=a;if(a=b.localDateTime)d["SYS-TIME"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.localDateTime)d["SYS-TIME-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");if(a=c.fun.clear(b.systemDrive))d["SYS-DRIVE"]=a;if(a=b.installDate)d["SYS-INSTALL"]=
c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.installDate)d["SYS-INSTALL-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");if(a=b.lastBootUpTime)d["SYS-RESET"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.lastBootUpTime)d["SYS-RESET-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");if(a=c.fun.clear(b.serialNumber))d["SYS-SERIAL"]=a;if(a=c.fun.clear(b.description))d["SYS-DESCRIPTION"]=a;d["SYS-ARCHITECTURE"]=b.osArchitecture&&!b.osArchitecture.indexOf("64")?"x64":"x86";break}q="";
response=t.execQuery(c.fun.debug("SELECT manufacturer, product, serialNumber FROM Win32_BaseBoard WHERE hostingBoard = TRUE"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=c.fun.clear(b.product))d["PCB-NAME"]=a;a&&(a=c.fun.clear(b.manufacturer,"Inc.").replace("Hewlett-Packard","HP"))&&(d["PCB-NAME"]=a.split(" ")[0]+" "+c.fun.clear(b.product));if(a=c.fun.clear(b.serialNumber))d["PCB-SERIAL"]=a;break}q="";response=t.execQuery(c.fun.debug("SELECT releaseDate, manufacturer, smBIOSBIOSVersion, serialNumber FROM Win32_BIOS WHERE primaryBIOS = TRUE"));
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=c.fun.clear(b.releaseDate))d["PCB-BIOS-RELEASE"]=c.lib.date2str(c.fun.wql2date(a,r.getTimezoneOffset()),"d.m.Y H:i:s");if(a=c.fun.clear(b.releaseDate))d["PCB-BIOS-RELEASE-DATE"]=c.lib.date2str(c.fun.wql2date(a,r.getTimezoneOffset()),"d.m.Y");if(a=c.fun.clear(b.manufacturer,"Inc."))d["PCB-BIOS-MANUFACTURE"]=a;if(a=c.fun.clear(b.smBIOSBIOSVersion))d["PCB-BIOS-VERSION"]=a;if(a=c.fun.clear(b.serialNumber))d["PCB-BIOS-SERIAL"]=a;
break}q="";response=t.execQuery(c.fun.debug("SELECT * FROM Win32_NetworkAdapterConfiguration WHERE ipEnabled = TRUE AND fullDNSRegistrationEnabled = TRUE"));for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),!b.serviceName||-1==b.serviceName.indexOf("vpn"))if(!b.serviceName||-1==b.serviceName.indexOf("loop"))if(!b.serviceName||-1==b.serviceName.indexOf("VBox")){if(a=b.interfaceIndex)q=a;if(null!=b.ipAddress){g=b.ipAddress.toArray();e=0;for(var p=g.length;e<p;e++)(a=c.fun.clear(g[e]))&&
-1!=a.indexOf(".")&&!d["NET-IP-V4"]&&(d["NET-IP-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-IP-V6"]&&(d["NET-IP-V6"]=a)}if(null!=b.defaultIPGateway)for(g=b.defaultIPGateway.toArray(),e=0,p=g.length;e<p;e++)(a=c.fun.clear(g[e]))&&-1!=a.indexOf(".")&&!d["NET-GATEWAY-V4"]&&(d["NET-GATEWAY-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-GATEWAY-V6"]&&(d["NET-GATEWAY-V6"]=a);if(null!=b.dnsServerSearchOrder)for(g=b.dnsServerSearchOrder.toArray(),e=0,p=g.length;e<p;e++)(a=c.fun.clear(g[e]))&&-1!=a.indexOf(".")&&!d["NET-DNS-V4"]&&
(d["NET-DNS-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-DNS-V6"]&&(d["NET-DNS-V6"]=a);if(null!=b.ipSubnet)for(g=b.ipSubnet.toArray(),e=0,p=g.length;e<p;e++)(a=c.fun.clear(g[e]))&&-1!=a.indexOf(".")&&!d["NET-SUBNET-V4"]&&(d["NET-SUBNET-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-SUBNET-V6"]&&(d["NET-SUBNET-V6"]=a);if(a=c.fun.clear(b.dhcpServer))d["NET-DHCP-V4"]=a;if(a=c.fun.clear(b.description,"Сетевой адаптер","Адаптер","для виртуальной сети","Сетевая карта","Контроллер","NIC (NDIS 6.20)","- Минипорт планировщика пакетов",
"Family Controller","Adapter","Virtual Miniport","for Windows","x64").replace(/#\d+$/g,""))d["NET-NAME"]=a;if(a=c.fun.clear(b.macAddress))d["NET-MAC"]=a;break}if(q)for(response=t.execQuery(c.fun.debug("SELECT speed, timeOfLastReset FROM Win32_NetworkAdapter WHERE netEnabled = TRUE AND interfaceIndex = "+c.fun.repair(q))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.speed)d["NET-SPEED"]=c.fun.info2str(a,0,1E3)+"бит/с";if(a=b.speed)d["NET-SPEED-VAL"]=a;if(a=b.timeOfLastReset)d["NET-RESET"]=
c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.timeOfLastReset)d["NET-RESET-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");break}response=t.execQuery(c.fun.debug("SELECT * FROM Win32_ComputerSystem"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.dnsHostName)l=a;if(a=b.name)l||(l=a.toLowerCase());b.domain!=b.workgroup&&(n=b.domain);if(a=b.userName)k.domain=a.split(c.val.keyDelim)[0];if(a=b.userName)k.login=a.split(c.val.keyDelim)[1];if(a=b.userName)k.account=
a;if(a=c.fun.clear(l))d["NET-HOST"]=a;if(a=c.fun.clear(b.domain))d["NET-DOMAIN"]=a;if(a=c.fun.clear(b.model))d["DEV-NAME"]=a;a&&(a=c.fun.clear(b.manufacturer,"Inc.","Hewlett-Packard"))&&(d["DEV-NAME"]=a.split(" ")[0]+" "+c.fun.clear(b.model));break}!k.account&&v&&(g=[],f=v.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName=c.fun.debug("DefaultDomainName"),b=v.execMethod_(f.name,
b),!b.returnValue&&b.sValue&&g.push(b.sValue),f=v.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName=c.fun.debug("DefaultUserName"),b=v.execMethod_(f.name,b),!b.returnValue&&b.sValue&&g.push(b.sValue),2==g.length&&(k.domain=g[0]),2==g.length&&(k.login=g[1]),2==g.length&&(k.account=g.join(c.val.keyDelim)));if(!k.account){g=null;response=t.execQuery(c.fun.debug("SELECT lastUseTime, localPath, loaded, sid FROM Win32_UserProfile WHERE special = FALSE"));
for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),(a=g?0:1)||(a=b.loaded&&!g.loaded?1:a),a||(a=c.lib.compare(c.fun.wql2date(b.lastUseTime),c.fun.wql2date(g.lastUseTime))),0<a&&(g=b);if(b=g)if(k.profile=b.localPath,a=b.sid)k.sid=a}if(!k.account&&k.sid){g=[];try{b=t.get('Win32_SID.SID="'+k.sid+'"')}catch(y){b=null}(a=b.referencedDomainName)&&g.push(a);(a=b.accountName)&&g.push(a);2==g.length&&(k.domain=g[0]);2==g.length&&(k.login=g[1]);2==g.length&&(k.account=g.join(c.val.keyDelim))}if(k.account&&
c.lib.hasValue([".",l],k.domain,!1))for(response=t.execQuery(c.fun.debug("SELECT domain, name, fullName, sid FROM Win32_UserAccount WHERE name = "+c.fun.repair(k.login)+" AND domain = "+c.fun.repair(k.domain))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();g=[];k.name=b.fullName;if(a=b.sid)k.sid=a;(a=b.domain)&&g.push(a);(a=b.name)&&g.push(a);2==g.length&&(k.domain=g[0]);2==g.length&&(k.login=g[1]);2==g.length&&(k.account=g.join(c.val.keyDelim));break}if(k.account&&u&&!c.lib.hasValue([".",
l],k.domain,!1))for(g="DS_co DS_c DS_company DS_displayName DS_department DS_info DS_homeDirectory DS_l DS_mail DS_mobile DS_objectSid DS_telephoneNumber DS_title DS_distinguishedName".split(" "),response=u.execQuery(c.fun.debug("SELECT "+g.join(", ")+" FROM DS_user WHERE DS_sAMAccountName = "+c.fun.repair(k.login))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();k.name=b.DS_displayName;k.home=b.DS_homeDirectory;if(g=b.DS_objectSid)if(a=c.fun.bin2sid(g.value))k.sid=a;if(a=c.fun.clear(b.DS_co))d["USR-COUNTRY"]=
a;if(a=c.fun.clear(b.DS_c))d["USR-COUNTRY-ID"]=a;if(a=c.fun.clear(b.DS_company,'"'))d["USR-COMPANY"]=a;if(a=c.fun.clear(b.DS_department,'"'))d["USR-DEPARTMENT"]=a;if(a=c.fun.clear(b.DS_distinguishedName))d["USR-ACCOUNT-DN"]=a;if(a=c.fun.clear(b.DS_l))d["USR-CITY"]=a;if(a=c.fun.clear(b.DS_mail))d["USR-EMAIL"]=a;if(a=c.fun.clear(b.DS_mobile))d["USR-MOBILE"]=a;if(a=c.fun.clear(b.DS_telephoneNumber))d["USR-PHONE"]=a;if(a=c.fun.clear(b.DS_title,'"'))d["USR-POSITION"]=a;if(a=c.fun.clear(b.DS_info,'"'))d["USR-INFO"]=
a;break}if(k.account&&!("home"in k))for(response=t.execQuery(c.fun.debug("SELECT homeDirectory FROM Win32_NetworkLoginProfile WHERE name = "+c.fun.repair(k.account))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();k.home=b.homeDirectory;break}if(k.sid&&!("profile"in k))for(response=t.execQuery(c.fun.debug("SELECT localPath FROM Win32_UserProfile WHERE sid = "+c.fun.repair(k.sid))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();k.profile=b.localPath;break}if(a=c.fun.clear(k.sid))d["USR-SID"]=
a;if(a=c.fun.clear(k.account))d["USR-ACCOUNT"]=a;if(a=c.fun.clear(k.login))d["USR-LOGIN"]=a;if(a=c.fun.clear(k.domain))d["USR-DOMAIN"]=a;if(a=c.fun.clear(k.profile))d["USR-PROFILE"]=a;if(a=c.fun.clear(k.home))d["USR-HOME"]=a;if(a=c.fun.clear(k.name))d["USR-NAME"]=a;if(a=c.fun.clear(k.name)){g=a.split(c.val.argDelim);for(e=g.length-1;-1<e;e--)a=c.fun.clear(g[e],/[\[\(,\.\)\]]/g),(h=(h=3>a.length)||c.lib.hasValue(["von"],a,!0))?g.splice(e,1):g[e]=a;if(a=g[0])d["USR-NAME-FIRST"]=a;if(a=g[1])d["USR-NAME-SECOND"]=
a;if(a=g[2])d["USR-NAME-THIRD"]=a;if(a=g[3])d["USR-NAME-FOURTH"]=a}if(l&&u&&n)for(response=u.execQuery(c.fun.debug("SELECT DS_distinguishedName FROM DS_computer WHERE DS_cn = "+c.fun.repair(l))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=c.fun.clear(b.DS_distinguishedName))d["NET-HOST-DN"]=a;break}u=0;q="";response=t.execQuery(c.fun.debug("SELECT architecture, maxClockSpeed, name, revision, numberOfCores, socketDesignation FROM Win32_Processor WHERE role = 'CPU'"));for(f=
new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();0==b.architecture?d["CPU-ARCHITECTURE"]="x86":9==b.architecture&&(d["CPU-ARCHITECTURE"]="x64");if(a=b.maxClockSpeed)d["CPU-SPEED"]=c.fun.info2str(1E6*a,2,1E3)+"Гц";if(a=b.maxClockSpeed)d["CPU-SPEED-VAL"]=1E6*a;if(a=c.fun.clear(b.name,"CPU","APU","Процессор","Processor","with","Radeon HD Graphics","11th Gen"))d["CPU-NAME"]=a;if(a=c.fun.clear(b.revision))d["CPU-VERSION"]=a;if(a=c.fun.clear(b.numberOfCores))d["CPU-CORE"]=a;if(a=c.fun.clear(b.socketDesignation,
"SOCKET 0"))d["CPU-SOCKET"]=a;if(a=b.maxClockSpeed)u+=2.26143*Math.sqrt(a/1E3);if(a=b.numberOfCores)u*=1.02033*Math.sqrt(a);break}u&&(w=w?Math.min(w,u):u);q="";response=t.execQuery(c.fun.debug("SELECT level, maxCacheSize FROM Win32_CacheMemory"));for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),a=b.maxCacheSize)d["CPU-CACHE-L"+(b.level-2)]=c.fun.info2str(1024*a,0)+"Б";h=u=0;q="";response=t.execQuery(c.fun.debug("SELECT capacity, speed FROM Win32_PhysicalMemory"));for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.capacity)d["RAM-SIZE-VAL"]=h+=1*a;if(a=b.capacity)d["RAM-SIZE"]=c.fun.info2str(h,0)+"Б";if(a=b.speed)d["RAM-SPEED"]=a+" МГц";if(a=b.speed)d["RAM-SPEED-VAL"]=1E6*a;if(a=h)u=2.51143*Math.sqrt(a/1024/1024/1024);if(a=b.speed)u*=.92245*Math.sqrt(a/1E3)}u&&(w=w?Math.min(w,u):u);q="";response=t.execQuery(c.fun.debug("SELECT adapterRam, name, driverVersion, currentHorizontalResolution, currentRefreshRate, currentBitsPerPixel, currentVerticalResolution FROM Win32_VideoController"));
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.adapterRam)d["GPU-SIZE"]=c.fun.info2str(Math.abs(a),0)+"Б";if(a=b.adapterRam)d["GPU-SIZE-VAL"]=Math.abs(a);if(a=c.fun.clear(b.name,"GPU","Видеоустройство","Family","Chipset","Series","Graphics","Adapter"))d["GPU-NAME"]=a;if(a=c.fun.clear(b.driverVersion))d["GPU-VERSION"]=a;b.currentHorizontalResolution&&b.currentVerticalResolution&&(d["GPU-RESOLUTION"]=b.currentHorizontalResolution+" x "+b.currentVerticalResolution);if(a=b.currentHorizontalResolution)d["GPU-RESOLUTION-X"]=
a;if(a=b.currentVerticalResolution)d["GPU-RESOLUTION-Y"]=a;if(a=b.currentRefreshRate)d["GPU-FREQUENCY"]=c.fun.info2str(a,0,1E3)+"Гц";if(a=b.currentRefreshRate)d["GPU-FREQUENCY-VAL"]=a;if(a=b.currentBitsPerPixel)d["GPU-COLOR"]=c.fun.info2str(a,0)+"бит"+c.lib.numDeclin(a,"","","а");if(a=b.currentBitsPerPixel)d["GPU-COLOR-VAL"]=a;break}if(z){q="";response=z.execQuery(c.fun.debug("SELECT instanceName, serialNumberId, userFriendlyName, userFriendlyNameLength, weekOfManufacture, yearOfManufacture FROM WmiMonitorID WHERE active = TRUE"));
for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),b.userFriendlyNameLength){if(a=b.instanceName)q=a;if(a=c.fun.bin2str(b.userFriendlyName))if(a=c.fun.clear(a," 4K"," HDR"))d["MON-NAME"]=a;(a=c.fun.bin2str(b.serialNumberId))&&(a=c.fun.clear(a))&&"0"!=a&&(d["MON-SERIAL"]=a);b.yearOfManufacture&&b.weekOfManufacture&&(d["MON-RELEASE"]=c.lib.date2str(c.fun.getDateOfWeek(b.weekOfManufacture,b.yearOfManufacture),"d.m.Y H:i:s"));b.yearOfManufacture&&b.weekOfManufacture&&(d["MON-RELEASE-DATE"]=
c.lib.date2str(c.fun.getDateOfWeek(b.weekOfManufacture,b.yearOfManufacture),"d.m.Y"));break}if(q)for(response=z.execQuery(c.fun.debug("SELECT maxHorizontalImageSize, maxVerticalImageSize FROM WmiMonitorBasicDisplayParams WHERE instanceName = "+c.fun.repair(q))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.maxHorizontalImageSize)d["MON-SIZE-X"]=a;if(a=b.maxVerticalImageSize)d["MON-SIZE-Y"]=a;b.maxHorizontalImageSize&&b.maxVerticalImageSize&&(a=Math.sqrt(Math.pow(b.maxHorizontalImageSize,
2)+Math.pow(b.maxVerticalImageSize,2)),a=Math.round(a/2.54),d["MON-SIZE"]=b.maxHorizontalImageSize+" x "+b.maxVerticalImageSize+" см / "+a+" дюйм"+c.lib.numDeclin(a,"ов","","а"),d["MON-SIZE-Z"]=a);break}}u=0;q="";response=C?C.execQuery(c.fun.debug("SELECT model, firmwareVersion, mediaType, serialNumber, size FROM MSFT_PhysicalDisk")):t.execQuery(c.fun.debug("SELECT * FROM Win32_DiskDrive"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();switch(b.mediaType){case 0:h="USB";break;
case 3:h="HDD";break;case 4:h="SSD";break;case 5:h="SCM";break;case "Removable Media":h="USB";break;case "Fixed\thard disk media":case "Fixed hard disk media":h=b.model&&-1!=b.model.indexOf("Solid")?"SSD":b.model&&-1!=b.model.indexOf("SSD")?"SSD":b.model&&!b.model.indexOf("ADATA")?"SSD":"HDD";break;default:h=""}if((!b.model||-1==b.model.indexOf("Raid"))&&h&&!d[h+"-NAME"]){if(a=c.fun.clear(b.model,"ATA Device","SCSI Disk Device","USB Device","SSD","SATA"))d[h+"-NAME"]=a;if(a=c.fun.clear(b.firmwareVersion||
b.firmwareRevision))d[h+"-VERSION"]=a;if(a=c.fun.clear(b.serialNumber))d[h+"-SERIAL"]=a;if(a=b.size)d[h+"-SIZE"]=c.fun.info2str(a,0)+"Б";if(a=b.size)d[h+"-SIZE-VAL"]=a;h&&(u=Math.max(u,"SDD"==h?15.51143:7.14577))}}u&&(w=w?Math.min(w,u):u);q="";response=t.execQuery(c.fun.debug("SELECT mediaType, caption, drive FROM Win32_CDROMDrive"));for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),!b.caption||-1==b.caption.indexOf("Alcohol"))if(!b.caption||-1==b.caption.indexOf("Virtual"))if(!b.caption||
-1==b.caption.indexOf("Виртуальный"))if(!b.mediaType||"UNKNOWN"!=b.mediaType){switch(b.mediaType){case "CD-ROM":d["ROM-TYPE"]="CD";break;case "DVD-ROM":d["ROM-TYPE"]="DVD";break;case "CD Writer":d["ROM-TYPE"]="CD-RW";break;case "DVD Writer":d["ROM-TYPE"]="DVD-RW"}if(a=c.fun.clear(b.caption,"ATA Device","SCSI CdRom Device"))d["ROM-NAME"]=a;if(a=c.fun.clear(b.drive))d["ROM-DRIVE"]=a;break}q="";response=t.execQuery(c.fun.debug("SELECT caption, size FROM Win32_LogicalDisk WHERE driveType = 2 OR driveType = 3 OR driveType = 4"));
for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),b.caption&&-1!=b.caption.indexOf(E)||d["BAK-DRIVE"]||(a=c.fun.clear(b.caption))&&b.size>=c.val.driveMinSize&&(d["BAK-DRIVE"]=a);q="";h="DisplayIcon";g=["SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма"];
a="";if(v)for(f=v.methods_.item("getStringValue"),e=0,p=g.length;e<p&&!a;e++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(g[e]),b.sValueName=h,b=v.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=c.fun.clear(b.sValue));a&&(g=a.split(c.val.keyDelim),g.pop(),g.pop(),q=g.join(c.val.keyDelim),d["APP-EFARMA-DIR"]=q);h="\\Client\\ePlus.Client.exe";g=q?[q]:[];a="";e=0;for(p=g.length;e<p;e++)e&&(a+=" OR "),a+="name = "+c.fun.repair(g[e]+h);if(a)for(response=t.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+
a)),f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),e=0,p=g.length;e<p;e++)if(a=g[e]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-CLIENT"]=a;break}h="\\ARM\\ePlus.ARMCasherNew.exe";g=q?[q]:[];a="";e=0;for(p=g.length;e<p;e++)e&&(a+=" OR "),a+="name = "+c.fun.repair(g[e]+h);if(a)for(response=t.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+a)),f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),e=0,p=g.length;e<p;e++)if(a=g[e]+h,b.name&&
b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-CASHER"]=a;break}h="\\UpdateServer\\ePlus.UpdateServer.exe";g=q?[q]:[];a="";e=0;for(p=g.length;e<p;e++)e&&(a+=" OR "),a+="name = "+c.fun.repair(g[e]+h);if(a)for(response=t.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+a)),f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),e=0,p=g.length;e<p;e++)if(a=g[e]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-UPDATER"]=a;break}h="lic";g=q?[q+"\\UpdateServer\\",
q+"\\Client\\",q+"\\ARM\\"]:[];a="";e=0;for(p=g.length;e<p;e++)e&&(a+=" OR "),a+="drive = "+c.fun.repair(c.lib.strim(g[e],"",":",!0,!1))+" ",a+="AND path = "+c.fun.repair(c.lib.strim(g[e],":","",!1,!1))+" ",a+="AND extension = "+c.fun.repair(h);if(a)for(response=t.execQuery(c.fun.debug("SELECT name, fileName FROM CIM_DataFile WHERE "+a)),f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),e=0,p=g.length;e<p;e++)if(a=g[e]+b.fileName+"."+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-LICENSE"]=
a;break}q="";a=c.lib.date2str(r,"Y");h="\\ULUS.exe";g=["C:\\SoftLink\\Ulus\\"+a,"C:\\LO\\ULUS\\"+a,"C:\\so\\Ulus\\"+a,"C:\\ULUS\\"+a];a="";e=0;for(p=g.length;e<p;e++)e&&(a+=" OR "),a+="name = "+c.fun.repair(g[e]+h);if(a)for(response=t.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+a)),f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),e=0,p=g.length;e<p;e++)if(a=g[e]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-ULUS"]=a;d["APP-ULUS-DIR"]=g[e];break}h=q="";
g=["SOFTWARE\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command","SOFTWARE\\WOW6432Node\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command"];a="";if(v)for(f=v.methods_.item("getStringValue"),e=0,p=g.length;e<p&&!a;e++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(g[e]),b.sValueName=h,b=v.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=c.fun.clear(b.sValue));a&&(g=a.split(c.val.keyDelim),g.pop(),d["APP-CHROME"]=a,d["APP-CHROME-DIR"]=
g.join(c.val.keyDelim));h=q="";g=["SOFTWARE\\VideoLAN\\VLC","SOFTWARE\\WOW6432Node\\VideoLAN\\VLC"];a="";if(v)for(f=v.methods_.item("getStringValue"),e=0,p=g.length;e<p&&!a;e++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(g[e]),b.sValueName=h,b=v.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=c.fun.clear(b.sValue));a&&(g=a.split(c.val.keyDelim),g.pop(),d["APP-VLC"]=a,d["APP-VLC-DIR"]=g.join(c.val.keyDelim));q="";h="ClientID";g=["SOFTWARE\\TeamViewer","SOFTWARE\\WOW6432Node\\TeamViewer"];
a="";if(v)for(f=v.methods_.item("getDWORDValue"),e=0,p=g.length;e<p&&!a;e++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(g[e]),b.sValueName=h,b=v.execMethod_(f.name,b),!b.returnValue&&b.uValue&&(a=c.fun.clear(b.uValue));a&&(d["APP-TEAMVIEWER-ID"]=a);g=[];d["CPU-NAME"]&&d["CPU-CORE"]&&d["CPU-SPEED"]&&g.push(c.fun.clear(d["CPU-NAME"].replace("Dual-Core","Intel"),"Dual Core","Xeon","Pentium","Celeron","Core2 Duo","Core","Processor","Athlon 64","Athlon",/,.+/,/@.+/,
/\d\.d+GHz/)+" "+d["CPU-CORE"]+"x"+d["CPU-SPEED"].replace(",",".").replace(" МГц","M").replace(" ГГц","G")+"Hz");d["RAM-SIZE"]&&d["RAM-SPEED"]&&g.push(d["RAM-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+d["RAM-SPEED"].replace(" МГц","M").replace(" ГГц","G")+"Hz");d["GPU-SIZE"]&&d["GPU-NAME"]&&(-1!=d["GPU-NAME"].indexOf("GeForce")||-1!=d["GPU-NAME"].indexOf("Radeon"))&&g.push(d["GPU-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+c.fun.clear(d["GPU-NAME"],"AMD","NVIDIA","GeForce","Radeon",
/\(.+/));d["HDD-SIZE"]&&g.push(d["HDD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" HDD");d["SSD-SIZE"]&&g.push(d["SSD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" SSD");d["USB-SIZE"]&&g.push(d["USB-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" USB");d["ROM-TYPE"]&&g.push(d["ROM-TYPE"]);g.length&&(d["DEV-DESCRIPTION"]=g.join("/"));w&&(d["DEV-BENCHMARK"]=c.lib.num2str(w,5,",",""))}var D="NET-HOST NET-DOMAIN SYS-NAME SYS-VERSION SYS-ARCHITECTURE SYS-KEY SYS-TIME SYS-DRIVE SYS-INSTALL SYS-RESET PCB-NAME PCB-SERIAL PCB-BIOS-SERIAL PCB-BIOS-RELEASE CPU-NAME CPU-SOCKET CPU-CORE CPU-SPEED CPU-SPEED-VAL RAM-SPEED RAM-SIZE RAM-SIZE-VAL GPU-NAME GPU-RESOLUTION GPU-SIZE GPU-SIZE-VAL MON-NAME MON-SERIAL MON-SIZE MON-SIZE-Z MON-RELEASE NET-NAME NET-MAC NET-IP-V4 NET-SUBNET-V4 NET-GATEWAY-V4 NET-DNS-V4 NET-DHCP-V4 NET-IP-V6 NET-SUBNET-V6 NET-GATEWAY-V6 NET-SPEED NET-SPEED-VAL NET-RESET SSD-NAME SSD-SERIAL SSD-SIZE SSD-SIZE-VAL HDD-NAME HDD-SERIAL HDD-SIZE HDD-SIZE-VAL USB-NAME USB-SERIAL USB-SIZE USB-SIZE-VAL ROM-NAME ROM-TYPE ROM-DRIVE USR-ACCOUNT USR-DOMAIN USR-LOGIN USR-NAME USR-SID USR-COUNTRY USR-CITY USR-COMPANY USR-DEPARTMENT USR-POSITION USR-EMAIL USR-PHONE USR-MOBILE USR-PROFILE DEV-NAME DEV-DESCRIPTION DEV-BENCHMARK".split(" ");
if(m.input){c.fun.debug("Read input data");try{h="windows-1251",a=x.stdIn.readAll(),m.charset!=h&&(a=c.wsh.iconv(m.charset,h,a))}catch(y){a=""}}f=null;if(m.input&&a)switch(r="",c.fun.debug("Convert input data"),m.input){case "TSV":r||(r=c.val.tsvDelim);case "CSV":r||(r=c.val.csvDelim),f||(f=c.lib.tsv2arr(a,!1,r)),f.length&&(D=f.shift());case "tsv":r||(r=c.val.tsvDelim);case "csv":for(r||(r=c.val.csvDelim),f||(f=c.lib.tsv2arr(a,!1,r)),e=0,p=f.length;e<p;e++)b=f[e],b=c.lib.arr2obj(b,null,function(y,
F){if(y)return D[F]}),f[e]=b;case "ini":f||(f=[c.lib.ini2obj(a,!1)]);g={};e=0;for(p=f.length;e<p;e++){b=f[e];for(h in b)(a=b[h])&&(g[h]=a);for(h in d)a=d[h],b[h]=a;f[e]=b}for(h in g)a=g[h],!h||!a||h in d||(d[h]=a)}if(m.output)switch(r="",f=f||[d],t=null,c.fun.debug("Convert output data"),m.output){case "ini":r=c.val.argDelim+c.val.iniDelim+c.val.argDelim;b=c.lib.sort(d,"asc");a=c.lib.obj2str(b,!1,c.val.linDelim,r);break;case "TSV":r||(r=c.val.tsvDelim);case "CSV":r||(r=c.val.csvDelim),t=!1;case "tsv":r||
(r=c.val.tsvDelim);case "csv":r||(r=c.val.csvDelim),a=c.lib.arr2tsv(f,D,r,t)}if(m.output&&a){a+=c.val.linDelim;c.fun.debug("Write output data");try{x.stdOut.write(a)}catch(y){}}c.fun.debug("Set environment variables");f=A.environment(c.val.envType);for(h in d)a=d[h],setEnv(f,h,a);f=[];q=x.arguments.length;for(e=B;e<q;e++)a=x.arguments.item(e),a=a.split(c.val.getDelim).join(c.val.setDelim),(a=A.expandEnvironmentStrings(a))&&-1==a.indexOf(c.val.argDelim)||(a=c.val.argWrap+a+c.val.argWrap),f.push(a);
if(d=f.join(c.val.argDelim)){B=m.silent?0:c.val.runStyle;c.fun.debug("Calling an external command");try{a=A.run(d,B,!m.nowait),m.nowait&&(a=c.val.defReturn)}catch(y){a=c.val.defReturn}}else a=c.val.defReturn;c.fun.debug("Exit with code "+a);c.fun.debug(m.debug);x.quit(a)}})})(WSH,env);env.init();
