...
(function(v,d,J){d.lib.extend(d,{fun:{wql2date:function(b,p){return new Date(b?Date.UTC(1*b.substr(0,4),1*b.substr(4,2)-1,1*b.substr(6,2),1*b.substr(8,2),1*b.substr(10,2)-1*b.substr(21,4)+(p||0),1*b.substr(12,2),1*b.substr(14,3)):0)},bin2key:function(b){var p="";var r=b.toArray();b=Math.floor(r[66]/6)&1;r[66]=r[66]&247|4*(b&2);for(var c=24;-1<c;c--){var m=0;for(var q=14;-1<q;q--)m*=256,m=r[q+52]+m,r[q+52]=Math.floor(m/24),m%=24;p="BCDFGHJKMPQRTVWXY2346789".substr(m,1)+p}1==b&&(b=p.substr(1,m),p=p.substr(1).replace(b,
b+"N"));return[p.substr(0,5),p.substr(5,5),p.substr(10,5),p.substr(15,5),p.substr(20,5)].join("-")},info2str:function(b,p,r){if(!r||2>r)r=1024;if(!p||0>p)p=0;var c=Math.pow(10,p);for(var m=-1;b>=r;m++)b/=r;b=Math.ceil(b*c)/c;b=d.lib.num2str(b,-1<m?p:0,",","");return b+=" "+"КМГТПЭЗЙ".charAt(m)},clear:function(b){b=b?""+b:"";"INVALID"==b&&(b="");"To be filled by O.E.M."==b&&(b="");"System Product Name"==b&&(b="");"System Serial Number"==b&&(b="");"System manufacturer"==b&&(b="");"Default string"==
...
p="",r="";var c={};var m={},q=0;var A=new Date;for(b=0;b<v.arguments.length;b++){var a=v.arguments.item(b);if(!("context"in m)){var e=a.split(d.val.keyDelim);if(3==e.length&&!e[0]&&!e[1]){m.context=e[2];continue}}if(!("input"in m)&&(e=a.split(d.val.chrDelim),2==e.length&&d.lib.hasValue(["ini","csv","tsv","CSV","TSV"],e[0],!0)&&e[1])){m.input=e[0];m.charset=e[1];continue}if(!("output"in m)&&(e=a.split(d.val.chrDelim),1==e.length&&d.lib.hasValue(["ini","csv","tsv","CSV","TSV"],e[0],!0))){m.output=e[0];
continue}if("silent"in m||"silent"!=a)if("nowait"in m||"nowait"!=a)break;else m.nowait=!0;else m.silent=!0}var D=b;"context"in m||(m.context=".");"auto"==m.charset&&(m.charset="windows-1251");var E=new ActiveXObject("WScript.Shell");var x=new ActiveXObject("wbemScripting.Swbemlocator");x.security_.impersonationLevel=3;if(m.context)for(b=1;b;b++)try{switch(b){case 1:var n=x.connectServer(m.context,"root\\CIMV2");break;case 2:var F=x.connectServer(m.context,"root\\directory\\LDAP");break;case 3:var t=
x.connectServer(m.context,"root\\Microsoft\\Windows\\Storage");break;case 4:var l=x.connectServer(m.context,"root\\default").get("stdRegProv");break;default:b=-1}}catch(B){switch(b){case 1:n=null;break;case 2:F=null;break;case 3:t=null;break;case 4:l=null}}if(n){if(l){var f=l.methods_.item("getBinaryValue");b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";b.sValueName="DigitalProductId";b=l.execMethod_(f.name,b);b.returnValue||
(a=d.fun.bin2key(b.uValue))&&"BBBBB-BBBBB-BBBBB-BBBBB-BBBBB"!=a&&(c["SYS-KEY"]=a)}response=n.execQuery("SELECT * FROM Win32_OperatingSystem WHERE primary = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.systemDrive)var H=a;if(a=b.localDateTime)A=d.fun.wql2date(a);if(a=d.fun.clear(b.caption,"Майкрософт","Microsoft","Edition","x64",","))c["SYS-NAME"]=a;if(a=d.fun.clear(b.version))c["SYS-VERSION"]=a;if(a=b.localDateTime)c["SYS-TIME"]=d.lib.date2str(d.fun.wql2date(a),
"d.m.Y H:i:s");if(a=b.localDateTime)c["SYS-TIME-DATE"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y");if(a=d.fun.clear(b.systemDrive))c["SYS-DRIVE"]=a;if(a=b.installDate)c["SYS-INSTALL"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.installDate)c["SYS-INSTALL-DATE"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y");if(a=b.lastBootUpTime)c["SYS-RESET"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.lastBootUpTime)c["SYS-RESET-DATE"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y");if(a=d.fun.clear(b.serialNumber))c["SYS-SERIAL"]=
a;if(a=d.fun.clear(b.description))c["SYS-DESCRIPTION"]=a;c["SYS-ARCHITECTURE"]=b.osArchitecture&&!b.osArchitecture.indexOf("64")?"x64":"x86";break}response=n.execQuery("SELECT manufacturer, product, serialNumber FROM Win32_BaseBoard WHERE hostingBoard = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.product))c["PCB-NAME"]=a;a&&(a=d.fun.clear(b.manufacturer,"Inc.").replace("Hewlett-Packard","HP"))&&(c["PCB-NAME"]=a.split(" ")[0]+" "+d.fun.clear(b.product));
if(a=d.fun.clear(b.serialNumber))c["PCB-SERIAL"]=a;break}response=n.execQuery("SELECT releaseDate, manufacturer, smBIOSBIOSVersion, serialNumber FROM Win32_BIOS WHERE primaryBIOS = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.releaseDate))c["PCB-BIOS-RELEASE"]=d.lib.date2str(d.fun.wql2date(a,A.getTimezoneOffset()),"d.m.Y H:i:s");if(a=d.fun.clear(b.releaseDate))c["PCB-BIOS-RELEASE-DATE"]=d.lib.date2str(d.fun.wql2date(a,A.getTimezoneOffset()),"d.m.Y");
if(a=d.fun.clear(b.manufacturer,"Inc."))c["PCB-BIOS-MANUFACTURE"]=a;if(a=d.fun.clear(b.smBIOSBIOSVersion))c["PCB-BIOS-VERSION"]=a;if(a=d.fun.clear(b.serialNumber))c["PCB-BIOS-SERIAL"]=a;break}var u="";response=n.execQuery("SELECT * FROM Win32_NetworkAdapterConfiguration WHERE ipEnabled = TRUE");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.interfaceIndex)u=a;if(null!=b.ipAddress){e=b.ipAddress.toArray();var g=0;for(var k=e.length;g<k;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&
!c["NET-IP-V4"]&&(c["NET-IP-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-IP-V6"]&&(c["NET-IP-V6"]=a)}if(null!=b.defaultIPGateway)for(e=b.defaultIPGateway.toArray(),g=0,k=e.length;g<k;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-GATEWAY-V4"]&&(c["NET-GATEWAY-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-GATEWAY-V6"]&&(c["NET-GATEWAY-V6"]=a);if(null!=b.dnsServerSearchOrder)for(e=b.dnsServerSearchOrder.toArray(),g=0,k=e.length;g<k;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-DNS-V4"]&&(c["NET-DNS-V4"]=
a),a&&-1==a.indexOf(".")&&!c["NET-DNS-V6"]&&(c["NET-DNS-V6"]=a);if(null!=b.ipSubnet)for(e=b.ipSubnet.toArray(),g=0,k=e.length;g<k;g++)(a=d.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!c["NET-SUBNET-V4"]&&(c["NET-SUBNET-V4"]=a),a&&-1==a.indexOf(".")&&!c["NET-SUBNET-V6"]&&(c["NET-SUBNET-V6"]=a);if(a=d.fun.clear(b.dhcpServer))c["NET-DHCP-V4"]=a;if(a=d.fun.clear(b.description,"Сетевой адаптер","Адаптер","для виртуальной сети","Сетевая карта","Контроллер","NIC (NDIS 6.20)","- Минипорт планировщика пакетов",
"Family Controller","Adapter"))c["NET-NAME"]=a;if(a=d.fun.clear(b.macAddress))c["NET-MAC"]=a;break}e=0;response=n.execQuery("SELECT speed, timeOfLastReset FROM Win32_NetworkAdapter WHERE netEnabled = TRUE AND interfaceIndex = "+d.fun.repair(u));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.speed)c["NET-SPEED"]=d.fun.info2str(a,0,1E3)+"бит/с";if(a=b.speed)c["NET-SPEED-VAL"]=a;if(a=b.timeOfLastReset)c["NET-RESET"]=d.lib.date2str(d.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.timeOfLastReset)c["NET-RESET-DATE"]=
d.lib.date2str(d.fun.wql2date(a),"d.m.Y");break}e&&(q=q?Math.min(q,e):e);response=n.execQuery("SELECT * FROM Win32_ComputerSystem");for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.dnsHostName)p=a;if(a=b.name)p||(p=a.toLowerCase());b.domain!=b.workgroup&&(r=b.domain);if(a=b.userName)var z=a.split(d.val.keyDelim)[0];if(a=b.userName)var y=a.split(d.val.keyDelim)[1];if(a=b.userName)var w=a;if(a=d.fun.clear(p))c["NET-HOST"]=a;if(a=d.fun.clear(b.domain))c["NET-DOMAIN"]=a;if(a=
d.fun.clear(b.model))c["DEV-NAME"]=a;a&&(a=d.fun.clear(b.manufacturer,"Inc.","Hewlett-Packard"))&&(c["DEV-NAME"]=a.split(" ")[0]+" "+d.fun.clear(b.model));break}!w&&l&&(e=[],f=l.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName="DefaultDomainName",b=l.execMethod_(f.name,b),!b.returnValue&&b.sValue&&e.push(b.sValue),f=l.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),
b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName="DefaultUserName",b=l.execMethod_(f.name,b),!b.returnValue&&b.sValue&&e.push(b.sValue),2==e.length&&(z=e[0]),2==e.length&&(y=e[1]),2==e.length&&(w=e.join(d.val.keyDelim)));if(!w){e=null;response=n.execQuery("SELECT lastUseTime, localPath, loaded FROM Win32_UserProfile WHERE special = FALSE");for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),(a=e?0:1)||(a=b.loaded&&!e.loaded?
1:a),a||(a=d.lib.compare(d.fun.wql2date(b.lastUseTime),d.fun.wql2date(e.lastUseTime))),0<a&&(e=b);if(b=e){if(a=b.localPath.split(d.val.keyDelim).pop())y=a;if(a=b.localPath)var G=a}}if(y){var h=n;g=[".",r];do{response=h.execQuery("SELECT domain, name, fullName, sid FROM Win32_UserAccount WHERE name = "+d.fun.repair(y)+(z?" AND domain = "+d.fun.repair(z):""));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.fullName))c["USR-NAME"]=a;if(a=d.fun.clear(b.fullName)){e=
a.split(d.val.argDelim);for(k=e.length-1;-1<k;k--)a=d.fun.clear(e[k],/[\[\(,\.\)\]]/g),(f=(f=3>a.length)||d.lib.hasValue(["von"],a,!0))?e.splice(k,1):e[k]=a;if(a=e[0])c["USR-NAME-FIRST"]=a;if(a=e[1])c["USR-NAME-SECOND"]=a;if(a=e[2])c["USR-NAME-THIRD"]=a;if(a=e[3])c["USR-NAME-FOURTH"]=a}e=[];if(a=b.sid)var C=a;(a=b.domain)&&e.push(a);(a=b.name)&&e.push(a);2==e.length&&(z=e[0]);2==e.length&&(y=e[1]);2==e.length&&(w=e.join(d.val.keyDelim));break}try{h=!g.length||C?null:x.connectServer(g.shift(),"root\\CIMV2")}catch(B){h=
null}}while(h)}if(w)for(response=n.execQuery("SELECT homeDirectory FROM Win32_NetworkLoginProfile WHERE name = "+d.fun.repair(w)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.homeDirectory)var I=a;break}if(!G&&C)for(response=n.execQuery("SELECT localPath FROM Win32_UserProfile WHERE sid = "+d.fun.repair(C)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.localPath)G=a;break}if(a=d.fun.clear(C))c["USR-SID"]=a;if(a=d.fun.clear(w))c["USR-LOGIN"]=a;if(a=
d.fun.clear(z))c["USR-DOMAIN"]=a;if(a=d.fun.clear(y))c["USR-ACCOUNT"]=a;if(a=d.fun.clear(G))c["USR-PROFILE"]=a;if(a=d.fun.clear(I))c["USR-HOME"]=a;if(p&&F)for(response=F.execQuery("SELECT DS_distinguishedName FROM DS_computer WHERE DS_cn = "+d.fun.repair(p)),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=d.fun.clear(b.DS_distinguishedName))c["NET-HOST-DN"]=a;break}e=0;response=n.execQuery("SELECT architecture, maxClockSpeed, name, revision, numberOfCores, socketDesignation FROM Win32_Processor WHERE role = 'CPU'");
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();0==b.architecture?c["CPU-ARCHITECTURE"]="x86":9==b.architecture&&(c["CPU-ARCHITECTURE"]="x64");if(a=b.maxClockSpeed)c["CPU-SPEED"]=d.fun.info2str(1E6*a,2,1E3)+"Гц";if(a=b.maxClockSpeed)c["CPU-SPEED-VAL"]=1E6*a;if(a=d.fun.clear(b.name,"CPU","APU","Процессор","Processor","with","Radeon HD Graphics","11th Gen"))c["CPU-NAME"]=a;if(a=d.fun.clear(b.revision))c["CPU-VERSION"]=a;if(a=b.numberOfCores)c["CPU-CORE"]=a;if(a=d.fun.clear(b.socketDesignation,
...
a;if(a=b.currentVerticalResolution)c["GPU-RESOLUTION-Y"]=a;if(a=b.currentRefreshRate)c["GPU-FREQUENCY"]=d.fun.info2str(a,0,1E3)+"Гц";if(a=b.currentRefreshRate)c["GPU-FREQUENCY-VAL"]=a;if(a=b.currentBitsPerPixel)c["GPU-COLOR"]=d.fun.info2str(a,0)+"бит"+d.lib.numDeclin(a,"","","а");if(a=b.currentBitsPerPixel)c["GPU-COLOR-VAL"]=a;break}e=0;response=t?t.execQuery("SELECT model, firmwareVersion, mediaType, serialNumber, size FROM MSFT_PhysicalDisk"):n.execQuery("SELECT * FROM Win32_DiskDrive");for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();switch(b.mediaType){case 0:h="USB";break;case 3:h="HDD";break;case 4:h="SSD";break;case 5:h="SCM";break;case "Removable Media":h="USB";break;case "Fixed\thard disk media":case "Fixed hard disk media":h=b.model&&-1!=b.model.indexOf("Solid")?"SSD":b.model&&-1!=b.model.indexOf("SSD")?"SSD":b.model&&!b.model.indexOf("ADATA")?"SSD":"HDD";break;default:h=""}if((!b.model||-1==b.model.indexOf("Raid"))&&h&&!c[h+"-NAME"]){if(a=d.fun.clear(b.model,"ATA Device","SCSI Disk Device","USB Device",
"SSD","SATA"))c[h+"-NAME"]=a;if(a=d.fun.clear(b.firmwareVersion||b.firmwareRevision))c[h+"-VERSION"]=a;if(a=d.fun.clear(b.serialNumber))c[h+"-SERIAL"]=a;if(a=b.size)c[h+"-SIZE"]=d.fun.info2str(a,0)+"Б";if(a=b.size)c[h+"-SIZE-VAL"]=a;h&&(e=Math.max(e,"SDD"==h?15.51143:7.14577))}}e&&(q=q?Math.min(q,e):e);response=n.execQuery("SELECT mediaType, caption, drive FROM Win32_CDROMDrive");for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),!b.caption||-1==b.caption.indexOf("Alcohol"))if(!b.caption||
-1==b.caption.indexOf("Virtual")){switch(b.mediaType){case "CD-ROM":c["ROM-TYPE"]="CD";break;case "DVD-ROM":c["ROM-TYPE"]="DVD";break;case "CD Writer":c["ROM-TYPE"]="CD-RW";break;case "DVD Writer":c["ROM-TYPE"]="DVD-RW"}if(a=d.fun.clear(b.caption,"ATA Device","SCSI CdRom Device"))c["ROM-NAME"]=a;if(a=d.fun.clear(b.drive))c["ROM-DRIVE"]=a;break}response=n.execQuery("SELECT caption, size FROM Win32_LogicalDisk WHERE driveType = 2 OR driveType = 3 OR driveType = 4");for(f=new Enumerator(response);!f.atEnd();)b=
f.item(),f.moveNext(),b.caption&&-1!=b.caption.indexOf(H)||c["BAK-DRIVE"]||(a=d.fun.clear(b.caption))&&b.size>=d.val.driveMinSize&&(c["BAK-DRIVE"]=a);u="";h="DisplayIcon";e=["SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма"];a="";if(l)for(f=l.methods_.item("getStringValue"),
g=0,k=e.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=l.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(e=a.split(d.val.keyDelim),e.pop(),e.pop(),u=e.join(d.val.keyDelim),c["APP-EFARMA-DIR"]=u);h="\\Client\\ePlus.Client.exe";e=[u];a="";g=0;for(k=e.length;g<k;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=
f.item(),f.moveNext(),g=0,k=e.length;g<k;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-CLIENT"]=a;break}h="\\ARM\\ePlus.ARMCasherNew.exe";e=[u];a="";g=0;for(k=e.length;g<k;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=e.length;g<k;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-CASHER"]=a;break}h=
"\\UpdateServer\\ePlus.UpdateServer.exe";e=[u];a="";g=0;for(k=e.length;g<k;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=e.length;g<k;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-UPDATER"]=a;break}h="lic";e=[u+"\\UpdateServer\\",u+"\\Client\\",u+"\\ARM\\"];a="";g=0;for(k=e.length;g<k;g++)g&&(a+=" OR "),a+="drive = "+d.fun.repair(d.lib.strim(e[g],
"",":",!0,!1))+" ",a+="AND path = "+d.fun.repair(d.lib.strim(e[g],":","",!1,!1))+" ",a+="AND extension = "+d.fun.repair(h);response=n.execQuery("SELECT name, fileName FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=e.length;g<k;g++)if(a=e[g]+b.fileName+"."+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-EFARMA-LICENSE"]=a;break}a=d.lib.date2str(A,"Y");h="\\ULUS.exe";e=["C:\\SoftLink\\Ulus\\"+a,"C:\\LO\\ULUS\\"+a,"C:\\so\\Ulus\\"+a,
"C:\\ULUS\\"+a];a="";g=0;for(k=e.length;g<k;g++)g&&(a+=" OR "),a+="name = "+d.fun.repair(e[g]+h);response=n.execQuery("SELECT name FROM CIM_DataFile WHERE "+a);for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,k=e.length;g<k;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){c["APP-ULUS"]=a;c["APP-ULUS-DIR"]=e[g];break}h="";e=["SOFTWARE\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command","SOFTWARE\\WOW6432Node\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command"];
a="";if(l)for(f=l.methods_.item("getStringValue"),g=0,k=e.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=l.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(e=a.split(d.val.keyDelim),e.pop(),c["APP-CHROME"]=a,c["APP-CHROME-DIR"]=e.join(d.val.keyDelim));h="";e=["SOFTWARE\\VideoLAN\\VLC","SOFTWARE\\WOW6432Node\\VideoLAN\\VLC"];a="";if(l)for(f=l.methods_.item("getStringValue"),g=0,k=e.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),
b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=l.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=d.fun.clear(b.sValue));a&&(e=a.split(d.val.keyDelim),e.pop(),c["APP-VLC"]=a,c["APP-VLC-DIR"]=e.join(d.val.keyDelim));h="ClientID";e=["SOFTWARE\\TeamViewer","SOFTWARE\\WOW6432Node\\TeamViewer"];a="";if(l)for(f=l.methods_.item("getDWORDValue"),g=0,k=e.length;g<k&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=e[g],b.sValueName=h,b=l.execMethod_(f.name,b),!b.returnValue&&
b.uValue&&(a=d.fun.clear(b.uValue));a&&(c["APP-TEAMVIEWER-ID"]=a);e=[];c["CPU-NAME"]&&c["CPU-CORE"]&&c["CPU-SPEED"]&&e.push(d.fun.clear(c["CPU-NAME"].replace("Dual-Core","Intel"),"Dual Core","Xeon","Pentium","Celeron","Core2 Duo","Core","Processor","Athlon 64","Athlon",/,.+/,/@.+/,/\d\.d+GHz/)+" "+c["CPU-CORE"]+"x"+c["CPU-SPEED"].replace(",",".").replace(" МГц","M").replace(" ГГц","G")+"Hz");c["RAM-SIZE"]&&c["RAM-SPEED"]&&e.push(c["RAM-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+c["RAM-SPEED"].replace(" МГц",
"M").replace(" ГГц","G")+"Hz");c["GPU-SIZE"]&&c["GPU-NAME"]&&(-1!=c["GPU-NAME"].indexOf("GeForce")||-1!=c["GPU-NAME"].indexOf("Radeon"))&&e.push(c["GPU-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+d.fun.clear(c["GPU-NAME"],"AMD","NVIDIA","GeForce","Radeon",/\(.+/));c["HDD-SIZE"]&&e.push(c["HDD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" HDD");c["SSD-SIZE"]&&e.push(c["SSD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" SSD");c["USB-SIZE"]&&e.push(c["USB-SIZE"].replace(" МБ",
...
if(m.input)try{h="windows-1251",a=v.stdIn.readAll(),m.charset!=h&&(a=d.wsh.iconv(m.charset,h,a))}catch(B){a=""}if(m.input&&a)switch(b=0,l="",t=a.split(d.val.linDelim),m.input){case "ini":b=d.lib.ini2obj(a,!1);for(h in b)!h||!b[h]||h in c||(c[h]=b[h]);break;case "TSV":l||(l=d.val.tsvDelim);case "CSV":l||(l=d.val.csvDelim),b<t.length&&(n=t[b++].split(l));case "tsv":l||(l=d.val.tsvDelim);case "csv":for(l||(l=d.val.csvDelim);b<t.length;)for(e=t[b++].split(l),g=0,k=n.length;g<k;g++)h=n[g],!h||!e[g]||h in
c||(c[h]=e[g])}if(m.output)switch(t=[],l="",m.output){case "ini":l=d.val.argDelim+d.val.iniDelim+d.val.argDelim;e=[];for(h in c)e.push(h);e.sort();g=0;for(k=e.length;g<k;g++)h=e[g],a=c[h]?c[h]:"",a=h+l+a,t.push(a);a=t.join(d.val.linDelim);break;case "TSV":l||(l=d.val.tsvDelim);case "CSV":l||(l=d.val.csvDelim);f=!0;e=[];g=0;for(k=n.length;g<k;g++)(h=n[g])&&(f=!1),e.push(h);a=n.join(l);f||t.push(a);case "tsv":l||(l=d.val.tsvDelim);case "csv":l||(l=d.val.csvDelim);f=!0;e=[];g=0;for(k=n.length;g<k;g++)h=
n[g],(a=c[h]?c[h]:"")&&(f=!1),e.push(a);a=e.join(l);f||t.push(a);a=t.join(d.val.linDelim)}if(m.output&&a){a+=d.val.linDelim;try{v.stdOut.write(a)}catch(B){}}f=E.environment(d.val.envType);for(h in c)a=c[h],setEnv(f,h,a);f=[];for(b=D;b<v.arguments.length;b++)a=v.arguments.item(b),a=a.split(d.val.getDelim).join(d.val.setDelim),(a=E.expandEnvironmentStrings(a))&&-1==a.indexOf(d.val.argDelim)||(a=d.val.argWrap+a+d.val.argWrap),f.push(a);if(c=f.join(d.val.argDelim)){D=m.silent?0:d.val.runStyle;try{a=E.run(c,
D,!m.nowait),m.nowait&&(a=d.val.defReturn)}catch(B){a=d.val.defReturn}}else a=d.val.defReturn;v.quit(a)}})})(WSH,env);env.init();
