...
(function(w,c,D){c.lib.extend(c,{fun:{wql2date:function(g,q){return new Date(g?Date.UTC(1*g.substr(0,4),1*g.substr(4,2)-1,1*g.substr(6,2),1*g.substr(8,2),1*g.substr(10,2)-1*g.substr(21,4)+(q||0),1*g.substr(12,2),1*g.substr(14,3)):0)},bin2key:function(g){var q="";var t=g.toArray();g=Math.floor(t[66]/6)&1;t[66]=t[66]&247|4*(g&2);for(var l=24;-1<l;l--){var d=0;for(var m=14;-1<m;m--)d*=256,d=t[m+52]+d,t[m+52]=Math.floor(d/24),d%=24;q="BCDFGHJKMPQRTVWXY2346789".substr(d,1)+q}1==g&&(g=q.substr(1,d),q=q.substr(1).replace(g,
g+"N"));return[q.substr(0,5),q.substr(5,5),q.substr(10,5),q.substr(15,5),q.substr(20,5)].join("-")},bin2sid:function(g){var q="";g=g.toArray();var t=g[0]&255;var l=g[1]&255;var d=0;for(var m=2;7>=m;m++)d+=(g[m]&255)*(1<<8*(5-(m-2)));q=q+("S-"+t)+("-"+d);d=8;for(m=0;m<l;m++){for(var u=t=0;4>u;u++)t+=(g[d+u]&255)*(1<<8*u);q+="-"+t;d+=4}return q},info2str:function(g,q,t){if(!t||2>t)t=1024;if(!q||0>q)q=0;var l=Math.pow(10,q);for(var d=-1;g>=t;d++)g/=t;g=Math.ceil(g*l)/l;g=c.lib.num2str(g,-1<d?q:0,",",
"");return g+=" "+"КМГТПЭЗЙ".charAt(d)},clear:function(g){g=g?""+g:"";"INVALID"==g&&(g="");"To be filled by O.E.M."==g&&(g="");"System Product Name"==g&&(g="");"System Serial Number"==g&&(g="");"System manufacturer"==g&&(g="");"Default string"==g&&(g="");"empty"==g&&(g="");"None"==g&&(g="");for(var q=1,t=arguments.length;q<t;q++)g=g.replace(arguments[q],"");return g.replace(/\(R\)/gi,"").replace(/\(Registered Trademark\)/gi,"").replace(/\(Microsoft Corporation\)/gi,"").replace(/\(Корпорация Майкрософт\)/gi,
"").replace(/\(Майкрософт\)/gi,"").replace(/\(TM\)/gi,"").replace(/^[/'"]|[/"']$/g,"").replace(/\r\n|\n|\t/g," ").replace(/^\s+|\s+$/g,"").replace(/\.+$/,"").replace(/\s(?=\s)/gi,"")},repair:function(g){return("'"+(g?g:"")+"'").replace(/\\/g,"\\\\")},debug:function(){var g,q,t={},l=-1;return function(d){if(t.first){g=[c.lib.strPad(l,3,"0","left")];g.push("|");g.push(c.lib.strPad(c.lib.num2str((t.now.valueOf()-t.first.valueOf())/1E3,3,".",""),7,"0","left"));t.last=t.now;t.now=new Date;g.push("+"+c.lib.strPad(c.lib.num2str((t.now.valueOf()-
t.last.valueOf())/1E3,3,".",""),7,"0","left"));g.push("|");g.push(q);try{w.stdErr.writeLine(g.join(" "))}catch(m){}}else t.now=new Date;!l&&q&&(t.first=t.now);q=d;l++;return d}}()},init:function(){var g,q="",t="",l={};var d={};var m={},u=0;var y=new Date;for(g=0;g<w.arguments.length;g++){var a=w.arguments.item(g);if(!("context"in m)){var e=a.split(c.val.keyDelim);if(3==e.length&&!e[0]&&!e[1]){m.context=e[2];continue}}if(!("input"in m)&&(e=a.split(c.val.chrDelim),2==e.length&&c.lib.hasValue(["ini",
"csv","tsv","CSV","TSV"],e[0],!0)&&e[1])){m.input=e[0];m.charset=e[1];continue}if(!("output"in m)&&(e=a.split(c.val.chrDelim),1==e.length&&c.lib.hasValue(["ini","csv","tsv","CSV","TSV"],e[0],!0))){m.output=e[0];continue}if("silent"in m||"silent"!=a)if("nowait"in m||"nowait"!=a)if("debug"in m||"debug"!=a)break;else m.debug=!0;else m.nowait=!0;else m.silent=!0}var A=g;"context"in m||(m.context=".");"auto"==m.charset&&(m.charset="windows-1251");var B=new ActiveXObject("WScript.Shell");e=new ActiveXObject("wbemScripting.Swbemlocator");
e.security_.impersonationLevel=3;c.fun.debug(m.debug);if(m.context)for(c.fun.debug("Connect and create objects"),g=1;g;g++)try{switch(g){case 1:var r=e.connectServer(m.context,"root\\CIMV2");break;case 2:var x=e.connectServer(".","root\\directory\\LDAP");break;case 3:var v=e.connectServer(m.context,"root\\Microsoft\\Windows\\Storage");break;case 4:var n=e.connectServer(m.context,"root\\default").get("stdRegProv");break;default:g=-1}}catch(z){switch(g){case 1:r=null;break;case 2:x=null;break;case 3:v=
null;break;case 4:n=null}}if(r){if(n){var f=n.methods_.item("getBinaryValue");var b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";b.sValueName=c.fun.debug("DigitalProductId");b=n.execMethod_(f.name,b);!b.returnValue&&(a=c.fun.bin2key(b.uValue),a=c.fun.clear(a,"BBBBB-BBBBB-BBBBB-BBBBB-BBBBB"))&&(d["SYS-KEY"]=a)}response=r.execQuery(c.fun.debug("SELECT * FROM Win32_OperatingSystem WHERE primary = TRUE"));for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.systemDrive)var C=a;if(a=b.localDateTime)y=c.fun.wql2date(a);if(a=c.fun.clear(b.caption,"Майкрософт","Microsoft","Edition","x64",","))d["SYS-NAME"]=a;if(a=c.fun.clear(b.version))d["SYS-VERSION"]=a;if(a=b.localDateTime)d["SYS-TIME"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.localDateTime)d["SYS-TIME-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");if(a=c.fun.clear(b.systemDrive))d["SYS-DRIVE"]=a;if(a=b.installDate)d["SYS-INSTALL"]=c.lib.date2str(c.fun.wql2date(a),
"d.m.Y H:i:s");if(a=b.installDate)d["SYS-INSTALL-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");if(a=b.lastBootUpTime)d["SYS-RESET"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.lastBootUpTime)d["SYS-RESET-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");if(a=c.fun.clear(b.serialNumber))d["SYS-SERIAL"]=a;if(a=c.fun.clear(b.description))d["SYS-DESCRIPTION"]=a;d["SYS-ARCHITECTURE"]=b.osArchitecture&&!b.osArchitecture.indexOf("64")?"x64":"x86";break}response=r.execQuery(c.fun.debug("SELECT manufacturer, product, serialNumber FROM Win32_BaseBoard WHERE hostingBoard = TRUE"));
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=c.fun.clear(b.product))d["PCB-NAME"]=a;a&&(a=c.fun.clear(b.manufacturer,"Inc.").replace("Hewlett-Packard","HP"))&&(d["PCB-NAME"]=a.split(" ")[0]+" "+c.fun.clear(b.product));if(a=c.fun.clear(b.serialNumber))d["PCB-SERIAL"]=a;break}response=r.execQuery(c.fun.debug("SELECT releaseDate, manufacturer, smBIOSBIOSVersion, serialNumber FROM Win32_BIOS WHERE primaryBIOS = TRUE"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();
f.moveNext();if(a=c.fun.clear(b.releaseDate))d["PCB-BIOS-RELEASE"]=c.lib.date2str(c.fun.wql2date(a,y.getTimezoneOffset()),"d.m.Y H:i:s");if(a=c.fun.clear(b.releaseDate))d["PCB-BIOS-RELEASE-DATE"]=c.lib.date2str(c.fun.wql2date(a,y.getTimezoneOffset()),"d.m.Y");if(a=c.fun.clear(b.manufacturer,"Inc."))d["PCB-BIOS-MANUFACTURE"]=a;if(a=c.fun.clear(b.smBIOSBIOSVersion))d["PCB-BIOS-VERSION"]=a;if(a=c.fun.clear(b.serialNumber))d["PCB-BIOS-SERIAL"]=a;break}g="";response=r.execQuery(c.fun.debug("SELECT * FROM Win32_NetworkAdapterConfiguration WHERE ipEnabled = TRUE"));
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.index)g=a;if(null!=b.ipAddress){e=b.ipAddress.toArray();for(var h=0,p=e.length;h<p;h++)(a=c.fun.clear(e[h]))&&-1!=a.indexOf(".")&&!d["NET-IP-V4"]&&(d["NET-IP-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-IP-V6"]&&(d["NET-IP-V6"]=a)}if(null!=b.defaultIPGateway)for(e=b.defaultIPGateway.toArray(),h=0,p=e.length;h<p;h++)(a=c.fun.clear(e[h]))&&-1!=a.indexOf(".")&&!d["NET-GATEWAY-V4"]&&(d["NET-GATEWAY-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-GATEWAY-V6"]&&
(d["NET-GATEWAY-V6"]=a);if(null!=b.dnsServerSearchOrder)for(e=b.dnsServerSearchOrder.toArray(),h=0,p=e.length;h<p;h++)(a=c.fun.clear(e[h]))&&-1!=a.indexOf(".")&&!d["NET-DNS-V4"]&&(d["NET-DNS-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-DNS-V6"]&&(d["NET-DNS-V6"]=a);if(null!=b.ipSubnet)for(e=b.ipSubnet.toArray(),h=0,p=e.length;h<p;h++)(a=c.fun.clear(e[h]))&&-1!=a.indexOf(".")&&!d["NET-SUBNET-V4"]&&(d["NET-SUBNET-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-SUBNET-V6"]&&(d["NET-SUBNET-V6"]=a);if(a=c.fun.clear(b.dhcpServer))d["NET-DHCP-V4"]=
a;if(a=c.fun.clear(b.description,"Сетевой адаптер","Адаптер","для виртуальной сети","Сетевая карта","Контроллер","NIC (NDIS 6.20)","- Минипорт планировщика пакетов","Family Controller","Adapter"))d["NET-NAME"]=a;if(a=c.fun.clear(b.macAddress))d["NET-MAC"]=a;break}e=0;response=r.execQuery(c.fun.debug("SELECT speed, timeOfLastReset FROM Win32_NetworkAdapter WHERE netEnabled = TRUE AND deviceID = "+c.fun.repair(g)));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.speed)d["NET-SPEED"]=
c.fun.info2str(a,0,1E3)+"бит/с";if(a=b.speed)d["NET-SPEED-VAL"]=a;if(a=b.timeOfLastReset)d["NET-RESET"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.timeOfLastReset)d["NET-RESET-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");break}e&&(u=u?Math.min(u,e):e);response=r.execQuery(c.fun.debug("SELECT * FROM Win32_ComputerSystem"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.dnsHostName)q=a;if(a=b.name)q||(q=a.toLowerCase());b.domain!=b.workgroup&&(t=b.domain);
if(a=b.userName)l.domain=a.split(c.val.keyDelim)[0];if(a=b.userName)l.login=a.split(c.val.keyDelim)[1];if(a=b.userName)l.account=a;if(a=c.fun.clear(q))d["NET-HOST"]=a;if(a=c.fun.clear(b.domain))d["NET-DOMAIN"]=a;if(a=c.fun.clear(b.model))d["DEV-NAME"]=a;a&&(a=c.fun.clear(b.manufacturer,"Inc.","Hewlett-Packard"))&&(d["DEV-NAME"]=a.split(" ")[0]+" "+c.fun.clear(b.model));break}!l.account&&n&&(e=[],f=n.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=
"SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName=c.fun.debug("DefaultDomainName"),b=n.execMethod_(f.name,b),!b.returnValue&&b.sValue&&e.push(b.sValue),f=n.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName=c.fun.debug("DefaultUserName"),b=n.execMethod_(f.name,b),!b.returnValue&&b.sValue&&e.push(b.sValue),2==e.length&&(l.domain=e[0]),2==e.length&&(l.login=
e[1]),2==e.length&&(l.account=e.join(c.val.keyDelim)));if(!l.account){var k=null;response=r.execQuery(c.fun.debug("SELECT lastUseTime, localPath, loaded, sid FROM Win32_UserProfile WHERE special = FALSE"));for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),(a=k?0:1)||(a=b.loaded&&!k.loaded?1:a),a||(a=c.lib.compare(c.fun.wql2date(b.lastUseTime),c.fun.wql2date(k.lastUseTime))),0<a&&(k=b);if(b=k)if(l.profile=b.localPath,a=b.sid)l.sid=a}if(!l.account&&l.sid){e=[];try{b=r.get('Win32_SID.SID="'+
l.sid+'"')}catch(z){b=null}(a=b.referencedDomainName)&&e.push(a);(a=b.accountName)&&e.push(a);2==e.length&&(l.domain=e[0]);2==e.length&&(l.login=e[1]);2==e.length&&(l.account=e.join(c.val.keyDelim))}if(l.account&&c.lib.hasValue([".",q],l.domain,!1))for(response=r.execQuery(c.fun.debug("SELECT domain, name, fullName, sid FROM Win32_UserAccount WHERE name = "+c.fun.repair(l.login)+" AND domain = "+c.fun.repair(l.domain))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();e=[];l.name=b.fullName;
if(a=b.sid)l.sid=a;(a=b.domain)&&e.push(a);(a=b.name)&&e.push(a);2==e.length&&(l.domain=e[0]);2==e.length&&(l.login=e[1]);2==e.length&&(l.account=e.join(c.val.keyDelim));break}if(l.account&&x&&!c.lib.hasValue([".",q],l.domain,!1))for(e="DS_co DS_c DS_company DS_displayName DS_department DS_info DS_homeDirectory DS_l DS_mail DS_mobile DS_objectSid DS_telephoneNumber DS_title DS_distinguishedName".split(" "),response=x.execQuery(c.fun.debug("SELECT "+e.join(", ")+" FROM DS_user WHERE DS_sAMAccountName = "+
c.fun.repair(l.login))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();l.name=b.DS_displayName;l.home=b.DS_homeDirectory;if(k=b.DS_objectSid)l.sid=c.fun.bin2sid(k.value);if(a=c.fun.clear(b.DS_co))d["USR-COUNTRY"]=a;if(a=c.fun.clear(b.DS_c))d["USR-COUNTRY-ID"]=a;if(a=c.fun.clear(b.DS_company))d["USR-COMPANY"]=a;if(a=c.fun.clear(b.DS_department))d["USR-DEPARTMENT"]=a;if(a=c.fun.clear(b.DS_distinguishedName))d["USR-ACCOUNT-DN"]=a;if(a=c.fun.clear(b.DS_l))d["USR-CITY"]=a;if(a=c.fun.clear(b.DS_mail))d["USR-EMAIL"]=
a;if(a=c.fun.clear(b.DS_mobile))d["USR-MOBILE"]=a;if(a=c.fun.clear(b.DS_telephoneNumber))d["USR-PHONE"]=a;if(a=c.fun.clear(b.DS_title))d["USR-POSITION"]=a;if(a=c.fun.clear(b.DS_info))d["USR-INFO"]=a;break}if(l.account&&!("home"in l))for(response=r.execQuery(c.fun.debug("SELECT homeDirectory FROM Win32_NetworkLoginProfile WHERE name = "+c.fun.repair(l.account))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();l.home=b.homeDirectory;break}if(l.sid&&!("profile"in l))for(response=r.execQuery(c.fun.debug("SELECT localPath FROM Win32_UserProfile WHERE sid = "+
c.fun.repair(l.sid))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();l.profile=b.localPath;break}if(a=c.fun.clear(l.sid))d["USR-SID"]=a;if(a=c.fun.clear(l.account))d["USR-ACCOUNT"]=a;if(a=c.fun.clear(l.login))d["USR-LOGIN"]=a;if(a=c.fun.clear(l.domain))d["USR-DOMAIN"]=a;if(a=c.fun.clear(l.profile))d["USR-PROFILE"]=a;if(a=c.fun.clear(l.home))d["USR-HOME"]=a;if(a=c.fun.clear(l.name))d["USR-NAME"]=a;if(a=c.fun.clear(l.name)){e=a.split(c.val.argDelim);for(h=e.length-1;-1<h;h--)a=c.fun.clear(e[h],
/[\[\(,\.\)\]]/g),(b=(b=3>a.length)||c.lib.hasValue(["von"],a,!0))?e.splice(h,1):e[h]=a;if(a=e[0])d["USR-NAME-FIRST"]=a;if(a=e[1])d["USR-NAME-SECOND"]=a;if(a=e[2])d["USR-NAME-THIRD"]=a;if(a=e[3])d["USR-NAME-FOURTH"]=a}if(q&&x&&t)for(response=x.execQuery(c.fun.debug("SELECT DS_distinguishedName FROM DS_computer WHERE DS_cn = "+c.fun.repair(q))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=c.fun.clear(b.DS_distinguishedName))d["NET-HOST-DN"]=a;break}e=0;response=r.execQuery(c.fun.debug("SELECT architecture, maxClockSpeed, name, revision, numberOfCores, socketDesignation FROM Win32_Processor WHERE role = 'CPU'"));
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();0==b.architecture?d["CPU-ARCHITECTURE"]="x86":9==b.architecture&&(d["CPU-ARCHITECTURE"]="x64");if(a=b.maxClockSpeed)d["CPU-SPEED"]=c.fun.info2str(1E6*a,2,1E3)+"Гц";if(a=b.maxClockSpeed)d["CPU-SPEED-VAL"]=1E6*a;if(a=c.fun.clear(b.name,"CPU","APU","Процессор","Processor","with","Radeon HD Graphics","11th Gen"))d["CPU-NAME"]=a;if(a=c.fun.clear(b.revision))d["CPU-VERSION"]=a;if(a=c.fun.clear(b.numberOfCores))d["CPU-CORE"]=a;if(a=c.fun.clear(b.socketDesignation,
"SOCKET 0"))d["CPU-SOCKET"]=a;if(a=b.maxClockSpeed)e+=2.26143*Math.sqrt(a/1E3);if(a=b.numberOfCores)e*=1.02033*Math.sqrt(a);break}e&&(u=u?Math.min(u,e):e);response=r.execQuery(c.fun.debug("SELECT level, maxCacheSize FROM Win32_CacheMemory"));for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),a=b.maxCacheSize)d["CPU-CACHE-L"+(b.level-2)]=c.fun.info2str(1024*a,0)+"Б";k=e=0;response=r.execQuery(c.fun.debug("SELECT capacity, speed FROM Win32_PhysicalMemory"));for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.capacity)d["RAM-SIZE-VAL"]=k+=1*a;b.capacity&&(d["RAM-SIZE"]=c.fun.info2str(k,0)+"Б");if(a=b.speed)d["RAM-SPEED"]=a+" МГц";if(a=b.speed)d["RAM-SPEED-VAL"]=1E6*a;if(a=k)e=2.51143*Math.sqrt(a/1024/1024/1024);if(a=b.speed)e*=.92245*Math.sqrt(a/1E3)}e&&(u=u?Math.min(u,e):e);response=r.execQuery(c.fun.debug("SELECT adapterRam, name, driverVersion, currentHorizontalResolution, currentRefreshRate, currentBitsPerPixel, currentVerticalResolution FROM Win32_VideoController"));for(f=
new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.adapterRam)d["GPU-SIZE"]=c.fun.info2str(Math.abs(a),0)+"Б";if(a=b.adapterRam)d["GPU-SIZE-VAL"]=Math.abs(a);if(a=c.fun.clear(b.name,"GPU","Видеоустройство","Family","Chipset","Series","Graphics","Adapter"))d["GPU-NAME"]=a;if(a=c.fun.clear(b.driverVersion))d["GPU-VERSION"]=a;b.currentHorizontalResolution&&b.currentVerticalResolution&&(d["GPU-RESOLUTION"]=b.currentHorizontalResolution+" x "+b.currentVerticalResolution);if(a=b.currentHorizontalResolution)d["GPU-RESOLUTION-X"]=
a;if(a=b.currentVerticalResolution)d["GPU-RESOLUTION-Y"]=a;if(a=b.currentRefreshRate)d["GPU-FREQUENCY"]=c.fun.info2str(a,0,1E3)+"Гц";if(a=b.currentRefreshRate)d["GPU-FREQUENCY-VAL"]=a;if(a=b.currentBitsPerPixel)d["GPU-COLOR"]=c.fun.info2str(a,0)+"бит"+c.lib.numDeclin(a,"","","а");if(a=b.currentBitsPerPixel)d["GPU-COLOR-VAL"]=a;break}e=0;response=v?v.execQuery(c.fun.debug("SELECT model, firmwareVersion, mediaType, serialNumber, size FROM MSFT_PhysicalDisk")):r.execQuery(c.fun.debug("SELECT * FROM Win32_DiskDrive"));
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();switch(b.mediaType){case 0:k="USB";break;case 3:k="HDD";break;case 4:k="SSD";break;case 5:k="SCM";break;case "Removable Media":k="USB";break;case "Fixed\thard disk media":case "Fixed hard disk media":k=b.model&&-1!=b.model.indexOf("Solid")?"SSD":b.model&&-1!=b.model.indexOf("SSD")?"SSD":b.model&&!b.model.indexOf("ADATA")?"SSD":"HDD";break;default:k=""}if((!b.model||-1==b.model.indexOf("Raid"))&&k&&!d[k+"-NAME"]){if(a=c.fun.clear(b.model,
"ATA Device","SCSI Disk Device","USB Device","SSD","SATA"))d[k+"-NAME"]=a;if(a=c.fun.clear(b.firmwareVersion||b.firmwareRevision))d[k+"-VERSION"]=a;if(a=c.fun.clear(b.serialNumber))d[k+"-SERIAL"]=a;if(a=b.size)d[k+"-SIZE"]=c.fun.info2str(a,0)+"Б";if(a=b.size)d[k+"-SIZE-VAL"]=a;k&&(e=Math.max(e,"SDD"==k?15.51143:7.14577))}}e&&(u=u?Math.min(u,e):e);response=r.execQuery(c.fun.debug("SELECT mediaType, caption, drive FROM Win32_CDROMDrive"));for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),
!b.caption||-1==b.caption.indexOf("Alcohol"))if(!b.caption||-1==b.caption.indexOf("Virtual")){switch(b.mediaType){case "CD-ROM":d["ROM-TYPE"]="CD";break;case "DVD-ROM":d["ROM-TYPE"]="DVD";break;case "CD Writer":d["ROM-TYPE"]="CD-RW";break;case "DVD Writer":d["ROM-TYPE"]="DVD-RW"}if(a=c.fun.clear(b.caption,"ATA Device","SCSI CdRom Device"))d["ROM-NAME"]=a;if(a=c.fun.clear(b.drive))d["ROM-DRIVE"]=a;break}response=r.execQuery(c.fun.debug("SELECT caption, size FROM Win32_LogicalDisk WHERE driveType = 2 OR driveType = 3 OR driveType = 4"));
for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),b.caption&&-1!=b.caption.indexOf(C)||d["BAK-DRIVE"]||(a=c.fun.clear(b.caption))&&b.size>=c.val.driveMinSize&&(d["BAK-DRIVE"]=a);g="";k="DisplayIcon";e=["SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма"];
a="";if(n)for(f=n.methods_.item("getStringValue"),h=0,p=e.length;h<p&&!a;h++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(e[h]),b.sValueName=k,b=n.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=c.fun.clear(b.sValue));a&&(e=a.split(c.val.keyDelim),e.pop(),e.pop(),g=e.join(c.val.keyDelim),d["APP-EFARMA-DIR"]=g);k="\\Client\\ePlus.Client.exe";e=g?[g]:[];a="";h=0;for(p=e.length;h<p;h++)h&&(a+=" OR "),a+="name = "+c.fun.repair(e[h]+k);if(a)for(response=r.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+
a)),f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),h=0,p=e.length;h<p;h++)if(a=e[h]+k,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-CLIENT"]=a;break}k="\\ARM\\ePlus.ARMCasherNew.exe";e=g?[g]:[];a="";h=0;for(p=e.length;h<p;h++)h&&(a+=" OR "),a+="name = "+c.fun.repair(e[h]+k);if(a)for(response=r.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+a)),f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),h=0,p=e.length;h<p;h++)if(a=e[h]+k,b.name&&
b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-CASHER"]=a;break}k="\\UpdateServer\\ePlus.UpdateServer.exe";e=g?[g]:[];a="";h=0;for(p=e.length;h<p;h++)h&&(a+=" OR "),a+="name = "+c.fun.repair(e[h]+k);if(a)for(response=r.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+a)),f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),h=0,p=e.length;h<p;h++)if(a=e[h]+k,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-UPDATER"]=a;break}k="lic";e=g?[g+"\\UpdateServer\\",
g+"\\Client\\",g+"\\ARM\\"]:[];a="";h=0;for(p=e.length;h<p;h++)h&&(a+=" OR "),a+="drive = "+c.fun.repair(c.lib.strim(e[h],"",":",!0,!1))+" ",a+="AND path = "+c.fun.repair(c.lib.strim(e[h],":","",!1,!1))+" ",a+="AND extension = "+c.fun.repair(k);if(a)for(response=r.execQuery(c.fun.debug("SELECT name, fileName FROM CIM_DataFile WHERE "+a)),f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),h=0,p=e.length;h<p;h++)if(a=e[h]+b.fileName+"."+k,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-LICENSE"]=
a;break}a=c.lib.date2str(y,"Y");k="\\ULUS.exe";e=["C:\\SoftLink\\Ulus\\"+a,"C:\\LO\\ULUS\\"+a,"C:\\so\\Ulus\\"+a,"C:\\ULUS\\"+a];a="";h=0;for(p=e.length;h<p;h++)h&&(a+=" OR "),a+="name = "+c.fun.repair(e[h]+k);if(a)for(response=r.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+a)),f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),h=0,p=e.length;h<p;h++)if(a=e[h]+k,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-ULUS"]=a;d["APP-ULUS-DIR"]=e[h];break}k="";e=["SOFTWARE\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command",
"SOFTWARE\\WOW6432Node\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command"];a="";if(n)for(f=n.methods_.item("getStringValue"),h=0,p=e.length;h<p&&!a;h++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(e[h]),b.sValueName=k,b=n.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=c.fun.clear(b.sValue));a&&(e=a.split(c.val.keyDelim),e.pop(),d["APP-CHROME"]=a,d["APP-CHROME-DIR"]=e.join(c.val.keyDelim));k="";e=["SOFTWARE\\VideoLAN\\VLC","SOFTWARE\\WOW6432Node\\VideoLAN\\VLC"];
a="";if(n)for(f=n.methods_.item("getStringValue"),h=0,p=e.length;h<p&&!a;h++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(e[h]),b.sValueName=k,b=n.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=c.fun.clear(b.sValue));a&&(e=a.split(c.val.keyDelim),e.pop(),d["APP-VLC"]=a,d["APP-VLC-DIR"]=e.join(c.val.keyDelim));k="ClientID";e=["SOFTWARE\\TeamViewer","SOFTWARE\\WOW6432Node\\TeamViewer"];a="";if(n)for(f=n.methods_.item("getDWORDValue"),h=0,p=e.length;h<p&&!a;h++)b=
f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(e[h]),b.sValueName=k,b=n.execMethod_(f.name,b),!b.returnValue&&b.uValue&&(a=c.fun.clear(b.uValue));a&&(d["APP-TEAMVIEWER-ID"]=a);e=[];d["CPU-NAME"]&&d["CPU-CORE"]&&d["CPU-SPEED"]&&e.push(c.fun.clear(d["CPU-NAME"].replace("Dual-Core","Intel"),"Dual Core","Xeon","Pentium","Celeron","Core2 Duo","Core","Processor","Athlon 64","Athlon",/,.+/,/@.+/,/\d\.d+GHz/)+" "+d["CPU-CORE"]+"x"+d["CPU-SPEED"].replace(",",".").replace(" МГц",
"M").replace(" ГГц","G")+"Hz");d["RAM-SIZE"]&&d["RAM-SPEED"]&&e.push(d["RAM-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+d["RAM-SPEED"].replace(" МГц","M").replace(" ГГц","G")+"Hz");d["GPU-SIZE"]&&d["GPU-NAME"]&&(-1!=d["GPU-NAME"].indexOf("GeForce")||-1!=d["GPU-NAME"].indexOf("Radeon"))&&e.push(d["GPU-SIZE"].replace(" МБ","MB").replace(" ГБ","GB")+" "+c.fun.clear(d["GPU-NAME"],"AMD","NVIDIA","GeForce","Radeon",/\(.+/));d["HDD-SIZE"]&&e.push(d["HDD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ",
"TB")+" HDD");d["SSD-SIZE"]&&e.push(d["SSD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" SSD");d["USB-SIZE"]&&e.push(d["USB-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" USB");d["ROM-TYPE"]&&e.push(d["ROM-TYPE"]);e.length&&(d["DEV-DESCRIPTION"]=e.join("/"));u&&(d["DEV-BENCHMARK"]=c.lib.num2str(u,5,",",""))}r="SYS-KEY SYS-NAME SYS-VERSION SYS-TIME SYS-ARCHITECTURE SYS-DRIVE SYS-INSTALL SYS-RESET SYS-SERIAL PCB-NAME PCB-SERIAL PCB-BIOS-MANUFACTURE PCB-BIOS-RELEASE PCB-BIOS-VERSION PCB-BIOS-SERIAL NET-IP-V4 NET-GATEWAY-V4 NET-DNS-V4 NET-SUBNET-V4 NET-DHCP-V4 NET-NAME NET-MAC NET-SPEED NET-RESET NET-HOST NET-DOMAIN USR-LOGIN USR-DOMAIN USR-ACCOUNT USR-NAME USR-SID USR-PROFILE CPU-ARCHITECTURE CPU-SPEED CPU-NAME CPU-CORE CPU-SOCKET CPU-CACHE-L1 CPU-CACHE-L2 CPU-CACHE-L3 RAM-SIZE RAM-SPEED GPU-SIZE GPU-NAME GPU-VERSION GPU-RESOLUTION GPU-FREQUENCY GPU-COLOR SSD-NAME SSD-VERSION SSD-SERIAL SSD-SIZE HDD-NAME HDD-VERSION HDD-SERIAL HDD-SIZE USB-NAME USB-VERSION USB-SERIAL USB-SIZE ROM-TYPE ROM-NAME ROM-DRIVE ROM-VERSION DEV-NAME DEV-DESCRIPTION DEV-BENCHMARK".split(" ");
if(m.input){c.fun.debug("Read input data");try{k="windows-1251",a=w.stdIn.readAll(),m.charset!=k&&(a=c.wsh.iconv(m.charset,k,a))}catch(z){a=""}}if(m.input&&a)switch(g=0,n="",v=a.split(c.val.linDelim),m.input){case "ini":b=c.lib.ini2obj(a,!1);for(k in b)!k||!b[k]||k in d||(d[k]=b[k]);break;case "TSV":n||(n=c.val.tsvDelim);case "CSV":n||(n=c.val.csvDelim),g<v.length&&(r=v[g++].split(n));case "tsv":n||(n=c.val.tsvDelim);case "csv":for(n||(n=c.val.csvDelim);g<v.length;)for(e=v[g++].split(n),h=0,p=r.length;h<
p;h++)k=r[h],!k||!e[h]||k in d||(d[k]=e[h])}if(m.output)switch(v=[],n="",c.fun.debug("Write output data"),m.output){case "ini":n=c.val.argDelim+c.val.iniDelim+c.val.argDelim;e=[];for(k in d)e.push(k);e.sort();h=0;for(p=e.length;h<p;h++)k=e[h],a=d[k]?d[k]:"",a=k+n+a,v.push(a);a=v.join(c.val.linDelim);break;case "TSV":n||(n=c.val.tsvDelim);case "CSV":n||(n=c.val.csvDelim);b=!0;e=[];h=0;for(p=r.length;h<p;h++)(k=r[h])&&(b=!1),e.push(k);a=r.join(n);b||v.push(a);case "tsv":n||(n=c.val.tsvDelim);case "csv":n||
(n=c.val.csvDelim);b=!0;e=[];h=0;for(p=r.length;h<p;h++)k=r[h],(a=d[k]?d[k]:"")&&(b=!1),e.push(a);a=e.join(n);b||v.push(a);a=v.join(c.val.linDelim)}if(m.output&&a){a+=c.val.linDelim;try{w.stdOut.write(a)}catch(z){}}c.fun.debug("Set environment variables");f=B.environment(c.val.envType);for(k in d)a=d[k],setEnv(f,k,a);f=[];for(g=A;g<w.arguments.length;g++)a=w.arguments.item(g),a=a.split(c.val.getDelim).join(c.val.setDelim),(a=B.expandEnvironmentStrings(a))&&-1==a.indexOf(c.val.argDelim)||(a=c.val.argWrap+
a+c.val.argWrap),f.push(a);if(d=f.join(c.val.argDelim)){A=m.silent?0:c.val.runStyle;c.fun.debug("Calling an external command");try{a=B.run(d,A,!m.nowait),m.nowait&&(a=c.val.defReturn)}catch(z){a=c.val.defReturn}}else a=c.val.defReturn;c.fun.debug("Exit with code "+a);c.fun.debug(m.debug);w.quit(a)}})})(WSH,env);env.init();
