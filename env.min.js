...
(function(v,c,J){c.lib.extend(c,{fun:{wql2date:function(b,n){return new Date(b?Date.UTC(1*b.substr(0,4),1*b.substr(4,2)-1,1*b.substr(6,2),1*b.substr(8,2),1*b.substr(10,2)-1*b.substr(21,4)+(n||0),1*b.substr(12,2),1*b.substr(14,3)):0)},bin2key:function(b){var n="";var q=b.toArray();b=Math.floor(q[66]/6)&1;q[66]=q[66]&247|4*(b&2);for(var d=24;-1<d;d--){var k=0;for(var r=14;-1<r;r--)k*=256,k=q[r+52]+k,q[r+52]=Math.floor(k/24),k%=24;n="BCDFGHJKMPQRTVWXY2346789".substr(k,1)+n}1==b&&(b=n.substr(1,k),n=n.substr(1).replace(b,
b+"N"));return[n.substr(0,5),n.substr(5,5),n.substr(10,5),n.substr(15,5),n.substr(20,5)].join("-")},info2str:function(b,n,q){if(!q||2>q)q=1024;if(!n||0>n)n=0;var d=Math.pow(10,n);for(var k=-1;b>=q;k++)b/=q;b=Math.ceil(b*d)/d;b=c.lib.num2str(b,-1<k?n:0,",","");return b+=" "+"КМГТПЭЗЙ".charAt(k)},clear:function(b){b=b?""+b:"";"INVALID"==b&&(b="");"To be filled by O.E.M."==b&&(b="");"System Product Name"==b&&(b="");"System Serial Number"==b&&(b="");"System manufacturer"==b&&(b="");"Default string"==
b&&(b="");"empty"==b&&(b="");"None"==b&&(b="");for(var n=1,q=arguments.length;n<q;n++)b=b.replace(arguments[n],"");return b.replace(/\(R\)/gi,"").replace(/\(Registered Trademark\)/gi,"").replace(/\(Microsoft Corporation\)/gi,"").replace(/\(Корпорация Майкрософт\)/gi,"").replace(/\(Майкрософт\)/gi,"").replace(/\(TM\)/gi,"").replace(/^[/'"]|[/"']$/g,"").replace(/^\s+|\s+$/g,"").replace(/\.+$/,"").replace(/\s(?=\s)/gi,"")},repair:function(b){return("'"+(b?b:"")+"'").replace(/\\/g,"\\\\")},debug:function(){var b,
n,q={},d=-1;return function(k){if(q.first){b=[c.lib.strPad(d,3,"0","left")];b.push("|");b.push(c.lib.strPad(c.lib.num2str((q.now.valueOf()-q.first.valueOf())/1E3,3,".",""),7,"0","left"));q.last=q.now;q.now=new Date;b.push("+"+c.lib.strPad(c.lib.num2str((q.now.valueOf()-q.last.valueOf())/1E3,3,".",""),7,"0","left"));b.push("|");b.push(n);try{v.stdErr.writeLine(b.join(" "))}catch(r){}}else q.now=new Date;!d&&n&&(q.first=q.now);n=k;d++;return k}}()},init:function(){var b,n="",q="";var d={};var k={},
r=0;var A=new Date;for(b=0;b<v.arguments.length;b++){var a=v.arguments.item(b);if(!("context"in k)){var e=a.split(c.val.keyDelim);if(3==e.length&&!e[0]&&!e[1]){k.context=e[2];continue}}if(!("input"in k)&&(e=a.split(c.val.chrDelim),2==e.length&&c.lib.hasValue(["ini","csv","tsv","CSV","TSV"],e[0],!0)&&e[1])){k.input=e[0];k.charset=e[1];continue}if(!("output"in k)&&(e=a.split(c.val.chrDelim),1==e.length&&c.lib.hasValue(["ini","csv","tsv","CSV","TSV"],e[0],!0))){k.output=e[0];continue}if("silent"in k||
"silent"!=a)if("nowait"in k||"nowait"!=a)if("debug"in k||"debug"!=a)break;else k.debug=!0;else k.nowait=!0;else k.silent=!0}var D=b;"context"in k||(k.context=".");"auto"==k.charset&&(k.charset="windows-1251");var E=new ActiveXObject("WScript.Shell");var x=new ActiveXObject("wbemScripting.Swbemlocator");x.security_.impersonationLevel=3;c.fun.debug(k.debug);if(k.context)for(c.fun.debug("Connect and create objects"),b=1;b;b++)try{switch(b){case 1:var p=x.connectServer(k.context,"root\\CIMV2");break;
case 2:var F=x.connectServer(k.context,"root\\directory\\LDAP");break;case 3:var t=x.connectServer(k.context,"root\\Microsoft\\Windows\\Storage");break;case 4:var m=x.connectServer(k.context,"root\\default").get("stdRegProv");break;default:b=-1}}catch(B){switch(b){case 1:p=null;break;case 2:F=null;break;case 3:t=null;break;case 4:m=null}}if(p){if(m){var f=m.methods_.item("getBinaryValue");b=f.inParameters.spawnInstance_();b.hDefKey=2147483650;b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";
b.sValueName=c.fun.debug("DigitalProductId");b=m.execMethod_(f.name,b);b.returnValue||(a=c.fun.bin2key(b.uValue))&&"BBBBB-BBBBB-BBBBB-BBBBB-BBBBB"!=a&&(d["SYS-KEY"]=a)}response=p.execQuery(c.fun.debug("SELECT * FROM Win32_OperatingSystem WHERE primary = TRUE"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.systemDrive)var H=a;if(a=b.localDateTime)A=c.fun.wql2date(a);if(a=c.fun.clear(b.caption,"Майкрософт","Microsoft","Edition","x64",","))d["SYS-NAME"]=a;if(a=c.fun.clear(b.version))d["SYS-VERSION"]=
a;if(a=b.localDateTime)d["SYS-TIME"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.localDateTime)d["SYS-TIME-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");if(a=c.fun.clear(b.systemDrive))d["SYS-DRIVE"]=a;if(a=b.installDate)d["SYS-INSTALL"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.installDate)d["SYS-INSTALL-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");if(a=b.lastBootUpTime)d["SYS-RESET"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.lastBootUpTime)d["SYS-RESET-DATE"]=
c.lib.date2str(c.fun.wql2date(a),"d.m.Y");if(a=c.fun.clear(b.serialNumber))d["SYS-SERIAL"]=a;if(a=c.fun.clear(b.description))d["SYS-DESCRIPTION"]=a;d["SYS-ARCHITECTURE"]=b.osArchitecture&&!b.osArchitecture.indexOf("64")?"x64":"x86";break}response=p.execQuery(c.fun.debug("SELECT manufacturer, product, serialNumber FROM Win32_BaseBoard WHERE hostingBoard = TRUE"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=c.fun.clear(b.product))d["PCB-NAME"]=a;a&&(a=c.fun.clear(b.manufacturer,
"Inc.").replace("Hewlett-Packard","HP"))&&(d["PCB-NAME"]=a.split(" ")[0]+" "+c.fun.clear(b.product));if(a=c.fun.clear(b.serialNumber))d["PCB-SERIAL"]=a;break}response=p.execQuery(c.fun.debug("SELECT releaseDate, manufacturer, smBIOSBIOSVersion, serialNumber FROM Win32_BIOS WHERE primaryBIOS = TRUE"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=c.fun.clear(b.releaseDate))d["PCB-BIOS-RELEASE"]=c.lib.date2str(c.fun.wql2date(a,A.getTimezoneOffset()),"d.m.Y H:i:s");if(a=c.fun.clear(b.releaseDate))d["PCB-BIOS-RELEASE-DATE"]=
c.lib.date2str(c.fun.wql2date(a,A.getTimezoneOffset()),"d.m.Y");if(a=c.fun.clear(b.manufacturer,"Inc."))d["PCB-BIOS-MANUFACTURE"]=a;if(a=c.fun.clear(b.smBIOSBIOSVersion))d["PCB-BIOS-VERSION"]=a;if(a=c.fun.clear(b.serialNumber))d["PCB-BIOS-SERIAL"]=a;break}var u="";response=p.execQuery(c.fun.debug("SELECT * FROM Win32_NetworkAdapterConfiguration WHERE ipEnabled = TRUE"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.interfaceIndex)u=a;if(null!=b.ipAddress){e=b.ipAddress.toArray();
for(var g=0,l=e.length;g<l;g++)(a=c.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!d["NET-IP-V4"]&&(d["NET-IP-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-IP-V6"]&&(d["NET-IP-V6"]=a)}if(null!=b.defaultIPGateway)for(e=b.defaultIPGateway.toArray(),g=0,l=e.length;g<l;g++)(a=c.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!d["NET-GATEWAY-V4"]&&(d["NET-GATEWAY-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-GATEWAY-V6"]&&(d["NET-GATEWAY-V6"]=a);if(null!=b.dnsServerSearchOrder)for(e=b.dnsServerSearchOrder.toArray(),g=0,l=e.length;g<
l;g++)(a=c.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!d["NET-DNS-V4"]&&(d["NET-DNS-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-DNS-V6"]&&(d["NET-DNS-V6"]=a);if(null!=b.ipSubnet)for(e=b.ipSubnet.toArray(),g=0,l=e.length;g<l;g++)(a=c.fun.clear(e[g]))&&-1!=a.indexOf(".")&&!d["NET-SUBNET-V4"]&&(d["NET-SUBNET-V4"]=a),a&&-1==a.indexOf(".")&&!d["NET-SUBNET-V6"]&&(d["NET-SUBNET-V6"]=a);if(a=c.fun.clear(b.dhcpServer))d["NET-DHCP-V4"]=a;if(a=c.fun.clear(b.description,"Сетевой адаптер","Адаптер","для виртуальной сети",
"Сетевая карта","Контроллер","NIC (NDIS 6.20)","- Минипорт планировщика пакетов","Family Controller","Adapter"))d["NET-NAME"]=a;if(a=c.fun.clear(b.macAddress))d["NET-MAC"]=a;break}e=0;response=p.execQuery(c.fun.debug("SELECT speed, timeOfLastReset FROM Win32_NetworkAdapter WHERE netEnabled = TRUE AND interfaceIndex = "+c.fun.repair(u)));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.speed)d["NET-SPEED"]=c.fun.info2str(a,0,1E3)+"бит/с";if(a=b.speed)d["NET-SPEED-VAL"]=a;
if(a=b.timeOfLastReset)d["NET-RESET"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y H:i:s");if(a=b.timeOfLastReset)d["NET-RESET-DATE"]=c.lib.date2str(c.fun.wql2date(a),"d.m.Y");break}e&&(r=r?Math.min(r,e):e);response=p.execQuery(c.fun.debug("SELECT * FROM Win32_ComputerSystem"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.dnsHostName)n=a;if(a=b.name)n||(n=a.toLowerCase());b.domain!=b.workgroup&&(q=b.domain);if(a=b.userName)var z=a.split(c.val.keyDelim)[0];if(a=b.userName)var y=
a.split(c.val.keyDelim)[1];if(a=b.userName)var w=a;if(a=c.fun.clear(n))d["NET-HOST"]=a;if(a=c.fun.clear(b.domain))d["NET-DOMAIN"]=a;if(a=c.fun.clear(b.model))d["DEV-NAME"]=a;a&&(a=c.fun.clear(b.manufacturer,"Inc.","Hewlett-Packard"))&&(d["DEV-NAME"]=a.split(" ")[0]+" "+c.fun.clear(b.model));break}!w&&m&&(e=[],f=m.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName=c.fun.debug("DefaultDomainName"),
b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&e.push(b.sValue),f=m.methods_.item("getStringValue"),b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon",b.sValueName=c.fun.debug("DefaultUserName"),b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&e.push(b.sValue),2==e.length&&(z=e[0]),2==e.length&&(y=e[1]),2==e.length&&(w=e.join(c.val.keyDelim)));if(!w){e=null;response=p.execQuery(c.fun.debug("SELECT lastUseTime, localPath, loaded FROM Win32_UserProfile WHERE special = FALSE"));
for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),(a=e?0:1)||(a=b.loaded&&!e.loaded?1:a),a||(a=c.lib.compare(c.fun.wql2date(b.lastUseTime),c.fun.wql2date(e.lastUseTime))),0<a&&(e=b);if(b=e){if(a=b.localPath.split(c.val.keyDelim).pop())y=a;if(a=b.localPath)var G=a}}if(y){g=p;var h=[".",q];do{response=g.execQuery(c.fun.debug("SELECT domain, name, fullName, sid FROM Win32_UserAccount WHERE name = "+c.fun.repair(y)+(z?" AND domain = "+c.fun.repair(z):"")));for(f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=c.fun.clear(b.fullName))d["USR-NAME"]=a;if(a=c.fun.clear(b.fullName)){e=a.split(c.val.argDelim);for(l=e.length-1;-1<l;l--)a=c.fun.clear(e[l],/[\[\(,\.\)\]]/g),(f=(f=3>a.length)||c.lib.hasValue(["von"],a,!0))?e.splice(l,1):e[l]=a;if(a=e[0])d["USR-NAME-FIRST"]=a;if(a=e[1])d["USR-NAME-SECOND"]=a;if(a=e[2])d["USR-NAME-THIRD"]=a;if(a=e[3])d["USR-NAME-FOURTH"]=a}e=[];if(a=b.sid)var C=a;(a=b.domain)&&e.push(a);(a=b.name)&&e.push(a);2==e.length&&(z=e[0]);2==e.length&&(y=e[1]);2==
e.length&&(w=e.join(c.val.keyDelim));break}try{g=!h.length||C?null:x.connectServer(h.shift(),"root\\CIMV2")}catch(B){g=null}}while(g)}if(w)for(response=p.execQuery(c.fun.debug("SELECT homeDirectory FROM Win32_NetworkLoginProfile WHERE name = "+c.fun.repair(w))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.homeDirectory)var I=a;break}if(!G&&C)for(response=p.execQuery(c.fun.debug("SELECT localPath FROM Win32_UserProfile WHERE sid = "+c.fun.repair(C))),f=new Enumerator(response);!f.atEnd();){b=
f.item();f.moveNext();if(a=b.localPath)G=a;break}if(a=c.fun.clear(C))d["USR-SID"]=a;if(a=c.fun.clear(w))d["USR-LOGIN"]=a;if(a=c.fun.clear(z))d["USR-DOMAIN"]=a;if(a=c.fun.clear(y))d["USR-ACCOUNT"]=a;if(a=c.fun.clear(G))d["USR-PROFILE"]=a;if(a=c.fun.clear(I))d["USR-HOME"]=a;if(n&&F&&q)for(response=F.execQuery(c.fun.debug("SELECT DS_distinguishedName FROM DS_computer WHERE DS_cn = "+c.fun.repair(n))),f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=c.fun.clear(b.DS_distinguishedName))d["NET-HOST-DN"]=
a;break}e=0;response=p.execQuery(c.fun.debug("SELECT architecture, maxClockSpeed, name, revision, numberOfCores, socketDesignation FROM Win32_Processor WHERE role = 'CPU'"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();0==b.architecture?d["CPU-ARCHITECTURE"]="x86":9==b.architecture&&(d["CPU-ARCHITECTURE"]="x64");if(a=b.maxClockSpeed)d["CPU-SPEED"]=c.fun.info2str(1E6*a,2,1E3)+"Гц";if(a=b.maxClockSpeed)d["CPU-SPEED-VAL"]=1E6*a;if(a=c.fun.clear(b.name,"CPU","APU","Процессор","Processor",
"with","Radeon HD Graphics","11th Gen"))d["CPU-NAME"]=a;if(a=c.fun.clear(b.revision))d["CPU-VERSION"]=a;if(a=b.numberOfCores)d["CPU-CORE"]=a;if(a=c.fun.clear(b.socketDesignation,"SOCKET 0"))d["CPU-SOCKET"]=a;if(a=b.maxClockSpeed)e+=2.26143*Math.sqrt(a/1E3);if(a=b.numberOfCores)e*=1.02033*Math.sqrt(a);break}e&&(r=r?Math.min(r,e):e);response=p.execQuery(c.fun.debug("SELECT level, maxCacheSize FROM Win32_CacheMemory"));for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),a=b.maxCacheSize)d["CPU-CACHE-L"+
(b.level-2)]=c.fun.info2str(1024*a,0)+"Б";h=e=0;response=p.execQuery(c.fun.debug("SELECT capacity, speed FROM Win32_PhysicalMemory"));for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();if(a=b.capacity)d["RAM-SIZE-VAL"]=h+=1*a;b.capacity&&(d["RAM-SIZE"]=c.fun.info2str(h,0)+"Б");if(a=b.speed)d["RAM-SPEED"]=a+" МГц";if(a=b.speed)d["RAM-SPEED-VAL"]=1E6*a;if(a=h)e=2.51143*Math.sqrt(a/1024/1024/1024);if(a=b.speed)e*=.92245*Math.sqrt(a/1E3)}e&&(r=r?Math.min(r,e):e);response=p.execQuery(c.fun.debug("SELECT adapterRam, name, driverVersion, currentHorizontalResolution, currentRefreshRate, currentBitsPerPixel, currentVerticalResolution FROM Win32_VideoController"));
...
a;if(a=b.currentVerticalResolution)d["GPU-RESOLUTION-Y"]=a;if(a=b.currentRefreshRate)d["GPU-FREQUENCY"]=c.fun.info2str(a,0,1E3)+"Гц";if(a=b.currentRefreshRate)d["GPU-FREQUENCY-VAL"]=a;if(a=b.currentBitsPerPixel)d["GPU-COLOR"]=c.fun.info2str(a,0)+"бит"+c.lib.numDeclin(a,"","","а");if(a=b.currentBitsPerPixel)d["GPU-COLOR-VAL"]=a;break}e=0;response=t?t.execQuery(c.fun.debug("SELECT model, firmwareVersion, mediaType, serialNumber, size FROM MSFT_PhysicalDisk")):p.execQuery(c.fun.debug("SELECT * FROM Win32_DiskDrive"));
for(f=new Enumerator(response);!f.atEnd();){b=f.item();f.moveNext();switch(b.mediaType){case 0:h="USB";break;case 3:h="HDD";break;case 4:h="SSD";break;case 5:h="SCM";break;case "Removable Media":h="USB";break;case "Fixed\thard disk media":case "Fixed hard disk media":h=b.model&&-1!=b.model.indexOf("Solid")?"SSD":b.model&&-1!=b.model.indexOf("SSD")?"SSD":b.model&&!b.model.indexOf("ADATA")?"SSD":"HDD";break;default:h=""}if((!b.model||-1==b.model.indexOf("Raid"))&&h&&!d[h+"-NAME"]){if(a=c.fun.clear(b.model,
"ATA Device","SCSI Disk Device","USB Device","SSD","SATA"))d[h+"-NAME"]=a;if(a=c.fun.clear(b.firmwareVersion||b.firmwareRevision))d[h+"-VERSION"]=a;if(a=c.fun.clear(b.serialNumber))d[h+"-SERIAL"]=a;if(a=b.size)d[h+"-SIZE"]=c.fun.info2str(a,0)+"Б";if(a=b.size)d[h+"-SIZE-VAL"]=a;h&&(e=Math.max(e,"SDD"==h?15.51143:7.14577))}}e&&(r=r?Math.min(r,e):e);response=p.execQuery(c.fun.debug("SELECT mediaType, caption, drive FROM Win32_CDROMDrive"));for(f=new Enumerator(response);!f.atEnd();)if(b=f.item(),f.moveNext(),
!b.caption||-1==b.caption.indexOf("Alcohol"))if(!b.caption||-1==b.caption.indexOf("Virtual")){switch(b.mediaType){case "CD-ROM":d["ROM-TYPE"]="CD";break;case "DVD-ROM":d["ROM-TYPE"]="DVD";break;case "CD Writer":d["ROM-TYPE"]="CD-RW";break;case "DVD Writer":d["ROM-TYPE"]="DVD-RW"}if(a=c.fun.clear(b.caption,"ATA Device","SCSI CdRom Device"))d["ROM-NAME"]=a;if(a=c.fun.clear(b.drive))d["ROM-DRIVE"]=a;break}response=p.execQuery(c.fun.debug("SELECT caption, size FROM Win32_LogicalDisk WHERE driveType = 2 OR driveType = 3 OR driveType = 4"));
for(f=new Enumerator(response);!f.atEnd();)b=f.item(),f.moveNext(),b.caption&&-1!=b.caption.indexOf(H)||d["BAK-DRIVE"]||(a=c.fun.clear(b.caption))&&b.size>=c.val.driveMinSize&&(d["BAK-DRIVE"]=a);u="";h="DisplayIcon";e=["SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\F3 TAIL","SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма","SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\еФарма"];
a="";if(m)for(f=m.methods_.item("getStringValue"),g=0,l=e.length;g<l&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(e[g]),b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=c.fun.clear(b.sValue));a&&(e=a.split(c.val.keyDelim),e.pop(),e.pop(),u=e.join(c.val.keyDelim),d["APP-EFARMA-DIR"]=u);h="\\Client\\ePlus.Client.exe";e=[u];a="";g=0;for(l=e.length;g<l;g++)g&&(a+=" OR "),a+="name = "+c.fun.repair(e[g]+h);response=p.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+
a));for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,l=e.length;g<l;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-CLIENT"]=a;break}h="\\ARM\\ePlus.ARMCasherNew.exe";e=[u];a="";g=0;for(l=e.length;g<l;g++)g&&(a+=" OR "),a+="name = "+c.fun.repair(e[g]+h);response=p.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+a));for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,l=e.length;g<l;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==
a.toLowerCase()){d["APP-EFARMA-CASHER"]=a;break}h="\\UpdateServer\\ePlus.UpdateServer.exe";e=[u];a="";g=0;for(l=e.length;g<l;g++)g&&(a+=" OR "),a+="name = "+c.fun.repair(e[g]+h);response=p.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+a));for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,l=e.length;g<l;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-UPDATER"]=a;break}h="lic";e=[u+"\\UpdateServer\\",u+"\\Client\\",u+"\\ARM\\"];a=
"";g=0;for(l=e.length;g<l;g++)g&&(a+=" OR "),a+="drive = "+c.fun.repair(c.lib.strim(e[g],"",":",!0,!1))+" ",a+="AND path = "+c.fun.repair(c.lib.strim(e[g],":","",!1,!1))+" ",a+="AND extension = "+c.fun.repair(h);response=p.execQuery(c.fun.debug("SELECT name, fileName FROM CIM_DataFile WHERE "+a));for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,l=e.length;g<l;g++)if(a=e[g]+b.fileName+"."+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-EFARMA-LICENSE"]=a;break}a=c.lib.date2str(A,
"Y");h="\\ULUS.exe";e=["C:\\SoftLink\\Ulus\\"+a,"C:\\LO\\ULUS\\"+a,"C:\\so\\Ulus\\"+a,"C:\\ULUS\\"+a];a="";g=0;for(l=e.length;g<l;g++)g&&(a+=" OR "),a+="name = "+c.fun.repair(e[g]+h);response=p.execQuery(c.fun.debug("SELECT name FROM CIM_DataFile WHERE "+a));for(f=new Enumerator(response);!f.atEnd();)for(b=f.item(),f.moveNext(),g=0,l=e.length;g<l;g++)if(a=e[g]+h,b.name&&b.name.toLowerCase()==a.toLowerCase()){d["APP-ULUS"]=a;d["APP-ULUS-DIR"]=e[g];break}h="";e=["SOFTWARE\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command",
"SOFTWARE\\WOW6432Node\\Clients\\StartMenuInternet\\Google Chrome\\shell\\open\\command"];a="";if(m)for(f=m.methods_.item("getStringValue"),g=0,l=e.length;g<l&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(e[g]),b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=c.fun.clear(b.sValue));a&&(e=a.split(c.val.keyDelim),e.pop(),d["APP-CHROME"]=a,d["APP-CHROME-DIR"]=e.join(c.val.keyDelim));h="";e=["SOFTWARE\\VideoLAN\\VLC","SOFTWARE\\WOW6432Node\\VideoLAN\\VLC"];
a="";if(m)for(f=m.methods_.item("getStringValue"),g=0,l=e.length;g<l&&!a;g++)b=f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(e[g]),b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.sValue&&(a=c.fun.clear(b.sValue));a&&(e=a.split(c.val.keyDelim),e.pop(),d["APP-VLC"]=a,d["APP-VLC-DIR"]=e.join(c.val.keyDelim));h="ClientID";e=["SOFTWARE\\TeamViewer","SOFTWARE\\WOW6432Node\\TeamViewer"];a="";if(m)for(f=m.methods_.item("getDWORDValue"),g=0,l=e.length;g<l&&!a;g++)b=
f.inParameters.spawnInstance_(),b.hDefKey=2147483650,b.sSubKeyName=c.fun.debug(e[g]),b.sValueName=h,b=m.execMethod_(f.name,b),!b.returnValue&&b.uValue&&(a=c.fun.clear(b.uValue));a&&(d["APP-TEAMVIEWER-ID"]=a);e=[];d["CPU-NAME"]&&d["CPU-CORE"]&&d["CPU-SPEED"]&&e.push(c.fun.clear(d["CPU-NAME"].replace("Dual-Core","Intel"),"Dual Core","Xeon","Pentium","Celeron","Core2 Duo","Core","Processor","Athlon 64","Athlon",/,.+/,/@.+/,/\d\.d+GHz/)+" "+d["CPU-CORE"]+"x"+d["CPU-SPEED"].replace(",",".").replace(" МГц",
...
"TB")+" HDD");d["SSD-SIZE"]&&e.push(d["SSD-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" SSD");d["USB-SIZE"]&&e.push(d["USB-SIZE"].replace(" МБ","MB").replace(" ГБ","GB").replace(" ТБ","TB")+" USB");d["ROM-TYPE"]&&e.push(d["ROM-TYPE"]);e.length&&(d["DEV-DESCRIPTION"]=e.join("/"));r&&(d["DEV-BENCHMARK"]=c.lib.num2str(r,5,",",""))}p="SYS-KEY SYS-NAME SYS-VERSION SYS-TIME SYS-ARCHITECTURE SYS-DRIVE SYS-INSTALL SYS-RESET SYS-SERIAL PCB-NAME PCB-SERIAL PCB-BIOS-MANUFACTURE PCB-BIOS-RELEASE PCB-BIOS-VERSION PCB-BIOS-SERIAL NET-IP-V4 NET-GATEWAY-V4 NET-DNS-V4 NET-SUBNET-V4 NET-DHCP-V4 NET-NAME NET-MAC NET-SPEED NET-RESET NET-HOST NET-DOMAIN USR-LOGIN USR-DOMAIN USR-ACCOUNT USR-NAME USR-SID USR-PROFILE CPU-ARCHITECTURE CPU-SPEED CPU-NAME CPU-CORE CPU-SOCKET CPU-CACHE-L1 CPU-CACHE-L2 CPU-CACHE-L3 RAM-SIZE RAM-SPEED GPU-SIZE GPU-NAME GPU-VERSION GPU-RESOLUTION GPU-FREQUENCY GPU-COLOR SSD-NAME SSD-VERSION SSD-SERIAL SSD-SIZE HDD-NAME HDD-VERSION HDD-SERIAL HDD-SIZE USB-NAME USB-VERSION USB-SERIAL USB-SIZE ROM-TYPE ROM-NAME ROM-DRIVE ROM-VERSION DEV-NAME DEV-DESCRIPTION DEV-BENCHMARK".split(" ");
if(k.input){c.fun.debug("Read input data");try{h="windows-1251",a=v.stdIn.readAll(),k.charset!=h&&(a=c.wsh.iconv(k.charset,h,a))}catch(B){a=""}}if(k.input&&a)switch(b=0,m="",t=a.split(c.val.linDelim),k.input){case "ini":b=c.lib.ini2obj(a,!1);for(h in b)!h||!b[h]||h in d||(d[h]=b[h]);break;case "TSV":m||(m=c.val.tsvDelim);case "CSV":m||(m=c.val.csvDelim),b<t.length&&(p=t[b++].split(m));case "tsv":m||(m=c.val.tsvDelim);case "csv":for(m||(m=c.val.csvDelim);b<t.length;)for(e=t[b++].split(m),g=0,l=p.length;g<
l;g++)h=p[g],!h||!e[g]||h in d||(d[h]=e[g])}if(k.output)switch(t=[],m="",c.fun.debug("Write output data"),k.output){case "ini":m=c.val.argDelim+c.val.iniDelim+c.val.argDelim;e=[];for(h in d)e.push(h);e.sort();g=0;for(l=e.length;g<l;g++)h=e[g],a=d[h]?d[h]:"",a=h+m+a,t.push(a);a=t.join(c.val.linDelim);break;case "TSV":m||(m=c.val.tsvDelim);case "CSV":m||(m=c.val.csvDelim);f=!0;e=[];g=0;for(l=p.length;g<l;g++)(h=p[g])&&(f=!1),e.push(h);a=p.join(m);f||t.push(a);case "tsv":m||(m=c.val.tsvDelim);case "csv":m||
(m=c.val.csvDelim);f=!0;e=[];g=0;for(l=p.length;g<l;g++)h=p[g],(a=d[h]?d[h]:"")&&(f=!1),e.push(a);a=e.join(m);f||t.push(a);a=t.join(c.val.linDelim)}if(k.output&&a){a+=c.val.linDelim;try{v.stdOut.write(a)}catch(B){}}c.fun.debug("Set environment variables");f=E.environment(c.val.envType);for(h in d)a=d[h],setEnv(f,h,a);f=[];for(b=D;b<v.arguments.length;b++)a=v.arguments.item(b),a=a.split(c.val.getDelim).join(c.val.setDelim),(a=E.expandEnvironmentStrings(a))&&-1==a.indexOf(c.val.argDelim)||(a=c.val.argWrap+
a+c.val.argWrap),f.push(a);if(d=f.join(c.val.argDelim)){D=k.silent?0:c.val.runStyle;c.fun.debug("Calling an external command");try{a=E.run(d,D,!k.nowait),k.nowait&&(a=c.val.defReturn)}catch(B){a=c.val.defReturn}}else a=c.val.defReturn;c.fun.debug("Exit with code "+a);c.fun.debug(k.debug);v.quit(a)}})})(WSH,env);env.init();
